...
${"─".repeat(60)}
${b[V]}`}).join(`
`)}function nd({lang:C,ui:E}){var se;const[_,$]=it.useState(null),[b,V]=it.useState("staging"),[Y,ne]=it.useState("cap"),[H,_e]=it.useState("search"),[he,K]=it.useState(!1),j=wc[C],Pe=ed[C],Q=Ra.find(w=>w.id===_),O=(se=Q==null?void 0:Q[C])==null?void 0:se[b],q=(Q==null?void 0:Q.validExtents)||["ap","cap"],xe=it.useMemo(()=>O?td(O,Y,j.templateSections):"",[O,Y,j]),L=()=>{navigator.clipboard.writeText(xe),K(!0),setTimeout(()=>K(!1),2e3)},le=w=>{const X=Ra.find(ge=>ge.id===w);$(w),X&&!X.validExtents.includes(Y)&&ne(X.validExtents[0]),_e("search"),K(!1)};return _?h.jsxs("div",{className:"space-y-4",children:[h.jsxs("div",{className:`rounded-lg border p-4 ${pe.bg} ${pe.border}`,children:[h.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-3",children:[h.jsxs("div",{className:"flex-1 min-w-0",children:[h.jsxs("div",{className:"flex items-center gap-3 mb-2 flex-wrap",children:[h.jsx("button",{onClick:()=>$(null),className:"text-xs text-zinc-500 hover:text-zinc-300 border border-zinc-700 rounded px-2 py-1 transition-colors",children:"← back"}),h.jsx("h2",{className:`text-lg font-bold ${pe.text}`,children:Q[C].label})]}),O&&h.jsxs("p",{className:"text-xs text-zinc-500 leading-relaxed",children:[h.jsxs("span",{className:"text-zinc-400 font-semibold",children:[E.evidenceLabel," "]}),O.evidence]})]}),h.jsxs("div",{className:"flex gap-2 flex-shrink-0",children:[h.jsx("button",{onClick:()=>_e("search"),className:`text-xs px-3 py-1.5 rounded border font-bold transition-all ${H==="search"?`${pe.bg} ${pe.border} ${pe.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:E.searchTab}),h.jsx("button",{onClick:()=>_e("template"),className:`text-xs px-3 py-1.5 rounded border font-bold transition-all ${H==="template"?`${pe.bg} ${pe.border} ${pe.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:E.templateTab})]})]}),h.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 items-start",children:[h.jsxs("div",{children:[h.jsx("div",{className:"text-xs text-zinc-600 mb-1.5 uppercase tracking-widest font-semibold",children:j.clinicalQuestion}),h.jsx("div",{className:"flex gap-1",children:["staging","response"].map(w=>h.jsx("button",{onClick:()=>{V(w),_e("search")},className:`text-xs px-3 py-1.5 rounded border font-bold transition-all ${b===w?`${pe.bg} ${pe.border} ${pe.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-300"}`,children:w==="staging"?j.staging:j.response},w))})]}),h.jsxs("div",{children:[h.jsx("div",{className:"text-xs text-zinc-600 mb-1.5 uppercase tracking-widest font-semibold",children:j.scanExtent}),h.jsx("div",{className:"flex gap-1 flex-wrap",children:q.map(w=>h.jsx("button",{onClick:()=>ne(w),className:`text-xs px-3 py-1.5 rounded border font-bold transition-all ${Y===w?`${pe.bg} ${pe.border} ${pe.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-300"}`,children:j.extents[w]},w))})]})]}),O&&h.jsxs("div",{className:"mt-3 flex flex-wrap gap-1.5 items-center",children:[h.jsx("span",{className:"text-xs text-zinc-600 mr-1",children:E.dontMiss}),O.criticalFindings.map(w=>h.jsxs("span",{className:"text-xs px-2 py-0.5 bg-red-500/10 border border-red-500/20 text-red-400 rounded font-medium",children:["⚠ ",w]},w))]})]}),H==="search"&&O&&h.jsxs("div",{className:"space-y-3",children:[h.jsxs("div",{className:"rounded-lg border border-zinc-700/60 bg-zinc-900/60 p-4",children:[h.jsx("div",{className:"text-xs font-bold text-zinc-500 uppercase tracking-widest mb-2",children:E.mismatchTitle}),h.jsx("p",{className:"text-sm text-zinc-300 leading-relaxed",children:O.searchMismatch}),h.jsx("div",{className:"mt-2 flex gap-2 flex-wrap",children:h.jsxs("span",{className:`text-xs px-2 py-0.5 rounded border font-semibold ${pe.badge}`,children:[b==="staging"?j.classificationLabel:j.criteriaLabel," ",b==="staging"?O.classification:O.criteria]})}),h.jsxs("p",{className:"text-xs text-zinc-600 mt-2",children:[h.jsxs("span",{className:"text-zinc-500 font-semibold",children:[E.searchEvidenceLabel," "]}),O.searchEvidence]})]}),h.jsxs("div",{className:"rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden",children:[h.jsx("div",{className:"px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70",children:h.jsx("span",{className:"text-xs font-bold text-zinc-400 uppercase tracking-widest",children:E.protocolTitle})}),h.jsx("div",{className:"divide-y divide-zinc-800/50",children:O.searchPattern.map(w=>{const X=Hc[w.priority];return h.jsxs("div",{className:`flex gap-3 p-4 ${X.bg}`,children:[h.jsxs("div",{className:"flex-shrink-0 flex items-start gap-2 pt-1",children:[h.jsx("div",{className:`w-2 h-2 rounded-full flex-shrink-0 ${X.dot}`}),h.jsx("span",{className:"text-xs text-zinc-700 font-bold w-3",children:w.step})]}),h.jsxs("div",{className:"flex-1 min-w-0",children:[h.jsxs("div",{className:"flex items-baseline gap-2 mb-1 flex-wrap",children:[h.jsx("span",{className:`text-sm font-bold ${X.label}`,children:w.title}),h.jsxs("span",{className:"text-xs text-zinc-700",children:["~",w.time]})]}),h.jsx("p",{className:"text-xs text-zinc-400 leading-relaxed",children:w.detail})]})]},w.step)})})]}),h.jsxs("div",{className:"flex gap-5 text-xs text-zinc-600 px-1",children:[h.jsxs("span",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"w-2 h-2 rounded-full bg-red-500 flex-shrink-0"})," ",E.legendCritical]}),h.jsxs("span",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-500 flex-shrink-0"})," ",E.legendHigh]}),h.jsxs("span",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"w-2 h-2 rounded-full bg-zinc-500 flex-shrink-0"})," ",E.legendStandard]})]})]}),H==="template"&&O&&h.jsxs("div",{className:"space-y-3",children:[h.jsxs("div",{className:"rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden",children:[h.jsxs("div",{className:"flex items-center justify-between px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70",children:[h.jsxs("span",{className:"text-xs text-zinc-600",children:[E.formatNote," · ",j.extents[Y]]}),h.jsx("button",{onClick:L,className:`text-xs px-3 py-1 rounded border font-bold transition-all ${he?`${pe.bg} ${pe.border} ${pe.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:he?E.copiedButton:E.copyButton})]}),h.jsx("pre",{className:"p-4 text-zinc-300 overflow-x-auto whitespace-pre-wrap break-words",style:{fontFamily:"inherit",fontSize:"0.72rem",lineHeight:"1.8"},children:xe})]}),h.jsxs("p",{className:"text-xs text-zinc-600 px-1",children:[E.usageNote," ",h.jsx("span",{className:"text-red-500/60",children:E.criticalNote})]})]})]}):h.jsxs("div",{className:"space-y-6",children:[h.jsxs("div",{className:`rounded-lg border p-5 ${pe.bg} ${pe.border}`,children:[h.jsx("h2",{className:`text-lg font-bold mb-1 ${pe.text}`,children:j.selectTumour}),h.jsx("p",{className:"text-xs text-zinc-500",children:"Select tumour type, then clinical question and scan extent."})]}),h.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2",children:Ra.map(w=>h.jsxs("button",{onClick:()=>le(w.id),className:"rounded-lg border border-zinc-800 bg-zinc-900/50 hover:bg-zinc-800/80 hover:border-zinc-600 p-4 text-left transition-all group",children:[h.jsx("div",{className:`text-sm font-bold mb-1 group-hover:${pe.text} text-zinc-300`,children:Pe[w.id]}),h.jsx("div",{className:"text-xs text-zinc-600",children:w.validExtents.map(X=>wc[C].extents[X]).join(" · ")})]},w.id))})]})}function id(C,E){const _=Rr.find($=>$.key===C);return(_==null?void 0:_.categories[E])||(_==null?void 0:_.categories[Object.keys(_.categories)[0]])}function rd({template:C,lang:E,ui:_}){const $=C[E];return h.jsxs("div",{className:"space-y-3",children:[h.jsxs("div",{className:"rounded-lg border border-zinc-700/60 bg-zinc-900/60 p-4",children:[h.jsx("div",{className:"text-xs font-bold text-zinc-500 uppercase tracking-widest mb-2",children:_.mismatchTitle}),h.jsx("p",{className:"text-sm text-zinc-300 leading-relaxed",children:$.searchMismatch}),h.jsxs("p",{className:"text-xs text-zinc-600 mt-2 leading-relaxed",children:[h.jsxs("span",{className:"text-zinc-500 font-semibold",children:[_.searchEvidenceLabel," "]}),$.searchEvidence]})]}),h.jsxs("div",{className:"rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden",children:[h.jsx("div",{className:"px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70",children:h.jsx("span",{className:"text-xs font-bold text-zinc-400 uppercase tracking-widest",children:_.protocolTitle})}),h.jsx("div",{className:"divide-y divide-zinc-800/50",children:$.searchPattern.map(b=>{const V=Hc[b.priority];return h.jsxs("div",{className:`flex gap-3 p-4 ${V.bg}`,children:[h.jsxs("div",{className:"flex-shrink-0 flex items-start gap-2 pt-1",children:[h.jsx("div",{className:`w-2 h-2 rounded-full flex-shrink-0 ${V.dot}`}),h.jsx("span",{className:"text-xs text-zinc-700 font-bold w-3 leading-none",children:b.step})]}),h.jsxs("div",{className:"flex-1 min-w-0",children:[h.jsxs("div",{className:"flex items-baseline gap-2 mb-1 flex-wrap",children:[h.jsx("span",{className:`text-sm font-bold ${V.label}`,children:b.title}),h.jsxs("span",{className:"text-xs text-zinc-700 flex-shrink-0",children:["~",b.time]})]}),h.jsx("p",{className:"text-xs text-zinc-400 leading-relaxed",children:b.detail})]})]},b.step)})})]}),h.jsxs("div",{className:"flex gap-5 text-xs text-zinc-600 px-1",children:[h.jsxs("span",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"w-2 h-2 rounded-full bg-red-500 flex-shrink-0"})," ",_.legendCritical]}),h.jsxs("span",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-500 flex-shrink-0"})," ",_.legendHigh]}),h.jsxs("span",{className:"flex items-center gap-1.5",children:[h.jsx("span",{className:"w-2 h-2 rounded-full bg-zinc-500 flex-shrink-0"})," ",_.legendStandard]})]})]})}function od({template:C,lang:E,ui:_,catStyle:$}){const[b,V]=it.useState(!1),Y=C[E],ne=()=>{navigator.clipboard.writeText(Y.template),V(!0),setTimeout(()=>V(!1),2e3)};return h.jsxs("div",{className:"space-y-3",children:[h.jsxs("div",{className:"rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden",children:[h.jsxs("div",{className:"flex items-center justify-between px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70",children:[h.jsx("span",{className:"text-xs text-zinc-600",children:_.formatNote}),h.jsx("button",{onClick:ne,className:`text-xs px-3 py-1 rounded border font-bold transition-all ${b?`${$.bg} ${$.border} ${$.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:b?_.copiedButton:_.copyButton})]}),h.jsx("pre",{className:"p-4 text-zinc-300 overflow-x-auto whitespace-pre-wrap break-words",style:{fontFamily:"inherit",fontSize:"0.72rem",lineHeight:"1.8"},children:Y.template})]}),h.jsxs("p",{className:"text-xs text-zinc-600 px-1 leading-relaxed",children:[_.usageNote," ",h.jsx("span",{className:"text-red-500/60",children:_.criticalNote})]})]})}function ad(){const[C,E]=it.useState("en"),[_,$]=it.useState("abdomen"),[b,V]=it.useState("appendicitis"),[Y,ne]=it.useState("search"),H=Km[C],_e=Gm[C],he=Zm[C],K=Rr.find(L=>L.key===_),j=K==null?void 0:K.isOncology,Pe=Dc[_]||[],Q=Pe.find(L=>L.id===b)||Pe[0],O=j?null:id(_,Q==null?void 0:Q.category),q=L=>{var se;$(L);const le=Rr.find(w=>w.key===L);le!=null&&le.isOncology||V(((se=(Dc[L]||[])[0])==null?void 0:se.id)||""),ne("search")},xe=j?{}:Pe.reduce((L,le)=>(L[le.category]||(L[le.category]=[]),L[le.category].push(le),L),{});return h.jsxs("div",{className:"min-h-screen bg-zinc-950 text-zinc-100",style:{fontFamily:"'JetBrains Mono','Cascadia Code','Fira Code',monospace"},children:[h.jsx("div",{className:"border-b border-zinc-800 bg-zinc-900/80 sticky top-0 z-10",children:h.jsxs("div",{className:"max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-3 flex-wrap",children:[h.jsxs("div",{className:"flex-shrink-0",children:[h.jsx("div",{className:"text-sm font-bold tracking-widest text-zinc-100",children:H.appTitle}),h.jsx("div",{className:"text-xs text-zinc-600 mt-0.5 tracking-wide",children:H.appSubtitle})]}),h.jsx("div",{className:"flex gap-1 bg-zinc-900 border border-zinc-800 rounded-lg p-1 flex-wrap",children:Rr.map(L=>h.jsx("button",{onClick:()=>q(L.key),className:`text-xs px-3 py-1.5 rounded-md font-bold tracking-wider border transition-all ${_===L.key?L.tabStyle.active:L.tabStyle.inactive}`,children:_e[L.key]},L.key))}),h.jsxs("div",{className:"flex items-center gap-4",children:[h.jsxs("div",{className:"text-xs text-zinc-700 text-right hidden lg:block leading-relaxed",children:[h.jsx("div",{children:H.guidanceRow1}),h.jsx("div",{children:H.guidanceRow2})]}),h.jsx("div",{className:"flex gap-1 bg-zinc-900 border border-zinc-800 rounded p-0.5 flex-shrink-0",children:["en","cs"].map(L=>h.jsx("button",{onClick:()=>E(L),className:`text-xs px-3 py-1.5 rounded font-bold tracking-wider uppercase transition-all ${C===L?"bg-zinc-700 text-zinc-100":"text-zinc-600 hover:text-zinc-300"}`,children:L},L))})]})]})}),h.jsxs("div",{className:"max-w-7xl mx-auto flex flex-col lg:flex-row",style:{minHeight:"calc(100vh - 57px)"},children:[!j&&h.jsx("div",{className:"lg:w-52 flex-shrink-0 border-b lg:border-b-0 lg:border-r border-zinc-800/70",children:h.jsx("div",{className:"p-3 space-y-1",children:Object.entries(xe).map(([L,le])=>{const se=K.categories[L],w=Object.keys(xe).length>1;return h.jsxs("div",{className:"mb-2",children:[w&&h.jsx("div",{className:"text-xs font-bold text-zinc-700 uppercase tracking-widest px-2 pt-2 pb-1",children:he[L]}),le.map(X=>{const ge=K.categories[X.category]||se,we=X.id===b;return h.jsx("button",{onClick:()=>{V(X.id),ne("search")},className:`w-full text-left px-3 py-2 rounded text-xs transition-all mb-0.5 ${we?`${ge.bg} border ${ge.border} ${ge.text} font-bold`:"text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800/50"}`,children:X[C].label},X.id)})]},L)})})}),h.jsx("div",{className:"flex-1 min-w-0 p-4 lg:p-6",children:j?h.jsx(nd,{lang:C,ui:H}):Q?h.jsxs("div",{className:"space-y-4",children:[h.jsxs("div",{className:`rounded-lg border p-4 ${O.bg} ${O.border}`,children:[h.jsxs("div",{className:"flex flex-wrap items-start gap-3 justify-between",children:[h.jsxs("div",{className:"flex-1 min-w-0",children:[h.jsxs("div",{className:"flex flex-wrap items-center gap-2 mb-2",children:[h.jsx("h2",{className:`text-lg font-bold ${O.text}`,children:Q[C].label}),h.jsx("span",{className:`text-xs px-2 py-0.5 rounded border font-semibold ${O.badge}`,children:he[Q.category]})]}),h.jsxs("p",{className:"text-xs text-zinc-500 leading-relaxed",children:[h.jsxs("span",{className:"text-zinc-400 font-semibold",children:[H.evidenceLabel," "]}),Q[C].evidence]})]}),h.jsx("div",{className:"flex gap-2 flex-shrink-0",children:["search","template"].map(L=>h.jsx("button",{onClick:()=>ne(L),className:`text-xs px-3 py-1.5 rounded border font-bold tracking-wide transition-all ${Y===L?`${O.bg} ${O.border} ${O.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:L==="search"?H.searchTab:H.templateTab},L))})]}),h.jsxs("div",{className:"mt-3 flex flex-wrap gap-1.5 items-center",children:[h.jsx("span",{className:"text-xs text-zinc-600 mr-1",children:H.dontMiss}),Q[C].criticalFindings.map(L=>h.jsxs("span",{className:"text-xs px-2 py-0.5 bg-red-500/10 border border-red-500/20 text-red-400 rounded font-medium",children:["⚠ ",L]},L))]})]}),Y==="search"?h.jsx(rd,{template:Q,lang:C,ui:H}):h.jsx(od,{template:Q,lang:C,ui:H,catStyle:O})]}):null})]})]})}Ym.createRoot(document.getElementById("root")).render(h.jsx(it.StrictMode,{children:h.jsx(ad,{})}));
