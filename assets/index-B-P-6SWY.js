(function(){const E=document.createElement("link").relList;if(E&&E.supports&&E.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))U(A);new MutationObserver(A=>{for(const H of A)if(H.type==="childList")for(const K of H.addedNodes)K.tagName==="LINK"&&K.rel==="modulepreload"&&U(K)}).observe(document,{childList:!0,subtree:!0});function _(A){const H={};return A.integrity&&(H.integrity=A.integrity),A.referrerPolicy&&(H.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?H.credentials="include":A.crossOrigin==="anonymous"?H.credentials="omit":H.credentials="same-origin",H}function U(A){if(A.ep)return;A.ep=!0;const H=_(A);fetch(A.href,H)}})();var bo={exports:{}},fi={},Ao={exports:{}},W={};/**
 * @license React
 ...
 */var Tc;function Dm(){if(Tc)return W;Tc=1;var S=Symbol.for("react.element"),E=Symbol.for("react.portal"),_=Symbol.for("react.fragment"),U=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),H=Symbol.for("react.provider"),K=Symbol.for("react.context"),ne=Symbol.for("react.forward_ref"),j=Symbol.for("react.suspense"),me=Symbol.for("react.memo"),ae=Symbol.for("react.lazy"),x=Symbol.iterator;function Y(m){return m===null||typeof m!="object"?null:(m=x&&m[x]||m["@@iterator"],typeof m=="function"?m:null)}var de={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},oe=Object.assign,M={};function G(m,y,Z){this.props=m,this.context=y,this.refs=M,this.updater=Z||de}G.prototype.isReactComponent={},G.prototype.setState=function(m,y){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,y,"setState")},G.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function xe(){}xe.prototype=G.prototype;function be(m,y,Z){this.props=m,this.context=y,this.refs=M,this.updater=Z||de}var O=be.prototype=new xe;O.constructor=be,oe(O,G.prototype),O.isPureReactComponent=!0;var q=Array.isArray,T=Object.prototype.hasOwnProperty,g={current:null},w={key:!0,ref:!0,__self:!0,__source:!0};function $(m,y,Z){var J,X={},ee=null,le=null;if(y!=null)for(J in y.ref!==void 0&&(le=y.ref),y.key!==void 0&&(ee=""+y.key),y)T.call(y,J)&&!w.hasOwnProperty(J)&&(X[J]=y[J]);var ie=arguments.length-2;if(ie===1)X.children=Z;else if(1<ie){for(var pe=Array(ie),Je=0;Je<ie;Je++)pe[Je]=arguments[Je+2];X.children=pe}if(m&&m.defaultProps)for(J in ie=m.defaultProps,ie)X[J]===void 0&&(X[J]=ie[J]);return{$$typeof:S,type:m,key:ee,ref:le,props:X,_owner:g.current}}function ke(m,y){return{$$typeof:S,type:m.type,key:y,ref:m.ref,props:m.props,_owner:m._owner}}function fe(m){return typeof m=="object"&&m!==null&&m.$$typeof===S}function ot(m){var y={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(Z){return y[Z]})}var vt=/\/+/g;function We(m,y){return typeof m=="object"&&m!==null&&m.key!=null?ot(""+m.key):y.toString(36)}function lt(m,y,Z,J,X){var ee=typeof m;(ee==="undefined"||ee==="boolean")&&(m=null);var le=!1;if(m===null)le=!0;else switch(ee){case"string":case"number":le=!0;break;case"object":switch(m.$$typeof){case S:case E:le=!0}}if(le)return le=m,X=X(le),m=J===""?"."+We(le,0):J,q(X)?(Z="",m!=null&&(Z=m.replace(vt,"$&/")+"/"),lt(X,y,Z,"",function(Je){return Je})):X!=null&&(fe(X)&&(X=ke(X,Z+(!X.key||le&&le.key===X.key?"":(""+X.key).replace(vt,"$&/")+"/")+m)),y.push(X)),1;if(le=0,J=J===""?".":J+":",q(m))for(var ie=0;ie<m.length;ie++){ee=m[ie];var pe=J+We(ee,ie);le+=lt(ee,y,Z,pe,X)}else if(pe=Y(m),typeof pe=="function")for(m=pe.call(m),ie=0;!(ee=m.next()).done;)ee=ee.value,pe=J+We(ee,ie++),le+=lt(ee,y,Z,pe,X);else if(ee==="object")throw y=String(m),Error("Objects are not valid as a React child (found: "+(y==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":y)+"). If you meant to render a collection of children, use an array instead.");return le}function ht(m,y,Z){if(m==null)return m;var J=[],X=0;return lt(m,J,"","",function(ee){return y.call(Z,ee,X++)}),J}function Be(m){if(m._status===-1){var y=m._result;y=y(),y.then(function(Z){(m._status===0||m._status===-1)&&(m._status=1,m._result=Z)},function(Z){(m._status===0||m._status===-1)&&(m._status=2,m._result=Z)}),m._status===-1&&(m._status=0,m._result=y)}if(m._status===1)return m._result.default;throw m._result}var ge={current:null},C={transition:null},B={ReactCurrentDispatcher:ge,ReactCurrentBatchConfig:C,ReactCurrentOwner:g};function b(){throw Error("act(...) is not supported in production builds of React.")}return W.Children={map:ht,forEach:function(m,y,Z){ht(m,function(){y.apply(this,arguments)},Z)},count:function(m){var y=0;return ht(m,function(){y++}),y},toArray:function(m){return ht(m,function(y){return y})||[]},only:function(m){if(!fe(m))throw Error("React.Children.only expected to receive a single React element child.");return m}},W.Component=G,W.Fragment=_,W.Profiler=A,W.PureComponent=be,W.StrictMode=U,W.Suspense=j,W.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=B,W.act=b,W.cloneElement=function(m,y,Z){if(m==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+m+".");var J=oe({},m.props),X=m.key,ee=m.ref,le=m._owner;if(y!=null){if(y.ref!==void 0&&(ee=y.ref,le=g.current),y.key!==void 0&&(X=""+y.key),m.type&&m.type.defaultProps)var ie=m.type.defaultProps;for(pe in y)T.call(y,pe)&&!w.hasOwnProperty(pe)&&(J[pe]=y[pe]===void 0&&ie!==void 0?ie[pe]:y[pe])}var pe=arguments.length-2;if(pe===1)J.children=Z;else if(1<pe){ie=Array(pe);for(var Je=0;Je<pe;Je++)ie[Je]=arguments[Je+2];J.children=ie}return{$$typeof:S,type:m.type,key:X,ref:ee,props:J,_owner:le}},W.createContext=function(m){return m={$$typeof:K,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},m.Provider={$$typeof:H,_context:m},m.Consumer=m},W.createElement=$,W.createFactory=function(m){var y=$.bind(null,m);return y.type=m,y},W.createRef=function(){return{current:null}},W.forwardRef=function(m){return{$$typeof:ne,render:m}},W.isValidElement=fe,W.lazy=function(m){return{$$typeof:ae,_payload:{_status:-1,_result:m},_init:Be}},W.memo=function(m,y){return{$$typeof:me,type:m,compare:y===void 0?null:y}},W.startTransition=function(m){var y=C.transition;C.transition={};try{m()}finally{C.transition=y}},W.unstable_act=b,W.useCallback=function(m,y){return ge.current.useCallback(m,y)},W.useContext=function(m){return ge.current.useContext(m)},W.useDebugValue=function(){},W.useDeferredValue=function(m){return ge.current.useDeferredValue(m)},W.useEffect=function(m,y){return ge.current.useEffect(m,y)},W.useId=function(){return ge.current.useId()},W.useImperativeHandle=function(m,y,Z){return ge.current.useImperativeHandle(m,y,Z)},W.useInsertionEffect=function(m,y){return ge.current.useInsertionEffect(m,y)},W.useLayoutEffect=function(m,y){return ge.current.useLayoutEffect(m,y)},W.useMemo=function(m,y){return ge.current.useMemo(m,y)},W.useReducer=function(m,y,Z){return ge.current.useReducer(m,y,Z)},W.useRef=function(m){return ge.current.useRef(m)},W.useState=function(m){return ge.current.useState(m)},W.useSyncExternalStore=function(m,y,Z){return ge.current.useSyncExternalStore(m,y,Z)},W.useTransition=function(){return ge.current.useTransition()},W.version="18.3.1",W}var Ic;function Mo(){return Ic||(Ic=1,Ao.exports=Dm()),Ao.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ec;function Vm(){if(Ec)return fi;Ec=1;var S=Mo(),E=Symbol.for("react.element"),_=Symbol.for("react.fragment"),U=Object.prototype.hasOwnProperty,A=S.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,H={key:!0,ref:!0,__self:!0,__source:!0};function K(ne,j,me){var ae,x={},Y=null,de=null;me!==void 0&&(Y=""+me),j.key!==void 0&&(Y=""+j.key),j.ref!==void 0&&(de=j.ref);for(ae in j)U.call(j,ae)&&!H.hasOwnProperty(ae)&&(x[ae]=j[ae]);if(ne&&ne.defaultProps)for(ae in j=ne.defaultProps,j)x[ae]===void 0&&(x[ae]=j[ae]);return{$$typeof:E,type:ne,key:Y,ref:de,props:x,_owner:A.current}}return fi.Fragment=_,fi.jsx=K,fi.jsxs=K,fi}var Rc;function wm(){return Rc||(Rc=1,bo.exports=Vm()),bo.exports}var u=wm(),ve=Mo(),Er={},To={exports:{}},Ze={},Io={exports:{}},Eo={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lc;function Hm(){return Lc||(Lc=1,(function(S){function E(C,B){var b=C.length;C.push(B);e:for(;0<b;){var m=b-1>>>1,y=C[m];if(0<A(y,B))C[m]=B,C[b]=y,b=m;else break e}}function _(C){return C.length===0?null:C[0]}function U(C){if(C.length===0)return null;var B=C[0],b=C.pop();if(b!==B){C[0]=b;e:for(var m=0,y=C.length,Z=y>>>1;m<Z;){var J=2*(m+1)-1,X=C[J],ee=J+1,le=C[ee];if(0>A(X,b))ee<y&&0>A(le,X)?(C[m]=le,C[ee]=b,m=ee):(C[m]=X,C[J]=b,m=J);else if(ee<y&&0>A(le,b))C[m]=le,C[ee]=b,m=ee;else break e}}return B}function A(C,B){var b=C.sortIndex-B.sortIndex;return b!==0?b:C.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var H=performance;S.unstable_now=function(){return H.now()}}else{var K=Date,ne=K.now();S.unstable_now=function(){return K.now()-ne}}var j=[],me=[],ae=1,x=null,Y=3,de=!1,oe=!1,M=!1,G=typeof setTimeout=="function"?setTimeout:null,xe=typeof clearTimeout=="function"?clearTimeout:null,be=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function O(C){for(var B=_(me);B!==null;){if(B.callback===null)U(me);else if(B.startTime<=C)U(me),B.sortIndex=B.expirationTime,E(j,B);else break;B=_(me)}}function q(C){if(M=!1,O(C),!oe)if(_(j)!==null)oe=!0,Be(T);else{var B=_(me);B!==null&&ge(q,B.startTime-C)}}function T(C,B){oe=!1,M&&(M=!1,xe($),$=-1),de=!0;var b=Y;try{for(O(B),x=_(j);x!==null&&(!(x.expirationTime>B)||C&&!ot());){var m=x.callback;if(typeof m=="function"){x.callback=null,Y=x.priorityLevel;var y=m(x.expirationTime<=B);B=S.unstable_now(),typeof y=="function"?x.callback=y:x===_(j)&&U(j),O(B)}else U(j);x=_(j)}if(x!==null)var Z=!0;else{var J=_(me);J!==null&&ge(q,J.startTime-B),Z=!1}return Z}finally{x=null,Y=b,de=!1}}var g=!1,w=null,$=-1,ke=5,fe=-1;function ot(){return!(S.unstable_now()-fe<ke)}function vt(){if(w!==null){var C=S.unstable_now();fe=C;var B=!0;try{B=w(!0,C)}finally{B?We():(g=!1,w=null)}}else g=!1}var We;if(typeof be=="function")We=function(){be(vt)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,ht=lt.port2;lt.port1.onmessage=vt,We=function(){ht.postMessage(null)}}else We=function(){G(vt,0)};function Be(C){w=C,g||(g=!0,We())}function ge(C,B){$=G(function(){C(S.unstable_now())},B)}S.unstable_IdlePriority=5,S.unstable_ImmediatePriority=1,S.unstable_LowPriority=4,S.unstable_NormalPriority=3,S.unstable_Profiling=null,S.unstable_UserBlockingPriority=2,S.unstable_cancelCallback=function(C){C.callback=null},S.unstable_continueExecution=function(){oe||de||(oe=!0,Be(T))},S.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<C?Math.floor(1e3/C):5},S.unstable_getCurrentPriorityLevel=function(){return Y},S.unstable_getFirstCallbackNode=function(){return _(j)},S.unstable_next=function(C){switch(Y){case 1:case 2:case 3:var B=3;break;default:B=Y}var b=Y;Y=B;try{return C()}finally{Y=b}},S.unstable_pauseExecution=function(){},S.unstable_requestPaint=function(){},S.unstable_runWithPriority=function(C,B){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var b=Y;Y=C;try{return B()}finally{Y=b}},S.unstable_scheduleCallback=function(C,B,b){var m=S.unstable_now();switch(typeof b=="object"&&b!==null?(b=b.delay,b=typeof b=="number"&&0<b?m+b:m):b=m,C){case 1:var y=-1;break;case 2:y=250;break;case 5:y=1073741823;break;case 4:y=1e4;break;default:y=5e3}return y=b+y,C={id:ae++,callback:B,priorityLevel:C,startTime:b,expirationTime:y,sortIndex:-1},b>m?(C.sortIndex=b,E(me,C),_(j)===null&&C===_(me)&&(M?(xe($),$=-1):M=!0,ge(q,b-m))):(C.sortIndex=y,E(j,C),oe||de||(oe=!0,Be(T))),C},S.unstable_shouldYield=ot,S.unstable_wrapCallback=function(C){var B=Y;return function(){var b=Y;Y=B;try{return C.apply(this,arguments)}finally{Y=b}}}})(Eo)),Eo}var Mc;function jm(){return Mc||(Mc=1,Io.exports=Hm()),Io.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var xc;function Bm(){if(xc)return Ze;xc=1;var S=Mo(),E=jm();function _(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var U=new Set,A={};function H(e,t){K(e,t),K(e+"Capture",t)}function K(e,t){for(A[e]=t,e=0;e<t.length;e++)U.add(t[e])}var ne=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),j=Object.prototype.hasOwnProperty,me=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,ae={},x={};function Y(e){return j.call(x,e)?!0:j.call(ae,e)?!1:me.test(e)?x[e]=!0:(ae[e]=!0,!1)}function de(e,t,n,i){if(n!==null&&n.type===0)return!1;switch(typeof t){case"function":case"symbol":return!0;case"boolean":return i?!1:n!==null?!n.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function oe(e,t,n,i){if(t===null||typeof t>"u"||de(e,t,n,i))return!0;if(i)return!1;if(n!==null)switch(n.type){case 3:return!t;case 4:return t===!1;case 5:return isNaN(t);case 6:return isNaN(t)||1>t}return!1}function M(e,t,n,i,r,a,o){this.acceptsBooleans=t===2||t===3||t===4,this.attributeName=i,this.attributeNamespace=r,this.mustUseProperty=n,this.propertyName=e,this.type=t,this.sanitizeURL=a,this.removeEmptyString=o}var G={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){G[e]=new M(e,0,!1,e,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0];G[t]=new M(t,1,!1,e[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(e){G[e]=new M(e,2,!1,e.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){G[e]=new M(e,2,!1,e,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){G[e]=new M(e,3,!1,e.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(e){G[e]=new M(e,3,!0,e,null,!1,!1)}),["capture","download"].forEach(function(e){G[e]=new M(e,4,!1,e,null,!1,!1)}),["cols","rows","size","span"].forEach(function(e){G[e]=new M(e,6,!1,e,null,!1,!1)}),["rowSpan","start"].forEach(function(e){G[e]=new M(e,5,!1,e.toLowerCase(),null,!1,!1)});var xe=/[\-:]([a-z])/g;function be(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var t=e.replace(xe,be);G[t]=new M(t,1,!1,e,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var t=e.replace(xe,be);G[t]=new M(t,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(xe,be);G[t]=new M(t,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(e){G[e]=new M(e,1,!1,e.toLowerCase(),null,!1,!1)}),G.xlinkHref=new M("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(e){G[e]=new M(e,1,!1,e.toLowerCase(),null,!0,!0)});function O(e,t,n,i){var r=G.hasOwnProperty(t)?G[t]:null;(r!==null?r.type!==0:i||!(2<t.length)||t[0]!=="o"&&t[0]!=="O"||t[1]!=="n"&&t[1]!=="N")&&(oe(t,n,r,i)&&(n=null),i||r===null?Y(t)&&(n===null?e.removeAttribute(t):e.setAttribute(t,""+n)):r.mustUseProperty?e[r.propertyName]=n===null?r.type===3?!1:"":n:(t=r.attributeName,i=r.attributeNamespace,n===null?e.removeAttribute(t):(r=r.type,n=r===3||r===4&&n===!0?"":""+n,i?e.setAttributeNS(i,t,n):e.setAttribute(t,n))))}var q=S.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,T=Symbol.for("react.element"),g=Symbol.for("react.portal"),w=Symbol.for("react.fragment"),$=Symbol.for("react.strict_mode"),ke=Symbol.for("react.profiler"),fe=Symbol.for("react.provider"),ot=Symbol.for("react.context"),vt=Symbol.for("react.forward_ref"),We=Symbol.for("react.suspense"),lt=Symbol.for("react.suspense_list"),ht=Symbol.for("react.memo"),Be=Symbol.for("react.lazy"),ge=Symbol.for("react.offscreen"),C=Symbol.iterator;function B(e){return e===null||typeof e!="object"?null:(e=C&&e[C]||e["@@iterator"],typeof e=="function"?e:null)}var b=Object.assign,m;function y(e){if(m===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);m=t&&t[1]||""}return`
...
`+r[o].replace(" at new "," at ");return e.displayName&&s.includes("<anonymous>")&&(s=s.replace("<anonymous>",e.displayName)),s}while(1<=o&&0<=l);break}}}finally{Z=!1,Error.prepareStackTrace=n}return(e=e?e.displayName||e.name:"")?y(e):""}function X(e){switch(e.tag){case 5:return y(e.type);case 16:return y("Lazy");case 13:return y("Suspense");case 19:return y("SuspenseList");case 0:case 2:case 15:return e=J(e.type,!1),e;case 11:return e=J(e.type.render,!1),e;case 1:return e=J(e.type,!0),e;default:return""}}function ee(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case w:return"Fragment";case g:return"Portal";case ke:return"Profiler";case $:return"StrictMode";case We:return"Suspense";case lt:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case ot:return(e.displayName||"Context")+".Consumer";case fe:return(e._context.displayName||"Context")+".Provider";case vt:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case ht:return t=e.displayName||null,t!==null?t:ee(e.type)||"Memo";case Be:t=e._payload,e=e._init;try{return ee(e(t))}catch{}}return null}function le(e){var t=e.type;switch(e.tag){case 24:return"Cache";case 9:return(t.displayName||"Context")+".Consumer";case 10:return(t._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return e=t.render,e=e.displayName||e.name||"",t.displayName||(e!==""?"ForwardRef("+e+")":"ForwardRef");case 7:return"Fragment";case 5:return t;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return ee(t);case 8:return t===$?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof t=="function")return t.displayName||t.name||null;if(typeof t=="string")return t}return null}function ie(e){switch(typeof e){case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function pe(e){var t=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(t==="checkbox"||t==="radio")}function Je(e){var t=pe(e)?"checked":"value",n=Object.getOwnPropertyDescriptor(e.constructor.prototype,t),i=""+e[t];if(!e.hasOwnProperty(t)&&typeof n<"u"&&typeof n.get=="function"&&typeof n.set=="function"){var r=n.get,a=n.set;return Object.defineProperty(e,t,{configurable:!0,get:function(){return r.call(this)},set:function(o){i=""+o,a.call(this,o)}}),Object.defineProperty(e,t,{enumerable:n.enumerable}),{getValue:function(){return i},setValue:function(o){i=""+o},stopTracking:function(){e._valueTracker=null,delete e[t]}}}}function gi(e){e._valueTracker||(e._valueTracker=Je(e))}function xo(e){if(!e)return!1;var t=e._valueTracker;if(!t)return!0;var n=t.getValue(),i="";return e&&(i=pe(e)?e.checked?"true":"false":e.value),e=i,e!==n?(t.setValue(e),!0):!1}function Ni(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}function Lr(e,t){var n=t.checked;return b({},t,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:n??e._wrapperState.initialChecked})}function Oo(e,t){var n=t.defaultValue==null?"":t.defaultValue,i=t.checked!=null?t.checked:t.defaultChecked;n=ie(t.value!=null?t.value:n),e._wrapperState={initialChecked:i,initialValue:n,controlled:t.type==="checkbox"||t.type==="radio"?t.checked!=null:t.value!=null}}function Do(e,t){t=t.checked,t!=null&&O(e,"checked",t,!1)}function Mr(e,t){Do(e,t);var n=ie(t.value),i=t.type;if(n!=null)i==="number"?(n===0&&e.value===""||e.value!=n)&&(e.value=""+n):e.value!==""+n&&(e.value=""+n);else if(i==="submit"||i==="reset"){e.removeAttribute("value");return}t.hasOwnProperty("value")?xr(e,t.type,n):t.hasOwnProperty("defaultValue")&&xr(e,t.type,ie(t.defaultValue)),t.checked==null&&t.defaultChecked!=null&&(e.defaultChecked=!!t.defaultChecked)}function Vo(e,t,n){if(t.hasOwnProperty("value")||t.hasOwnProperty("defaultValue")){var i=t.type;if(!(i!=="submit"&&i!=="reset"||t.value!==void 0&&t.value!==null))return;t=""+e._wrapperState.initialValue,n||t===e.value||(e.value=t),e.defaultValue=t}n=e.name,n!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,n!==""&&(e.name=n)}function xr(e,t,n){(t!=="number"||Ni(e.ownerDocument)!==e)&&(n==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+n&&(e.defaultValue=""+n))}var xn=Array.isArray;function cn(e,t,n,i){if(e=e.options,t){t={};for(var r=0;r<n.length;r++)t["$"+n[r]]=!0;for(n=0;n<e.length;n++)r=t.hasOwnProperty("$"+e[n].value),e[n].selected!==r&&(e[n].selected=r),r&&i&&(e[n].defaultSelected=!0)}else{for(n=""+ie(n),t=null,r=0;r<e.length;r++){if(e[r].value===n){e[r].selected=!0,i&&(e[r].defaultSelected=!0);return}t!==null||e[r].disabled||(t=e[r])}t!==null&&(t.selected=!0)}}function Or(e,t){if(t.dangerouslySetInnerHTML!=null)throw Error(_(91));return b({},t,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function wo(e,t){var n=t.value;if(n==null){if(n=t.children,t=t.defaultValue,n!=null){if(t!=null)throw Error(_(92));if(xn(n)){if(1<n.length)throw Error(_(93));n=n[0]}t=n}t==null&&(t=""),n=t}e._wrapperState={initialValue:ie(n)}}function Ho(e,t){var n=ie(t.value),i=ie(t.defaultValue);n!=null&&(n=""+n,n!==e.value&&(e.value=n),t.defaultValue==null&&e.defaultValue!==n&&(e.defaultValue=n)),i!=null&&(e.defaultValue=""+i)}function jo(e){var t=e.textContent;t===e._wrapperState.initialValue&&t!==""&&t!==null&&(e.value=t)}function Bo(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function Dr(e,t){return e==null||e==="http://www.w3.org/1999/xhtml"?Bo(t):e==="http://www.w3.org/2000/svg"&&t==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Si,Fo=(function(e){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(t,n,i,r){MSApp.execUnsafeLocalFunction(function(){return e(t,n,i,r)})}:e})(function(e,t){if(e.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in e)e.innerHTML=t;else{for(Si=Si||document.createElement("div"),Si.innerHTML="<svg>"+t.valueOf().toString()+"</svg>",t=Si.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;t.firstChild;)e.appendChild(t.firstChild)}});function On(e,t){if(t){var n=e.firstChild;if(n&&n===e.lastChild&&n.nodeType===3){n.nodeValue=t;return}}e.textContent=t}var Dn={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},jc=["Webkit","ms","Moz","O"];Object.keys(Dn).forEach(function(e){jc.forEach(function(t){t=t+e.charAt(0).toUpperCase()+e.substring(1),Dn[t]=Dn[e]})});function Uo(e,t,n){return t==null||typeof t=="boolean"||t===""?"":n||typeof t!="number"||t===0||Dn.hasOwnProperty(e)&&Dn[e]?(""+t).trim():t+"px"}function Ko(e,t){e=e.style;for(var n in t)if(t.hasOwnProperty(n)){var i=n.indexOf("--")===0,r=Uo(n,t[n],i);n==="float"&&(n="cssFloat"),i?e.setProperty(n,r):e[n]=r}}var Bc=b({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function Vr(e,t){if(t){if(Bc[e]&&(t.children!=null||t.dangerouslySetInnerHTML!=null))throw Error(_(137,e));if(t.dangerouslySetInnerHTML!=null){if(t.children!=null)throw Error(_(60));if(typeof t.dangerouslySetInnerHTML!="object"||!("__html"in t.dangerouslySetInnerHTML))throw Error(_(61))}if(t.style!=null&&typeof t.style!="object")throw Error(_(62))}}function wr(e,t){if(e.indexOf("-")===-1)return typeof t.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var Hr=null;function jr(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var Br=null,un=null,mn=null;function Yo(e){if(e=ri(e)){if(typeof Br!="function")throw Error(_(280));var t=e.stateNode;t&&(t=Yi(t),Br(e.stateNode,e.type,t))}}function Go(e){un?mn?mn.push(e):mn=[e]:un=e}function Zo(){if(un){var e=un,t=mn;if(mn=un=null,Yo(e),t)for(e=0;e<t.length;e++)Yo(t[e])}}function Wo(e,t){return e(t)}function Jo(){}var Fr=!1;function qo(e,t,n){if(Fr)return e(t,n);Fr=!0;try{return Wo(e,t,n)}finally{Fr=!1,(un!==null||mn!==null)&&(Jo(),Zo())}}function Vn(e,t){var n=e.stateNode;if(n===null)return null;var i=Yi(n);if(i===null)return null;n=i[t];e:switch(t){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(e=e.type,i=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!i;break e;default:e=!1}if(e)return null;if(n&&typeof n!="function")throw Error(_(231,t,typeof n));return n}var Ur=!1;if(ne)try{var wn={};Object.defineProperty(wn,"passive",{get:function(){Ur=!0}}),window.addEventListener("test",wn,wn),window.removeEventListener("test",wn,wn)}catch{Ur=!1}function Fc(e,t,n,i,r,a,o,l,s){var v=Array.prototype.slice.call(arguments,3);try{t.apply(n,v)}catch(k){this.onError(k)}}var Hn=!1,Ci=null,zi=!1,Kr=null,Uc={onError:function(e){Hn=!0,Ci=e}};function Kc(e,t,n,i,r,a,o,l,s){Hn=!1,Ci=null,Fc.apply(Uc,arguments)}function Yc(e,t,n,i,r,a,o,l,s){if(Kc.apply(this,arguments),Hn){if(Hn){var v=Ci;Hn=!1,Ci=null}else throw Error(_(198));zi||(zi=!0,Kr=v)}}function Jt(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function $o(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function Qo(e){if(Jt(e)!==e)throw Error(_(188))}function Gc(e){var t=e.alternate;if(!t){if(t=Jt(e),t===null)throw Error(_(188));return t!==e?null:e}for(var n=e,i=t;;){var r=n.return;if(r===null)break;var a=r.alternate;if(a===null){if(i=r.return,i!==null){n=i;continue}break}if(r.child===a.child){for(a=r.child;a;){if(a===n)return Qo(r),e;if(a===i)return Qo(r),t;a=a.sibling}throw Error(_(188))}if(n.return!==i.return)n=r,i=a;else{for(var o=!1,l=r.child;l;){if(l===n){o=!0,n=r,i=a;break}if(l===i){o=!0,i=r,n=a;break}l=l.sibling}if(!o){for(l=a.child;l;){if(l===n){o=!0,n=a,i=r;break}if(l===i){o=!0,i=a,n=r;break}l=l.sibling}if(!o)throw Error(_(189))}}if(n.alternate!==i)throw Error(_(190))}if(n.tag!==3)throw Error(_(188));return n.stateNode.current===n?e:t}function Xo(e){return e=Gc(e),e!==null?el(e):null}function el(e){if(e.tag===5||e.tag===6)return e;for(e=e.child;e!==null;){var t=el(e);if(t!==null)return t;e=e.sibling}return null}var tl=E.unstable_scheduleCallback,nl=E.unstable_cancelCallback,Zc=E.unstable_shouldYield,Wc=E.unstable_requestPaint,Se=E.unstable_now,Jc=E.unstable_getCurrentPriorityLevel,Yr=E.unstable_ImmediatePriority,il=E.unstable_UserBlockingPriority,Pi=E.unstable_NormalPriority,qc=E.unstable_LowPriority,rl=E.unstable_IdlePriority,bi=null,yt=null;function $c(e){if(yt&&typeof yt.onCommitFiberRoot=="function")try{yt.onCommitFiberRoot(bi,e,void 0,(e.current.flags&128)===128)}catch{}}var st=Math.clz32?Math.clz32:eu,Qc=Math.log,Xc=Math.LN2;function eu(e){return e>>>=0,e===0?32:31-(Qc(e)/Xc|0)|0}var Ai=64,Ti=4194304;function jn(e){switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return e&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return e}}function Ii(e,t){var n=e.pendingLanes;if(n===0)return 0;var i=0,r=e.suspendedLanes,a=e.pingedLanes,o=n&268435455;if(o!==0){var l=o&~r;l!==0?i=jn(l):(a&=o,a!==0&&(i=jn(a)))}else o=n&~r,o!==0?i=jn(o):a!==0&&(i=jn(a));if(i===0)return 0;if(t!==0&&t!==i&&(t&r)===0&&(r=i&-i,a=t&-t,r>=a||r===16&&(a&4194240)!==0))return t;if((i&4)!==0&&(i|=n&16),t=e.entangledLanes,t!==0)for(e=e.entanglements,t&=i;0<t;)n=31-st(t),r=1<<n,i|=e[n],t&=~r;return i}function tu(e,t){switch(e){case 1:case 2:case 4:return t+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return t+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function nu(e,t){for(var n=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,a=e.pendingLanes;0<a;){var o=31-st(a),l=1<<o,s=r[o];s===-1?((l&n)===0||(l&i)!==0)&&(r[o]=tu(l,t)):s<=t&&(e.expiredLanes|=l),a&=~l}}function Gr(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function al(){var e=Ai;return Ai<<=1,(Ai&4194240)===0&&(Ai=64),e}function Zr(e){for(var t=[],n=0;31>n;n++)t.push(e);return t}function Bn(e,t,n){e.pendingLanes|=t,t!==536870912&&(e.suspendedLanes=0,e.pingedLanes=0),e=e.eventTimes,t=31-st(t),e[t]=n}function iu(e,t){var n=e.pendingLanes&~t;e.pendingLanes=t,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=t,e.mutableReadLanes&=t,e.entangledLanes&=t,t=e.entanglements;var i=e.eventTimes;for(e=e.expirationTimes;0<n;){var r=31-st(n),a=1<<r;t[r]=0,i[r]=-1,e[r]=-1,n&=~a}}function Wr(e,t){var n=e.entangledLanes|=t;for(e=e.entanglements;n;){var i=31-st(n),r=1<<i;r&t|e[i]&t&&(e[i]|=t),n&=~r}}var re=0;function ol(e){return e&=-e,1<e?4<e?(e&268435455)!==0?16:536870912:4:1}var ll,Jr,sl,cl,ul,qr=!1,Ei=[],Et=null,Rt=null,Lt=null,Fn=new Map,Un=new Map,Mt=[],ru="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function ml(e,t){switch(e){case"focusin":case"focusout":Et=null;break;case"dragenter":case"dragleave":Rt=null;break;case"mouseover":case"mouseout":Lt=null;break;case"pointerover":case"pointerout":Fn.delete(t.pointerId);break;case"gotpointercapture":case"lostpointercapture":Un.delete(t.pointerId)}}function Kn(e,t,n,i,r,a){return e===null||e.nativeEvent!==a?(e={blockedOn:t,domEventName:n,eventSystemFlags:i,nativeEvent:a,targetContainers:[r]},t!==null&&(t=ri(t),t!==null&&Jr(t)),e):(e.eventSystemFlags|=i,t=e.targetContainers,r!==null&&t.indexOf(r)===-1&&t.push(r),e)}function au(e,t,n,i,r){switch(t){case"focusin":return Et=Kn(Et,e,t,n,i,r),!0;case"dragenter":return Rt=Kn(Rt,e,t,n,i,r),!0;case"mouseover":return Lt=Kn(Lt,e,t,n,i,r),!0;case"pointerover":var a=r.pointerId;return Fn.set(a,Kn(Fn.get(a)||null,e,t,n,i,r)),!0;case"gotpointercapture":return a=r.pointerId,Un.set(a,Kn(Un.get(a)||null,e,t,n,i,r)),!0}return!1}function dl(e){var t=qt(e.target);if(t!==null){var n=Jt(t);if(n!==null){if(t=n.tag,t===13){if(t=$o(n),t!==null){e.blockedOn=t,ul(e.priority,function(){sl(n)});return}}else if(t===3&&n.stateNode.current.memoizedState.isDehydrated){e.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Ri(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var n=Qr(e.domEventName,e.eventSystemFlags,t[0],e.nativeEvent);if(n===null){n=e.nativeEvent;var i=new n.constructor(n.type,n);Hr=i,n.target.dispatchEvent(i),Hr=null}else return t=ri(n),t!==null&&Jr(t),e.blockedOn=n,!1;t.shift()}return!0}function pl(e,t,n){Ri(e)&&n.delete(t)}function ou(){qr=!1,Et!==null&&Ri(Et)&&(Et=null),Rt!==null&&Ri(Rt)&&(Rt=null),Lt!==null&&Ri(Lt)&&(Lt=null),Fn.forEach(pl),Un.forEach(pl)}function Yn(e,t){e.blockedOn===t&&(e.blockedOn=null,qr||(qr=!0,E.unstable_scheduleCallback(E.unstable_NormalPriority,ou)))}function Gn(e){function t(r){return Yn(r,e)}if(0<Ei.length){Yn(Ei[0],e);for(var n=1;n<Ei.length;n++){var i=Ei[n];i.blockedOn===e&&(i.blockedOn=null)}}for(Et!==null&&Yn(Et,e),Rt!==null&&Yn(Rt,e),Lt!==null&&Yn(Lt,e),Fn.forEach(t),Un.forEach(t),n=0;n<Mt.length;n++)i=Mt[n],i.blockedOn===e&&(i.blockedOn=null);for(;0<Mt.length&&(n=Mt[0],n.blockedOn===null);)dl(n),n.blockedOn===null&&Mt.shift()}var dn=q.ReactCurrentBatchConfig,Li=!0;function lu(e,t,n,i){var r=re,a=dn.transition;dn.transition=null;try{re=1,$r(e,t,n,i)}finally{re=r,dn.transition=a}}function su(e,t,n,i){var r=re,a=dn.transition;dn.transition=null;try{re=4,$r(e,t,n,i)}finally{re=r,dn.transition=a}}function $r(e,t,n,i){if(Li){var r=Qr(e,t,n,i);if(r===null)va(e,t,i,Mi,n),ml(e,i);else if(au(r,e,t,n,i))i.stopPropagation();else if(ml(e,i),t&4&&-1<ru.indexOf(e)){for(;r!==null;){var a=ri(r);if(a!==null&&ll(a),a=Qr(e,t,n,i),a===null&&va(e,t,i,Mi,n),a===r)break;r=a}r!==null&&i.stopPropagation()}else va(e,t,i,null,n)}}var Mi=null;function Qr(e,t,n,i){if(Mi=null,e=jr(i),e=qt(e),e!==null)if(t=Jt(e),t===null)e=null;else if(n=t.tag,n===13){if(e=$o(t),e!==null)return e;e=null}else if(n===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null);return Mi=e,null}function _l(e){switch(e){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(Jc()){case Yr:return 1;case il:return 4;case Pi:case qc:return 16;case rl:return 536870912;default:return 16}default:return 16}}var xt=null,Xr=null,xi=null;function vl(){if(xi)return xi;var e,t=Xr,n=t.length,i,r="value"in xt?xt.value:xt.textContent,a=r.length;for(e=0;e<n&&t[e]===r[e];e++);var o=n-e;for(i=1;i<=o&&t[n-i]===r[a-i];i++);return xi=r.slice(e,1<i?1-i:void 0)}function Oi(e){var t=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&t===13&&(e=13)):e=t,e===10&&(e=13),32<=e||e===13?e:0}function Di(){return!0}function hl(){return!1}function qe(e){function t(n,i,r,a,o){this._reactName=n,this._targetInst=r,this.type=i,this.nativeEvent=a,this.target=o,this.currentTarget=null;for(var l in e)e.hasOwnProperty(l)&&(n=e[l],this[l]=n?n(a):a[l]);return this.isDefaultPrevented=(a.defaultPrevented!=null?a.defaultPrevented:a.returnValue===!1)?Di:hl,this.isPropagationStopped=hl,this}return b(t.prototype,{preventDefault:function(){this.defaultPrevented=!0;var n=this.nativeEvent;n&&(n.preventDefault?n.preventDefault():typeof n.returnValue!="unknown"&&(n.returnValue=!1),this.isDefaultPrevented=Di)},stopPropagation:function(){var n=this.nativeEvent;n&&(n.stopPropagation?n.stopPropagation():typeof n.cancelBubble!="unknown"&&(n.cancelBubble=!0),this.isPropagationStopped=Di)},persist:function(){},isPersistent:Di}),t}var pn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},ea=qe(pn),Zn=b({},pn,{view:0,detail:0}),cu=qe(Zn),ta,na,Wn,Vi=b({},Zn,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:ra,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Wn&&(Wn&&e.type==="mousemove"?(ta=e.screenX-Wn.screenX,na=e.screenY-Wn.screenY):na=ta=0,Wn=e),ta)},movementY:function(e){return"movementY"in e?e.movementY:na}}),yl=qe(Vi),uu=b({},Vi,{dataTransfer:0}),mu=qe(uu),du=b({},Zn,{relatedTarget:0}),ia=qe(du),pu=b({},pn,{animationName:0,elapsedTime:0,pseudoElement:0}),_u=qe(pu),vu=b({},pn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),hu=qe(vu),yu=b({},pn,{data:0}),kl=qe(yu),ku={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},fu={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},gu={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Nu(e){var t=this.nativeEvent;return t.getModifierState?t.getModifierState(e):(e=gu[e])?!!t[e]:!1}function ra(){return Nu}var Su=b({},Zn,{key:function(e){if(e.key){var t=ku[e.key]||e.key;if(t!=="Unidentified")return t}return e.type==="keypress"?(e=Oi(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?fu[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:ra,charCode:function(e){return e.type==="keypress"?Oi(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Oi(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),Cu=qe(Su),zu=b({},Vi,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),fl=qe(zu),Pu=b({},Zn,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:ra}),bu=qe(Pu),Au=b({},pn,{propertyName:0,elapsedTime:0,pseudoElement:0}),Tu=qe(Au),Iu=b({},Vi,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),Eu=qe(Iu),Ru=[9,13,27,32],aa=ne&&"CompositionEvent"in window,Jn=null;ne&&"documentMode"in document&&(Jn=document.documentMode);var Lu=ne&&"TextEvent"in window&&!Jn,gl=ne&&(!aa||Jn&&8<Jn&&11>=Jn),Nl=" ",Sl=!1;function Cl(e,t){switch(e){case"keyup":return Ru.indexOf(t.keyCode)!==-1;case"keydown":return t.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function zl(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var _n=!1;function Mu(e,t){switch(e){case"compositionend":return zl(t);case"keypress":return t.which!==32?null:(Sl=!0,Nl);case"textInput":return e=t.data,e===Nl&&Sl?null:e;default:return null}}function xu(e,t){if(_n)return e==="compositionend"||!aa&&Cl(e,t)?(e=vl(),xi=Xr=xt=null,_n=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(t.ctrlKey||t.altKey||t.metaKey)||t.ctrlKey&&t.altKey){if(t.char&&1<t.char.length)return t.char;if(t.which)return String.fromCharCode(t.which)}return null;case"compositionend":return gl&&t.locale!=="ko"?null:t.data;default:return null}}var Ou={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Pl(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t==="input"?!!Ou[e.type]:t==="textarea"}function bl(e,t,n,i){Go(i),t=Fi(t,"onChange"),0<t.length&&(n=new ea("onChange","change",null,n,i),e.push({event:n,listeners:t}))}var qn=null,$n=null;function Du(e){Kl(e,0)}function wi(e){var t=fn(e);if(xo(t))return e}function Vu(e,t){if(e==="change")return t}var Al=!1;if(ne){var oa;if(ne){var la="oninput"in document;if(!la){var Tl=document.createElement("div");Tl.setAttribute("oninput","return;"),la=typeof Tl.oninput=="function"}oa=la}else oa=!1;Al=oa&&(!document.documentMode||9<document.documentMode)}function Il(){qn&&(qn.detachEvent("onpropertychange",El),$n=qn=null)}function El(e){if(e.propertyName==="value"&&wi($n)){var t=[];bl(t,$n,e,jr(e)),qo(Du,t)}}function wu(e,t,n){e==="focusin"?(Il(),qn=t,$n=n,qn.attachEvent("onpropertychange",El)):e==="focusout"&&Il()}function Hu(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return wi($n)}function ju(e,t){if(e==="click")return wi(t)}function Bu(e,t){if(e==="input"||e==="change")return wi(t)}function Fu(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var ct=typeof Object.is=="function"?Object.is:Fu;function Qn(e,t){if(ct(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;var n=Object.keys(e),i=Object.keys(t);if(n.length!==i.length)return!1;for(i=0;i<n.length;i++){var r=n[i];if(!j.call(t,r)||!ct(e[r],t[r]))return!1}return!0}function Rl(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Ll(e,t){var n=Rl(e);e=0;for(var i;n;){if(n.nodeType===3){if(i=e+n.textContent.length,e<=t&&i>=t)return{node:n,offset:t-e};e=i}e:{for(;n;){if(n.nextSibling){n=n.nextSibling;break e}n=n.parentNode}n=void 0}n=Rl(n)}}function Ml(e,t){return e&&t?e===t?!0:e&&e.nodeType===3?!1:t&&t.nodeType===3?Ml(e,t.parentNode):"contains"in e?e.contains(t):e.compareDocumentPosition?!!(e.compareDocumentPosition(t)&16):!1:!1}function xl(){for(var e=window,t=Ni();t instanceof e.HTMLIFrameElement;){try{var n=typeof t.contentWindow.location.href=="string"}catch{n=!1}if(n)e=t.contentWindow;else break;t=Ni(e.document)}return t}function sa(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t&&(t==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||t==="textarea"||e.contentEditable==="true")}function Uu(e){var t=xl(),n=e.focusedElem,i=e.selectionRange;if(t!==n&&n&&n.ownerDocument&&Ml(n.ownerDocument.documentElement,n)){if(i!==null&&sa(n)){if(t=i.start,e=i.end,e===void 0&&(e=t),"selectionStart"in n)n.selectionStart=t,n.selectionEnd=Math.min(e,n.value.length);else if(e=(t=n.ownerDocument||document)&&t.defaultView||window,e.getSelection){e=e.getSelection();var r=n.textContent.length,a=Math.min(i.start,r);i=i.end===void 0?a:Math.min(i.end,r),!e.extend&&a>i&&(r=i,i=a,a=r),r=Ll(n,a);var o=Ll(n,i);r&&o&&(e.rangeCount!==1||e.anchorNode!==r.node||e.anchorOffset!==r.offset||e.focusNode!==o.node||e.focusOffset!==o.offset)&&(t=t.createRange(),t.setStart(r.node,r.offset),e.removeAllRanges(),a>i?(e.addRange(t),e.extend(o.node,o.offset)):(t.setEnd(o.node,o.offset),e.addRange(t)))}}for(t=[],e=n;e=e.parentNode;)e.nodeType===1&&t.push({element:e,left:e.scrollLeft,top:e.scrollTop});for(typeof n.focus=="function"&&n.focus(),n=0;n<t.length;n++)e=t[n],e.element.scrollLeft=e.left,e.element.scrollTop=e.top}}var Ku=ne&&"documentMode"in document&&11>=document.documentMode,vn=null,ca=null,Xn=null,ua=!1;function Ol(e,t,n){var i=n.window===n?n.document:n.nodeType===9?n:n.ownerDocument;ua||vn==null||vn!==Ni(i)||(i=vn,"selectionStart"in i&&sa(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),Xn&&Qn(Xn,i)||(Xn=i,i=Fi(ca,"onSelect"),0<i.length&&(t=new ea("onSelect","select",null,t,n),e.push({event:t,listeners:i}),t.target=vn)))}function Hi(e,t){var n={};return n[e.toLowerCase()]=t.toLowerCase(),n["Webkit"+e]="webkit"+t,n["Moz"+e]="moz"+t,n}var hn={animationend:Hi("Animation","AnimationEnd"),animationiteration:Hi("Animation","AnimationIteration"),animationstart:Hi("Animation","AnimationStart"),transitionend:Hi("Transition","TransitionEnd")},ma={},Dl={};ne&&(Dl=document.createElement("div").style,"AnimationEvent"in window||(delete hn.animationend.animation,delete hn.animationiteration.animation,delete hn.animationstart.animation),"TransitionEvent"in window||delete hn.transitionend.transition);function ji(e){if(ma[e])return ma[e];if(!hn[e])return e;var t=hn[e],n;for(n in t)if(t.hasOwnProperty(n)&&n in Dl)return ma[e]=t[n];return e}var Vl=ji("animationend"),wl=ji("animationiteration"),Hl=ji("animationstart"),jl=ji("transitionend"),Bl=new Map,Fl="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function Ot(e,t){Bl.set(e,t),H(t,[e])}for(var da=0;da<Fl.length;da++){var pa=Fl[da],Yu=pa.toLowerCase(),Gu=pa[0].toUpperCase()+pa.slice(1);Ot(Yu,"on"+Gu)}Ot(Vl,"onAnimationEnd"),Ot(wl,"onAnimationIteration"),Ot(Hl,"onAnimationStart"),Ot("dblclick","onDoubleClick"),Ot("focusin","onFocus"),Ot("focusout","onBlur"),Ot(jl,"onTransitionEnd"),K("onMouseEnter",["mouseout","mouseover"]),K("onMouseLeave",["mouseout","mouseover"]),K("onPointerEnter",["pointerout","pointerover"]),K("onPointerLeave",["pointerout","pointerover"]),H("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),H("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),H("onBeforeInput",["compositionend","keypress","textInput","paste"]),H("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),H("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),H("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var ei="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Zu=new Set("cancel close invalid load scroll toggle".split(" ").concat(ei));function Ul(e,t,n){var i=e.type||"unknown-event";e.currentTarget=n,Yc(i,t,void 0,e),e.currentTarget=null}function Kl(e,t){t=(t&4)!==0;for(var n=0;n<e.length;n++){var i=e[n],r=i.event;i=i.listeners;e:{var a=void 0;if(t)for(var o=i.length-1;0<=o;o--){var l=i[o],s=l.instance,v=l.currentTarget;if(l=l.listener,s!==a&&r.isPropagationStopped())break e;Ul(r,l,v),a=s}else for(o=0;o<i.length;o++){if(l=i[o],s=l.instance,v=l.currentTarget,l=l.listener,s!==a&&r.isPropagationStopped())break e;Ul(r,l,v),a=s}}}if(zi)throw e=Kr,zi=!1,Kr=null,e}function ce(e,t){var n=t[Na];n===void 0&&(n=t[Na]=new Set);var i=e+"__bubble";n.has(i)||(Yl(t,e,2,!1),n.add(i))}function _a(e,t,n){var i=0;t&&(i|=4),Yl(n,e,i,t)}var Bi="_reactListening"+Math.random().toString(36).slice(2);function ti(e){if(!e[Bi]){e[Bi]=!0,U.forEach(function(n){n!=="selectionchange"&&(Zu.has(n)||_a(n,!1,e),_a(n,!0,e))});var t=e.nodeType===9?e:e.ownerDocument;t===null||t[Bi]||(t[Bi]=!0,_a("selectionchange",!1,t))}}function Yl(e,t,n,i){switch(_l(t)){case 1:var r=lu;break;case 4:r=su;break;default:r=$r}n=r.bind(null,t,n,e),r=void 0,!Ur||t!=="touchstart"&&t!=="touchmove"&&t!=="wheel"||(r=!0),i?r!==void 0?e.addEventListener(t,n,{capture:!0,passive:r}):e.addEventListener(t,n,!0):r!==void 0?e.addEventListener(t,n,{passive:r}):e.addEventListener(t,n,!1)}function va(e,t,n,i,r){var a=i;if((t&1)===0&&(t&2)===0&&i!==null)e:for(;;){if(i===null)return;var o=i.tag;if(o===3||o===4){var l=i.stateNode.containerInfo;if(l===r||l.nodeType===8&&l.parentNode===r)break;if(o===4)for(o=i.return;o!==null;){var s=o.tag;if((s===3||s===4)&&(s=o.stateNode.containerInfo,s===r||s.nodeType===8&&s.parentNode===r))return;o=o.return}for(;l!==null;){if(o=qt(l),o===null)return;if(s=o.tag,s===5||s===6){i=a=o;continue e}l=l.parentNode}}i=i.return}qo(function(){var v=a,k=jr(n),f=[];e:{var h=Bl.get(e);if(h!==void 0){var z=ea,I=e;switch(e){case"keypress":if(Oi(n)===0)break e;case"keydown":case"keyup":z=Cu;break;case"focusin":I="focus",z=ia;break;case"focusout":I="blur",z=ia;break;case"beforeblur":case"afterblur":z=ia;break;case"click":if(n.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":z=yl;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":z=mu;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":z=bu;break;case Vl:case wl:case Hl:z=_u;break;case jl:z=Tu;break;case"scroll":z=cu;break;case"wheel":z=Eu;break;case"copy":case"cut":case"paste":z=hu;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":z=fl}var R=(t&4)!==0,Ce=!R&&e==="scroll",d=R?h!==null?h+"Capture":null:h;R=[];for(var c=v,p;c!==null;){p=c;var N=p.stateNode;if(p.tag===5&&N!==null&&(p=N,d!==null&&(N=Vn(c,d),N!=null&&R.push(ni(c,N,p)))),Ce)break;c=c.return}0<R.length&&(h=new z(h,I,null,n,k),f.push({event:h,listeners:R}))}}if((t&7)===0){e:{if(h=e==="mouseover"||e==="pointerover",z=e==="mouseout"||e==="pointerout",h&&n!==Hr&&(I=n.relatedTarget||n.fromElement)&&(qt(I)||I[St]))break e;if((z||h)&&(h=k.window===k?k:(h=k.ownerDocument)?h.defaultView||h.parentWindow:window,z?(I=n.relatedTarget||n.toElement,z=v,I=I?qt(I):null,I!==null&&(Ce=Jt(I),I!==Ce||I.tag!==5&&I.tag!==6)&&(I=null)):(z=null,I=v),z!==I)){if(R=yl,N="onMouseLeave",d="onMouseEnter",c="mouse",(e==="pointerout"||e==="pointerover")&&(R=fl,N="onPointerLeave",d="onPointerEnter",c="pointer"),Ce=z==null?h:fn(z),p=I==null?h:fn(I),h=new R(N,c+"leave",z,n,k),h.target=Ce,h.relatedTarget=p,N=null,qt(k)===v&&(R=new R(d,c+"enter",I,n,k),R.target=p,R.relatedTarget=Ce,N=R),Ce=N,z&&I)t:{for(R=z,d=I,c=0,p=R;p;p=yn(p))c++;for(p=0,N=d;N;N=yn(N))p++;for(;0<c-p;)R=yn(R),c--;for(;0<p-c;)d=yn(d),p--;for(;c--;){if(R===d||d!==null&&R===d.alternate)break t;R=yn(R),d=yn(d)}R=null}else R=null;z!==null&&Gl(f,h,z,R,!1),I!==null&&Ce!==null&&Gl(f,Ce,I,R,!0)}}e:{if(h=v?fn(v):window,z=h.nodeName&&h.nodeName.toLowerCase(),z==="select"||z==="input"&&h.type==="file")var L=Vu;else if(Pl(h))if(Al)L=Bu;else{L=Hu;var D=wu}else(z=h.nodeName)&&z.toLowerCase()==="input"&&(h.type==="checkbox"||h.type==="radio")&&(L=ju);if(L&&(L=L(e,v))){bl(f,L,n,k);break e}D&&D(e,h,v),e==="focusout"&&(D=h._wrapperState)&&D.controlled&&h.type==="number"&&xr(h,"number",h.value)}switch(D=v?fn(v):window,e){case"focusin":(Pl(D)||D.contentEditable==="true")&&(vn=D,ca=v,Xn=null);break;case"focusout":Xn=ca=vn=null;break;case"mousedown":ua=!0;break;case"contextmenu":case"mouseup":case"dragend":ua=!1,Ol(f,n,k);break;case"selectionchange":if(Ku)break;case"keydown":case"keyup":Ol(f,n,k)}var V;if(aa)e:{switch(e){case"compositionstart":var F="onCompositionStart";break e;case"compositionend":F="onCompositionEnd";break e;case"compositionupdate":F="onCompositionUpdate";break e}F=void 0}else _n?Cl(e,n)&&(F="onCompositionEnd"):e==="keydown"&&n.keyCode===229&&(F="onCompositionStart");F&&(gl&&n.locale!=="ko"&&(_n||F!=="onCompositionStart"?F==="onCompositionEnd"&&_n&&(V=vl()):(xt=k,Xr="value"in xt?xt.value:xt.textContent,_n=!0)),D=Fi(v,F),0<D.length&&(F=new kl(F,e,null,n,k),f.push({event:F,listeners:D}),V?F.data=V:(V=zl(n),V!==null&&(F.data=V)))),(V=Lu?Mu(e,n):xu(e,n))&&(v=Fi(v,"onBeforeInput"),0<v.length&&(k=new kl("onBeforeInput","beforeinput",null,n,k),f.push({event:k,listeners:v}),k.data=V))}Kl(f,t)})}function ni(e,t,n){return{instance:e,listener:t,currentTarget:n}}function Fi(e,t){for(var n=t+"Capture",i=[];e!==null;){var r=e,a=r.stateNode;r.tag===5&&a!==null&&(r=a,a=Vn(e,n),a!=null&&i.unshift(ni(e,a,r)),a=Vn(e,t),a!=null&&i.push(ni(e,a,r))),e=e.return}return i}function yn(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function Gl(e,t,n,i,r){for(var a=t._reactName,o=[];n!==null&&n!==i;){var l=n,s=l.alternate,v=l.stateNode;if(s!==null&&s===i)break;l.tag===5&&v!==null&&(l=v,r?(s=Vn(n,a),s!=null&&o.unshift(ni(n,s,l))):r||(s=Vn(n,a),s!=null&&o.push(ni(n,s,l)))),n=n.return}o.length!==0&&e.push({event:t,listeners:o})}var Wu=/\r\n?/g,Ju=/\u0000|\uFFFD/g;function Zl(e){return(typeof e=="string"?e:""+e).replace(Wu,`
`).replace(Ju,"")}function Ui(e,t,n){if(t=Zl(t),Zl(e)!==t&&n)throw Error(_(425))}function Ki(){}var ha=null,ya=null;function ka(e,t){return e==="textarea"||e==="noscript"||typeof t.children=="string"||typeof t.children=="number"||typeof t.dangerouslySetInnerHTML=="object"&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var fa=typeof setTimeout=="function"?setTimeout:void 0,qu=typeof clearTimeout=="function"?clearTimeout:void 0,Wl=typeof Promise=="function"?Promise:void 0,$u=typeof queueMicrotask=="function"?queueMicrotask:typeof Wl<"u"?function(e){return Wl.resolve(null).then(e).catch(Qu)}:fa;function Qu(e){setTimeout(function(){throw e})}function ga(e,t){var n=t,i=0;do{var r=n.nextSibling;if(e.removeChild(n),r&&r.nodeType===8)if(n=r.data,n==="/$"){if(i===0){e.removeChild(r),Gn(t);return}i--}else n!=="$"&&n!=="$?"&&n!=="$!"||i++;n=r}while(n);Gn(t)}function Dt(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t==="$"||t==="$!"||t==="$?")break;if(t==="/$")return null}}return e}function Jl(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n==="$"||n==="$!"||n==="$?"){if(t===0)return e;t--}else n==="/$"&&t++}e=e.previousSibling}return null}var kn=Math.random().toString(36).slice(2),kt="__reactFiber$"+kn,ii="__reactProps$"+kn,St="__reactContainer$"+kn,Na="__reactEvents$"+kn,Xu="__reactListeners$"+kn,em="__reactHandles$"+kn;function qt(e){var t=e[kt];if(t)return t;for(var n=e.parentNode;n;){if(t=n[St]||n[kt]){if(n=t.alternate,t.child!==null||n!==null&&n.child!==null)for(e=Jl(e);e!==null;){if(n=e[kt])return n;e=Jl(e)}return t}e=n,n=e.parentNode}return null}function ri(e){return e=e[kt]||e[St],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function fn(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(_(33))}function Yi(e){return e[ii]||null}var Sa=[],gn=-1;function Vt(e){return{current:e}}function ue(e){0>gn||(e.current=Sa[gn],Sa[gn]=null,gn--)}function se(e,t){gn++,Sa[gn]=e.current,e.current=t}var wt={},Oe=Vt(wt),Fe=Vt(!1),$t=wt;function Nn(e,t){var n=e.type.contextTypes;if(!n)return wt;var i=e.stateNode;if(i&&i.__reactInternalMemoizedUnmaskedChildContext===t)return i.__reactInternalMemoizedMaskedChildContext;var r={},a;for(a in n)r[a]=t[a];return i&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=t,e.__reactInternalMemoizedMaskedChildContext=r),r}function Ue(e){return e=e.childContextTypes,e!=null}function Gi(){ue(Fe),ue(Oe)}function ql(e,t,n){if(Oe.current!==wt)throw Error(_(168));se(Oe,t),se(Fe,n)}function $l(e,t,n){var i=e.stateNode;if(t=t.childContextTypes,typeof i.getChildContext!="function")return n;i=i.getChildContext();for(var r in i)if(!(r in t))throw Error(_(108,le(e)||"Unknown",r));return b({},n,i)}function Zi(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||wt,$t=Oe.current,se(Oe,e),se(Fe,Fe.current),!0}function Ql(e,t,n){var i=e.stateNode;if(!i)throw Error(_(169));n?(e=$l(e,t,$t),i.__reactInternalMemoizedMergedChildContext=e,ue(Fe),ue(Oe),se(Oe,e)):ue(Fe),se(Fe,n)}var Ct=null,Wi=!1,Ca=!1;function Xl(e){Ct===null?Ct=[e]:Ct.push(e)}function tm(e){Wi=!0,Xl(e)}function Ht(){if(!Ca&&Ct!==null){Ca=!0;var e=0,t=re;try{var n=Ct;for(re=1;e<n.length;e++){var i=n[e];do i=i(!0);while(i!==null)}Ct=null,Wi=!1}catch(r){throw Ct!==null&&(Ct=Ct.slice(e+1)),tl(Yr,Ht),r}finally{re=t,Ca=!1}}return null}var Sn=[],Cn=0,Ji=null,qi=0,et=[],tt=0,Qt=null,zt=1,Pt="";function Xt(e,t){Sn[Cn++]=qi,Sn[Cn++]=Ji,Ji=e,qi=t}function es(e,t,n){et[tt++]=zt,et[tt++]=Pt,et[tt++]=Qt,Qt=e;var i=zt;e=Pt;var r=32-st(i)-1;i&=~(1<<r),n+=1;var a=32-st(t)+r;if(30<a){var o=r-r%5;a=(i&(1<<o)-1).toString(32),i>>=o,r-=o,zt=1<<32-st(t)+r|n<<r|i,Pt=a+e}else zt=1<<a|n<<r|i,Pt=e}function za(e){e.return!==null&&(Xt(e,1),es(e,1,0))}function Pa(e){for(;e===Ji;)Ji=Sn[--Cn],Sn[Cn]=null,qi=Sn[--Cn],Sn[Cn]=null;for(;e===Qt;)Qt=et[--tt],et[tt]=null,Pt=et[--tt],et[tt]=null,zt=et[--tt],et[tt]=null}var $e=null,Qe=null,_e=!1,ut=null;function ts(e,t){var n=at(5,null,null,0);n.elementType="DELETED",n.stateNode=t,n.return=e,t=e.deletions,t===null?(e.deletions=[n],e.flags|=16):t.push(n)}function ns(e,t){switch(e.tag){case 5:var n=e.type;return t=t.nodeType!==1||n.toLowerCase()!==t.nodeName.toLowerCase()?null:t,t!==null?(e.stateNode=t,$e=e,Qe=Dt(t.firstChild),!0):!1;case 6:return t=e.pendingProps===""||t.nodeType!==3?null:t,t!==null?(e.stateNode=t,$e=e,Qe=null,!0):!1;case 13:return t=t.nodeType!==8?null:t,t!==null?(n=Qt!==null?{id:zt,overflow:Pt}:null,e.memoizedState={dehydrated:t,treeContext:n,retryLane:1073741824},n=at(18,null,null,0),n.stateNode=t,n.return=e,e.child=n,$e=e,Qe=null,!0):!1;default:return!1}}function ba(e){return(e.mode&1)!==0&&(e.flags&128)===0}function Aa(e){if(_e){var t=Qe;if(t){var n=t;if(!ns(e,t)){if(ba(e))throw Error(_(418));t=Dt(n.nextSibling);var i=$e;t&&ns(e,t)?ts(i,n):(e.flags=e.flags&-4097|2,_e=!1,$e=e)}}else{if(ba(e))throw Error(_(418));e.flags=e.flags&-4097|2,_e=!1,$e=e}}}function is(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;$e=e}function $i(e){if(e!==$e)return!1;if(!_e)return is(e),_e=!0,!1;var t;if((t=e.tag!==3)&&!(t=e.tag!==5)&&(t=e.type,t=t!=="head"&&t!=="body"&&!ka(e.type,e.memoizedProps)),t&&(t=Qe)){if(ba(e))throw rs(),Error(_(418));for(;t;)ts(e,t),t=Dt(t.nextSibling)}if(is(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(_(317));e:{for(e=e.nextSibling,t=0;e;){if(e.nodeType===8){var n=e.data;if(n==="/$"){if(t===0){Qe=Dt(e.nextSibling);break e}t--}else n!=="$"&&n!=="$!"&&n!=="$?"||t++}e=e.nextSibling}Qe=null}}else Qe=$e?Dt(e.stateNode.nextSibling):null;return!0}function rs(){for(var e=Qe;e;)e=Dt(e.nextSibling)}function zn(){Qe=$e=null,_e=!1}function Ta(e){ut===null?ut=[e]:ut.push(e)}var nm=q.ReactCurrentBatchConfig;function ai(e,t,n){if(e=n.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(n._owner){if(n=n._owner,n){if(n.tag!==1)throw Error(_(309));var i=n.stateNode}if(!i)throw Error(_(147,e));var r=i,a=""+e;return t!==null&&t.ref!==null&&typeof t.ref=="function"&&t.ref._stringRef===a?t.ref:(t=function(o){var l=r.refs;o===null?delete l[a]:l[a]=o},t._stringRef=a,t)}if(typeof e!="string")throw Error(_(284));if(!n._owner)throw Error(_(290,e))}return e}function Qi(e,t){throw e=Object.prototype.toString.call(t),Error(_(31,e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e))}function as(e){var t=e._init;return t(e._payload)}function os(e){function t(d,c){if(e){var p=d.deletions;p===null?(d.deletions=[c],d.flags|=16):p.push(c)}}function n(d,c){if(!e)return null;for(;c!==null;)t(d,c),c=c.sibling;return null}function i(d,c){for(d=new Map;c!==null;)c.key!==null?d.set(c.key,c):d.set(c.index,c),c=c.sibling;return d}function r(d,c){return d=Zt(d,c),d.index=0,d.sibling=null,d}function a(d,c,p){return d.index=p,e?(p=d.alternate,p!==null?(p=p.index,p<c?(d.flags|=2,c):p):(d.flags|=2,c)):(d.flags|=1048576,c)}function o(d){return e&&d.alternate===null&&(d.flags|=2),d}function l(d,c,p,N){return c===null||c.tag!==6?(c=go(p,d.mode,N),c.return=d,c):(c=r(c,p),c.return=d,c)}function s(d,c,p,N){var L=p.type;return L===w?k(d,c,p.props.children,N,p.key):c!==null&&(c.elementType===L||typeof L=="object"&&L!==null&&L.$$typeof===Be&&as(L)===c.type)?(N=r(c,p.props),N.ref=ai(d,c,p),N.return=d,N):(N=Sr(p.type,p.key,p.props,null,d.mode,N),N.ref=ai(d,c,p),N.return=d,N)}function v(d,c,p,N){return c===null||c.tag!==4||c.stateNode.containerInfo!==p.containerInfo||c.stateNode.implementation!==p.implementation?(c=No(p,d.mode,N),c.return=d,c):(c=r(c,p.children||[]),c.return=d,c)}function k(d,c,p,N,L){return c===null||c.tag!==7?(c=sn(p,d.mode,N,L),c.return=d,c):(c=r(c,p),c.return=d,c)}function f(d,c,p){if(typeof c=="string"&&c!==""||typeof c=="number")return c=go(""+c,d.mode,p),c.return=d,c;if(typeof c=="object"&&c!==null){switch(c.$$typeof){case T:return p=Sr(c.type,c.key,c.props,null,d.mode,p),p.ref=ai(d,null,c),p.return=d,p;case g:return c=No(c,d.mode,p),c.return=d,c;case Be:var N=c._init;return f(d,N(c._payload),p)}if(xn(c)||B(c))return c=sn(c,d.mode,p,null),c.return=d,c;Qi(d,c)}return null}function h(d,c,p,N){var L=c!==null?c.key:null;if(typeof p=="string"&&p!==""||typeof p=="number")return L!==null?null:l(d,c,""+p,N);if(typeof p=="object"&&p!==null){switch(p.$$typeof){case T:return p.key===L?s(d,c,p,N):null;case g:return p.key===L?v(d,c,p,N):null;case Be:return L=p._init,h(d,c,L(p._payload),N)}if(xn(p)||B(p))return L!==null?null:k(d,c,p,N,null);Qi(d,p)}return null}function z(d,c,p,N,L){if(typeof N=="string"&&N!==""||typeof N=="number")return d=d.get(p)||null,l(c,d,""+N,L);if(typeof N=="object"&&N!==null){switch(N.$$typeof){case T:return d=d.get(N.key===null?p:N.key)||null,s(c,d,N,L);case g:return d=d.get(N.key===null?p:N.key)||null,v(c,d,N,L);case Be:var D=N._init;return z(d,c,p,D(N._payload),L)}if(xn(N)||B(N))return d=d.get(p)||null,k(c,d,N,L,null);Qi(c,N)}return null}function I(d,c,p,N){for(var L=null,D=null,V=c,F=c=0,Re=null;V!==null&&F<p.length;F++){V.index>F?(Re=V,V=null):Re=V.sibling;var te=h(d,V,p[F],N);if(te===null){V===null&&(V=Re);break}e&&V&&te.alternate===null&&t(d,V),c=a(te,c,F),D===null?L=te:D.sibling=te,D=te,V=Re}if(F===p.length)return n(d,V),_e&&Xt(d,F),L;if(V===null){for(;F<p.length;F++)V=f(d,p[F],N),V!==null&&(c=a(V,c,F),D===null?L=V:D.sibling=V,D=V);return _e&&Xt(d,F),L}for(V=i(d,V);F<p.length;F++)Re=z(V,d,F,p[F],N),Re!==null&&(e&&Re.alternate!==null&&V.delete(Re.key===null?F:Re.key),c=a(Re,c,F),D===null?L=Re:D.sibling=Re,D=Re);return e&&V.forEach(function(Wt){return t(d,Wt)}),_e&&Xt(d,F),L}function R(d,c,p,N){var L=B(p);if(typeof L!="function")throw Error(_(150));if(p=L.call(p),p==null)throw Error(_(151));for(var D=L=null,V=c,F=c=0,Re=null,te=p.next();V!==null&&!te.done;F++,te=p.next()){V.index>F?(Re=V,V=null):Re=V.sibling;var Wt=h(d,V,te.value,N);if(Wt===null){V===null&&(V=Re);break}e&&V&&Wt.alternate===null&&t(d,V),c=a(Wt,c,F),D===null?L=Wt:D.sibling=Wt,D=Wt,V=Re}if(te.done)return n(d,V),_e&&Xt(d,F),L;if(V===null){for(;!te.done;F++,te=p.next())te=f(d,te.value,N),te!==null&&(c=a(te,c,F),D===null?L=te:D.sibling=te,D=te);return _e&&Xt(d,F),L}for(V=i(d,V);!te.done;F++,te=p.next())te=z(V,d,F,te.value,N),te!==null&&(e&&te.alternate!==null&&V.delete(te.key===null?F:te.key),c=a(te,c,F),D===null?L=te:D.sibling=te,D=te);return e&&V.forEach(function(Om){return t(d,Om)}),_e&&Xt(d,F),L}function Ce(d,c,p,N){if(typeof p=="object"&&p!==null&&p.type===w&&p.key===null&&(p=p.props.children),typeof p=="object"&&p!==null){switch(p.$$typeof){case T:e:{for(var L=p.key,D=c;D!==null;){if(D.key===L){if(L=p.type,L===w){if(D.tag===7){n(d,D.sibling),c=r(D,p.props.children),c.return=d,d=c;break e}}else if(D.elementType===L||typeof L=="object"&&L!==null&&L.$$typeof===Be&&as(L)===D.type){n(d,D.sibling),c=r(D,p.props),c.ref=ai(d,D,p),c.return=d,d=c;break e}n(d,D);break}else t(d,D);D=D.sibling}p.type===w?(c=sn(p.props.children,d.mode,N,p.key),c.return=d,d=c):(N=Sr(p.type,p.key,p.props,null,d.mode,N),N.ref=ai(d,c,p),N.return=d,d=N)}return o(d);case g:e:{for(D=p.key;c!==null;){if(c.key===D)if(c.tag===4&&c.stateNode.containerInfo===p.containerInfo&&c.stateNode.implementation===p.implementation){n(d,c.sibling),c=r(c,p.children||[]),c.return=d,d=c;break e}else{n(d,c);break}else t(d,c);c=c.sibling}c=No(p,d.mode,N),c.return=d,d=c}return o(d);case Be:return D=p._init,Ce(d,c,D(p._payload),N)}if(xn(p))return I(d,c,p,N);if(B(p))return R(d,c,p,N);Qi(d,p)}return typeof p=="string"&&p!==""||typeof p=="number"?(p=""+p,c!==null&&c.tag===6?(n(d,c.sibling),c=r(c,p),c.return=d,d=c):(n(d,c),c=go(p,d.mode,N),c.return=d,d=c),o(d)):n(d,c)}return Ce}var Pn=os(!0),ls=os(!1),Xi=Vt(null),er=null,bn=null,Ia=null;function Ea(){Ia=bn=er=null}function Ra(e){var t=Xi.current;ue(Xi),e._currentValue=t}function La(e,t,n){for(;e!==null;){var i=e.alternate;if((e.childLanes&t)!==t?(e.childLanes|=t,i!==null&&(i.childLanes|=t)):i!==null&&(i.childLanes&t)!==t&&(i.childLanes|=t),e===n)break;e=e.return}}function An(e,t){er=e,Ia=bn=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&t)!==0&&(Ke=!0),e.firstContext=null)}function nt(e){var t=e._currentValue;if(Ia!==e)if(e={context:e,memoizedValue:t,next:null},bn===null){if(er===null)throw Error(_(308));bn=e,er.dependencies={lanes:0,firstContext:e}}else bn=bn.next=e;return t}var en=null;function Ma(e){en===null?en=[e]:en.push(e)}function ss(e,t,n,i){var r=t.interleaved;return r===null?(n.next=n,Ma(t)):(n.next=r.next,r.next=n),t.interleaved=n,bt(e,i)}function bt(e,t){e.lanes|=t;var n=e.alternate;for(n!==null&&(n.lanes|=t),n=e,e=e.return;e!==null;)e.childLanes|=t,n=e.alternate,n!==null&&(n.childLanes|=t),n=e,e=e.return;return n.tag===3?n.stateNode:null}var jt=!1;function xa(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function cs(e,t){e=e.updateQueue,t.updateQueue===e&&(t.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function At(e,t){return{eventTime:e,lane:t,tag:0,payload:null,callback:null,next:null}}function Bt(e,t,n){var i=e.updateQueue;if(i===null)return null;if(i=i.shared,(Q&2)!==0){var r=i.pending;return r===null?t.next=t:(t.next=r.next,r.next=t),i.pending=t,bt(e,n)}return r=i.interleaved,r===null?(t.next=t,Ma(i)):(t.next=r.next,r.next=t),i.interleaved=t,bt(e,n)}function tr(e,t,n){if(t=t.updateQueue,t!==null&&(t=t.shared,(n&4194240)!==0)){var i=t.lanes;i&=e.pendingLanes,n|=i,t.lanes=n,Wr(e,n)}}function us(e,t){var n=e.updateQueue,i=e.alternate;if(i!==null&&(i=i.updateQueue,n===i)){var r=null,a=null;if(n=n.firstBaseUpdate,n!==null){do{var o={eventTime:n.eventTime,lane:n.lane,tag:n.tag,payload:n.payload,callback:n.callback,next:null};a===null?r=a=o:a=a.next=o,n=n.next}while(n!==null);a===null?r=a=t:a=a.next=t}else r=a=t;n={baseState:i.baseState,firstBaseUpdate:r,lastBaseUpdate:a,shared:i.shared,effects:i.effects},e.updateQueue=n;return}e=n.lastBaseUpdate,e===null?n.firstBaseUpdate=t:e.next=t,n.lastBaseUpdate=t}function nr(e,t,n,i){var r=e.updateQueue;jt=!1;var a=r.firstBaseUpdate,o=r.lastBaseUpdate,l=r.shared.pending;if(l!==null){r.shared.pending=null;var s=l,v=s.next;s.next=null,o===null?a=v:o.next=v,o=s;var k=e.alternate;k!==null&&(k=k.updateQueue,l=k.lastBaseUpdate,l!==o&&(l===null?k.firstBaseUpdate=v:l.next=v,k.lastBaseUpdate=s))}if(a!==null){var f=r.baseState;o=0,k=v=s=null,l=a;do{var h=l.lane,z=l.eventTime;if((i&h)===h){k!==null&&(k=k.next={eventTime:z,lane:0,tag:l.tag,payload:l.payload,callback:l.callback,next:null});e:{var I=e,R=l;switch(h=t,z=n,R.tag){case 1:if(I=R.payload,typeof I=="function"){f=I.call(z,f,h);break e}f=I;break e;case 3:I.flags=I.flags&-65537|128;case 0:if(I=R.payload,h=typeof I=="function"?I.call(z,f,h):I,h==null)break e;f=b({},f,h);break e;case 2:jt=!0}}l.callback!==null&&l.lane!==0&&(e.flags|=64,h=r.effects,h===null?r.effects=[l]:h.push(l))}else z={eventTime:z,lane:h,tag:l.tag,payload:l.payload,callback:l.callback,next:null},k===null?(v=k=z,s=f):k=k.next=z,o|=h;if(l=l.next,l===null){if(l=r.shared.pending,l===null)break;h=l,l=h.next,h.next=null,r.lastBaseUpdate=h,r.shared.pending=null}}while(!0);if(k===null&&(s=f),r.baseState=s,r.firstBaseUpdate=v,r.lastBaseUpdate=k,t=r.shared.interleaved,t!==null){r=t;do o|=r.lane,r=r.next;while(r!==t)}else a===null&&(r.shared.lanes=0);rn|=o,e.lanes=o,e.memoizedState=f}}function ms(e,t,n){if(e=t.effects,t.effects=null,e!==null)for(t=0;t<e.length;t++){var i=e[t],r=i.callback;if(r!==null){if(i.callback=null,i=n,typeof r!="function")throw Error(_(191,r));r.call(i)}}}var oi={},ft=Vt(oi),li=Vt(oi),si=Vt(oi);function tn(e){if(e===oi)throw Error(_(174));return e}function Oa(e,t){switch(se(si,t),se(li,e),se(ft,oi),e=t.nodeType,e){case 9:case 11:t=(t=t.documentElement)?t.namespaceURI:Dr(null,"");break;default:e=e===8?t.parentNode:t,t=e.namespaceURI||null,e=e.tagName,t=Dr(t,e)}ue(ft),se(ft,t)}function Tn(){ue(ft),ue(li),ue(si)}function ds(e){tn(si.current);var t=tn(ft.current),n=Dr(t,e.type);t!==n&&(se(li,e),se(ft,n))}function Da(e){li.current===e&&(ue(ft),ue(li))}var he=Vt(0);function ir(e){for(var t=e;t!==null;){if(t.tag===13){var n=t.memoizedState;if(n!==null&&(n=n.dehydrated,n===null||n.data==="$?"||n.data==="$!"))return t}else if(t.tag===19&&t.memoizedProps.revealOrder!==void 0){if((t.flags&128)!==0)return t}else if(t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return null;t=t.return}t.sibling.return=t.return,t=t.sibling}return null}var Va=[];function wa(){for(var e=0;e<Va.length;e++)Va[e]._workInProgressVersionPrimary=null;Va.length=0}var rr=q.ReactCurrentDispatcher,Ha=q.ReactCurrentBatchConfig,nn=0,ye=null,Ae=null,Ie=null,ar=!1,ci=!1,ui=0,im=0;function De(){throw Error(_(321))}function ja(e,t){if(t===null)return!1;for(var n=0;n<t.length&&n<e.length;n++)if(!ct(e[n],t[n]))return!1;return!0}function Ba(e,t,n,i,r,a){if(nn=a,ye=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,rr.current=e===null||e.memoizedState===null?lm:sm,e=n(i,r),ci){a=0;do{if(ci=!1,ui=0,25<=a)throw Error(_(301));a+=1,Ie=Ae=null,t.updateQueue=null,rr.current=cm,e=n(i,r)}while(ci)}if(rr.current=sr,t=Ae!==null&&Ae.next!==null,nn=0,Ie=Ae=ye=null,ar=!1,t)throw Error(_(300));return e}function Fa(){var e=ui!==0;return ui=0,e}function gt(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return Ie===null?ye.memoizedState=Ie=e:Ie=Ie.next=e,Ie}function it(){if(Ae===null){var e=ye.alternate;e=e!==null?e.memoizedState:null}else e=Ae.next;var t=Ie===null?ye.memoizedState:Ie.next;if(t!==null)Ie=t,Ae=e;else{if(e===null)throw Error(_(310));Ae=e,e={memoizedState:Ae.memoizedState,baseState:Ae.baseState,baseQueue:Ae.baseQueue,queue:Ae.queue,next:null},Ie===null?ye.memoizedState=Ie=e:Ie=Ie.next=e}return Ie}function mi(e,t){return typeof t=="function"?t(e):t}function Ua(e){var t=it(),n=t.queue;if(n===null)throw Error(_(311));n.lastRenderedReducer=e;var i=Ae,r=i.baseQueue,a=n.pending;if(a!==null){if(r!==null){var o=r.next;r.next=a.next,a.next=o}i.baseQueue=r=a,n.pending=null}if(r!==null){a=r.next,i=i.baseState;var l=o=null,s=null,v=a;do{var k=v.lane;if((nn&k)===k)s!==null&&(s=s.next={lane:0,action:v.action,hasEagerState:v.hasEagerState,eagerState:v.eagerState,next:null}),i=v.hasEagerState?v.eagerState:e(i,v.action);else{var f={lane:k,action:v.action,hasEagerState:v.hasEagerState,eagerState:v.eagerState,next:null};s===null?(l=s=f,o=i):s=s.next=f,ye.lanes|=k,rn|=k}v=v.next}while(v!==null&&v!==a);s===null?o=i:s.next=l,ct(i,t.memoizedState)||(Ke=!0),t.memoizedState=i,t.baseState=o,t.baseQueue=s,n.lastRenderedState=i}if(e=n.interleaved,e!==null){r=e;do a=r.lane,ye.lanes|=a,rn|=a,r=r.next;while(r!==e)}else r===null&&(n.lanes=0);return[t.memoizedState,n.dispatch]}function Ka(e){var t=it(),n=t.queue;if(n===null)throw Error(_(311));n.lastRenderedReducer=e;var i=n.dispatch,r=n.pending,a=t.memoizedState;if(r!==null){n.pending=null;var o=r=r.next;do a=e(a,o.action),o=o.next;while(o!==r);ct(a,t.memoizedState)||(Ke=!0),t.memoizedState=a,t.baseQueue===null&&(t.baseState=a),n.lastRenderedState=a}return[a,i]}function ps(){}function _s(e,t){var n=ye,i=it(),r=t(),a=!ct(i.memoizedState,r);if(a&&(i.memoizedState=r,Ke=!0),i=i.queue,Ya(ys.bind(null,n,i,e),[e]),i.getSnapshot!==t||a||Ie!==null&&Ie.memoizedState.tag&1){if(n.flags|=2048,di(9,hs.bind(null,n,i,r,t),void 0,null),Ee===null)throw Error(_(349));(nn&30)!==0||vs(n,t,r)}return r}function vs(e,t,n){e.flags|=16384,e={getSnapshot:t,value:n},t=ye.updateQueue,t===null?(t={lastEffect:null,stores:null},ye.updateQueue=t,t.stores=[e]):(n=t.stores,n===null?t.stores=[e]:n.push(e))}function hs(e,t,n,i){t.value=n,t.getSnapshot=i,ks(t)&&fs(e)}function ys(e,t,n){return n(function(){ks(t)&&fs(e)})}function ks(e){var t=e.getSnapshot;e=e.value;try{var n=t();return!ct(e,n)}catch{return!0}}function fs(e){var t=bt(e,1);t!==null&&_t(t,e,1,-1)}function gs(e){var t=gt();return typeof e=="function"&&(e=e()),t.memoizedState=t.baseState=e,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:mi,lastRenderedState:e},t.queue=e,e=e.dispatch=om.bind(null,ye,e),[t.memoizedState,e]}function di(e,t,n,i){return e={tag:e,create:t,destroy:n,deps:i,next:null},t=ye.updateQueue,t===null?(t={lastEffect:null,stores:null},ye.updateQueue=t,t.lastEffect=e.next=e):(n=t.lastEffect,n===null?t.lastEffect=e.next=e:(i=n.next,n.next=e,e.next=i,t.lastEffect=e)),e}function Ns(){return it().memoizedState}function or(e,t,n,i){var r=gt();ye.flags|=e,r.memoizedState=di(1|t,n,void 0,i===void 0?null:i)}function lr(e,t,n,i){var r=it();i=i===void 0?null:i;var a=void 0;if(Ae!==null){var o=Ae.memoizedState;if(a=o.destroy,i!==null&&ja(i,o.deps)){r.memoizedState=di(t,n,a,i);return}}ye.flags|=e,r.memoizedState=di(1|t,n,a,i)}function Ss(e,t){return or(8390656,8,e,t)}function Ya(e,t){return lr(2048,8,e,t)}function Cs(e,t){return lr(4,2,e,t)}function zs(e,t){return lr(4,4,e,t)}function Ps(e,t){if(typeof t=="function")return e=e(),t(e),function(){t(null)};if(t!=null)return e=e(),t.current=e,function(){t.current=null}}function bs(e,t,n){return n=n!=null?n.concat([e]):null,lr(4,4,Ps.bind(null,t,e),n)}function Ga(){}function As(e,t){var n=it();t=t===void 0?null:t;var i=n.memoizedState;return i!==null&&t!==null&&ja(t,i[1])?i[0]:(n.memoizedState=[e,t],e)}function Ts(e,t){var n=it();t=t===void 0?null:t;var i=n.memoizedState;return i!==null&&t!==null&&ja(t,i[1])?i[0]:(e=e(),n.memoizedState=[e,t],e)}function Is(e,t,n){return(nn&21)===0?(e.baseState&&(e.baseState=!1,Ke=!0),e.memoizedState=n):(ct(n,t)||(n=al(),ye.lanes|=n,rn|=n,e.baseState=!0),t)}function rm(e,t){var n=re;re=n!==0&&4>n?n:4,e(!0);var i=Ha.transition;Ha.transition={};try{e(!1),t()}finally{re=n,Ha.transition=i}}function Es(){return it().memoizedState}function am(e,t,n){var i=Yt(e);if(n={lane:i,action:n,hasEagerState:!1,eagerState:null,next:null},Rs(e))Ls(t,n);else if(n=ss(e,t,n,i),n!==null){var r=je();_t(n,e,i,r),Ms(n,t,i)}}function om(e,t,n){var i=Yt(e),r={lane:i,action:n,hasEagerState:!1,eagerState:null,next:null};if(Rs(e))Ls(t,r);else{var a=e.alternate;if(e.lanes===0&&(a===null||a.lanes===0)&&(a=t.lastRenderedReducer,a!==null))try{var o=t.lastRenderedState,l=a(o,n);if(r.hasEagerState=!0,r.eagerState=l,ct(l,o)){var s=t.interleaved;s===null?(r.next=r,Ma(t)):(r.next=s.next,s.next=r),t.interleaved=r;return}}catch{}finally{}n=ss(e,t,r,i),n!==null&&(r=je(),_t(n,e,i,r),Ms(n,t,i))}}function Rs(e){var t=e.alternate;return e===ye||t!==null&&t===ye}function Ls(e,t){ci=ar=!0;var n=e.pending;n===null?t.next=t:(t.next=n.next,n.next=t),e.pending=t}function Ms(e,t,n){if((n&4194240)!==0){var i=t.lanes;i&=e.pendingLanes,n|=i,t.lanes=n,Wr(e,n)}}var sr={readContext:nt,useCallback:De,useContext:De,useEffect:De,useImperativeHandle:De,useInsertionEffect:De,useLayoutEffect:De,useMemo:De,useReducer:De,useRef:De,useState:De,useDebugValue:De,useDeferredValue:De,useTransition:De,useMutableSource:De,useSyncExternalStore:De,useId:De,unstable_isNewReconciler:!1},lm={readContext:nt,useCallback:function(e,t){return gt().memoizedState=[e,t===void 0?null:t],e},useContext:nt,useEffect:Ss,useImperativeHandle:function(e,t,n){return n=n!=null?n.concat([e]):null,or(4194308,4,Ps.bind(null,t,e),n)},useLayoutEffect:function(e,t){return or(4194308,4,e,t)},useInsertionEffect:function(e,t){return or(4,2,e,t)},useMemo:function(e,t){var n=gt();return t=t===void 0?null:t,e=e(),n.memoizedState=[e,t],e},useReducer:function(e,t,n){var i=gt();return t=n!==void 0?n(t):t,i.memoizedState=i.baseState=t,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:t},i.queue=e,e=e.dispatch=am.bind(null,ye,e),[i.memoizedState,e]},useRef:function(e){var t=gt();return e={current:e},t.memoizedState=e},useState:gs,useDebugValue:Ga,useDeferredValue:function(e){return gt().memoizedState=e},useTransition:function(){var e=gs(!1),t=e[0];return e=rm.bind(null,e[1]),gt().memoizedState=e,[t,e]},useMutableSource:function(){},useSyncExternalStore:function(e,t,n){var i=ye,r=gt();if(_e){if(n===void 0)throw Error(_(407));n=n()}else{if(n=t(),Ee===null)throw Error(_(349));(nn&30)!==0||vs(i,t,n)}r.memoizedState=n;var a={value:n,getSnapshot:t};return r.queue=a,Ss(ys.bind(null,i,a,e),[e]),i.flags|=2048,di(9,hs.bind(null,i,a,n,t),void 0,null),n},useId:function(){var e=gt(),t=Ee.identifierPrefix;if(_e){var n=Pt,i=zt;n=(i&~(1<<32-st(i)-1)).toString(32)+n,t=":"+t+"R"+n,n=ui++,0<n&&(t+="H"+n.toString(32)),t+=":"}else n=im++,t=":"+t+"r"+n.toString(32)+":";return e.memoizedState=t},unstable_isNewReconciler:!1},sm={readContext:nt,useCallback:As,useContext:nt,useEffect:Ya,useImperativeHandle:bs,useInsertionEffect:Cs,useLayoutEffect:zs,useMemo:Ts,useReducer:Ua,useRef:Ns,useState:function(){return Ua(mi)},useDebugValue:Ga,useDeferredValue:function(e){var t=it();return Is(t,Ae.memoizedState,e)},useTransition:function(){var e=Ua(mi)[0],t=it().memoizedState;return[e,t]},useMutableSource:ps,useSyncExternalStore:_s,useId:Es,unstable_isNewReconciler:!1},cm={readContext:nt,useCallback:As,useContext:nt,useEffect:Ya,useImperativeHandle:bs,useInsertionEffect:Cs,useLayoutEffect:zs,useMemo:Ts,useReducer:Ka,useRef:Ns,useState:function(){return Ka(mi)},useDebugValue:Ga,useDeferredValue:function(e){var t=it();return Ae===null?t.memoizedState=e:Is(t,Ae.memoizedState,e)},useTransition:function(){var e=Ka(mi)[0],t=it().memoizedState;return[e,t]},useMutableSource:ps,useSyncExternalStore:_s,useId:Es,unstable_isNewReconciler:!1};function mt(e,t){if(e&&e.defaultProps){t=b({},t),e=e.defaultProps;for(var n in e)t[n]===void 0&&(t[n]=e[n]);return t}return t}function Za(e,t,n,i){t=e.memoizedState,n=n(i,t),n=n==null?t:b({},t,n),e.memoizedState=n,e.lanes===0&&(e.updateQueue.baseState=n)}var cr={isMounted:function(e){return(e=e._reactInternals)?Jt(e)===e:!1},enqueueSetState:function(e,t,n){e=e._reactInternals;var i=je(),r=Yt(e),a=At(i,r);a.payload=t,n!=null&&(a.callback=n),t=Bt(e,a,r),t!==null&&(_t(t,e,r,i),tr(t,e,r))},enqueueReplaceState:function(e,t,n){e=e._reactInternals;var i=je(),r=Yt(e),a=At(i,r);a.tag=1,a.payload=t,n!=null&&(a.callback=n),t=Bt(e,a,r),t!==null&&(_t(t,e,r,i),tr(t,e,r))},enqueueForceUpdate:function(e,t){e=e._reactInternals;var n=je(),i=Yt(e),r=At(n,i);r.tag=2,t!=null&&(r.callback=t),t=Bt(e,r,i),t!==null&&(_t(t,e,i,n),tr(t,e,i))}};function xs(e,t,n,i,r,a,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(i,a,o):t.prototype&&t.prototype.isPureReactComponent?!Qn(n,i)||!Qn(r,a):!0}function Os(e,t,n){var i=!1,r=wt,a=t.contextType;return typeof a=="object"&&a!==null?a=nt(a):(r=Ue(t)?$t:Oe.current,i=t.contextTypes,a=(i=i!=null)?Nn(e,r):wt),t=new t(n,a),e.memoizedState=t.state!==null&&t.state!==void 0?t.state:null,t.updater=cr,e.stateNode=t,t._reactInternals=e,i&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=r,e.__reactInternalMemoizedMaskedChildContext=a),t}function Ds(e,t,n,i){e=t.state,typeof t.componentWillReceiveProps=="function"&&t.componentWillReceiveProps(n,i),typeof t.UNSAFE_componentWillReceiveProps=="function"&&t.UNSAFE_componentWillReceiveProps(n,i),t.state!==e&&cr.enqueueReplaceState(t,t.state,null)}function Wa(e,t,n,i){var r=e.stateNode;r.props=n,r.state=e.memoizedState,r.refs={},xa(e);var a=t.contextType;typeof a=="object"&&a!==null?r.context=nt(a):(a=Ue(t)?$t:Oe.current,r.context=Nn(e,a)),r.state=e.memoizedState,a=t.getDerivedStateFromProps,typeof a=="function"&&(Za(e,t,a,n),r.state=e.memoizedState),typeof t.getDerivedStateFromProps=="function"||typeof r.getSnapshotBeforeUpdate=="function"||typeof r.UNSAFE_componentWillMount!="function"&&typeof r.componentWillMount!="function"||(t=r.state,typeof r.componentWillMount=="function"&&r.componentWillMount(),typeof r.UNSAFE_componentWillMount=="function"&&r.UNSAFE_componentWillMount(),t!==r.state&&cr.enqueueReplaceState(r,r.state,null),nr(e,n,r,i),r.state=e.memoizedState),typeof r.componentDidMount=="function"&&(e.flags|=4194308)}function In(e,t){try{var n="",i=t;do n+=X(i),i=i.return;while(i);var r=n}catch(a){r=`
Error generating stack: `+a.message+`
`+a.stack}return{value:e,source:t,stack:r,digest:null}}function Ja(e,t,n){return{value:e,source:null,stack:n??null,digest:t??null}}function qa(e,t){try{console.error(t.value)}catch(n){setTimeout(function(){throw n})}}var um=typeof WeakMap=="function"?WeakMap:Map;function Vs(e,t,n){n=At(-1,n),n.tag=3,n.payload={element:null};var i=t.value;return n.callback=function(){hr||(hr=!0,mo=i),qa(e,t)},n}function ws(e,t,n){n=At(-1,n),n.tag=3;var i=e.type.getDerivedStateFromError;if(typeof i=="function"){var r=t.value;n.payload=function(){return i(r)},n.callback=function(){qa(e,t)}}var a=e.stateNode;return a!==null&&typeof a.componentDidCatch=="function"&&(n.callback=function(){qa(e,t),typeof i!="function"&&(Ut===null?Ut=new Set([this]):Ut.add(this));var o=t.stack;this.componentDidCatch(t.value,{componentStack:o!==null?o:""})}),n}function Hs(e,t,n){var i=e.pingCache;if(i===null){i=e.pingCache=new um;var r=new Set;i.set(t,r)}else r=i.get(t),r===void 0&&(r=new Set,i.set(t,r));r.has(n)||(r.add(n),e=zm.bind(null,e,t,n),t.then(e,e))}function js(e){do{var t;if((t=e.tag===13)&&(t=e.memoizedState,t=t!==null?t.dehydrated!==null:!0),t)return e;e=e.return}while(e!==null);return null}function Bs(e,t,n,i,r){return(e.mode&1)===0?(e===t?e.flags|=65536:(e.flags|=128,n.flags|=131072,n.flags&=-52805,n.tag===1&&(n.alternate===null?n.tag=17:(t=At(-1,1),t.tag=2,Bt(n,t,1))),n.lanes|=1),e):(e.flags|=65536,e.lanes=r,e)}var mm=q.ReactCurrentOwner,Ke=!1;function He(e,t,n,i){t.child=e===null?ls(t,null,n,i):Pn(t,e.child,n,i)}function Fs(e,t,n,i,r){n=n.render;var a=t.ref;return An(t,r),i=Ba(e,t,n,i,a,r),n=Fa(),e!==null&&!Ke?(t.updateQueue=e.updateQueue,t.flags&=-2053,e.lanes&=~r,Tt(e,t,r)):(_e&&n&&za(t),t.flags|=1,He(e,t,i,r),t.child)}function Us(e,t,n,i,r){if(e===null){var a=n.type;return typeof a=="function"&&!fo(a)&&a.defaultProps===void 0&&n.compare===null&&n.defaultProps===void 0?(t.tag=15,t.type=a,Ks(e,t,a,i,r)):(e=Sr(n.type,null,i,t,t.mode,r),e.ref=t.ref,e.return=t,t.child=e)}if(a=e.child,(e.lanes&r)===0){var o=a.memoizedProps;if(n=n.compare,n=n!==null?n:Qn,n(o,i)&&e.ref===t.ref)return Tt(e,t,r)}return t.flags|=1,e=Zt(a,i),e.ref=t.ref,e.return=t,t.child=e}function Ks(e,t,n,i,r){if(e!==null){var a=e.memoizedProps;if(Qn(a,i)&&e.ref===t.ref)if(Ke=!1,t.pendingProps=i=a,(e.lanes&r)!==0)(e.flags&131072)!==0&&(Ke=!0);else return t.lanes=e.lanes,Tt(e,t,r)}return $a(e,t,n,i,r)}function Ys(e,t,n){var i=t.pendingProps,r=i.children,a=e!==null?e.memoizedState:null;if(i.mode==="hidden")if((t.mode&1)===0)t.memoizedState={baseLanes:0,cachePool:null,transitions:null},se(Rn,Xe),Xe|=n;else{if((n&1073741824)===0)return e=a!==null?a.baseLanes|n:n,t.lanes=t.childLanes=1073741824,t.memoizedState={baseLanes:e,cachePool:null,transitions:null},t.updateQueue=null,se(Rn,Xe),Xe|=e,null;t.memoizedState={baseLanes:0,cachePool:null,transitions:null},i=a!==null?a.baseLanes:n,se(Rn,Xe),Xe|=i}else a!==null?(i=a.baseLanes|n,t.memoizedState=null):i=n,se(Rn,Xe),Xe|=i;return He(e,t,r,n),t.child}function Gs(e,t){var n=t.ref;(e===null&&n!==null||e!==null&&e.ref!==n)&&(t.flags|=512,t.flags|=2097152)}function $a(e,t,n,i,r){var a=Ue(n)?$t:Oe.current;return a=Nn(t,a),An(t,r),n=Ba(e,t,n,i,a,r),i=Fa(),e!==null&&!Ke?(t.updateQueue=e.updateQueue,t.flags&=-2053,e.lanes&=~r,Tt(e,t,r)):(_e&&i&&za(t),t.flags|=1,He(e,t,n,r),t.child)}function Zs(e,t,n,i,r){if(Ue(n)){var a=!0;Zi(t)}else a=!1;if(An(t,r),t.stateNode===null)mr(e,t),Os(t,n,i),Wa(t,n,i,r),i=!0;else if(e===null){var o=t.stateNode,l=t.memoizedProps;o.props=l;var s=o.context,v=n.contextType;typeof v=="object"&&v!==null?v=nt(v):(v=Ue(n)?$t:Oe.current,v=Nn(t,v));var k=n.getDerivedStateFromProps,f=typeof k=="function"||typeof o.getSnapshotBeforeUpdate=="function";f||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(l!==i||s!==v)&&Ds(t,o,i,v),jt=!1;var h=t.memoizedState;o.state=h,nr(t,i,o,r),s=t.memoizedState,l!==i||h!==s||Fe.current||jt?(typeof k=="function"&&(Za(t,n,k,i),s=t.memoizedState),(l=jt||xs(t,n,l,i,h,s,v))?(f||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(t.flags|=4194308)):(typeof o.componentDidMount=="function"&&(t.flags|=4194308),t.memoizedProps=i,t.memoizedState=s),o.props=i,o.state=s,o.context=v,i=l):(typeof o.componentDidMount=="function"&&(t.flags|=4194308),i=!1)}else{o=t.stateNode,cs(e,t),l=t.memoizedProps,v=t.type===t.elementType?l:mt(t.type,l),o.props=v,f=t.pendingProps,h=o.context,s=n.contextType,typeof s=="object"&&s!==null?s=nt(s):(s=Ue(n)?$t:Oe.current,s=Nn(t,s));var z=n.getDerivedStateFromProps;(k=typeof z=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(l!==f||h!==s)&&Ds(t,o,i,s),jt=!1,h=t.memoizedState,o.state=h,nr(t,i,o,r);var I=t.memoizedState;l!==f||h!==I||Fe.current||jt?(typeof z=="function"&&(Za(t,n,z,i),I=t.memoizedState),(v=jt||xs(t,n,v,i,h,I,s)||!1)?(k||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(i,I,s),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(i,I,s)),typeof o.componentDidUpdate=="function"&&(t.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(t.flags|=1024)):(typeof o.componentDidUpdate!="function"||l===e.memoizedProps&&h===e.memoizedState||(t.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||l===e.memoizedProps&&h===e.memoizedState||(t.flags|=1024),t.memoizedProps=i,t.memoizedState=I),o.props=i,o.state=I,o.context=s,i=v):(typeof o.componentDidUpdate!="function"||l===e.memoizedProps&&h===e.memoizedState||(t.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||l===e.memoizedProps&&h===e.memoizedState||(t.flags|=1024),i=!1)}return Qa(e,t,n,i,a,r)}function Qa(e,t,n,i,r,a){Gs(e,t);var o=(t.flags&128)!==0;if(!i&&!o)return r&&Ql(t,n,!1),Tt(e,t,a);i=t.stateNode,mm.current=t;var l=o&&typeof n.getDerivedStateFromError!="function"?null:i.render();return t.flags|=1,e!==null&&o?(t.child=Pn(t,e.child,null,a),t.child=Pn(t,null,l,a)):He(e,t,l,a),t.memoizedState=i.state,r&&Ql(t,n,!0),t.child}function Ws(e){var t=e.stateNode;t.pendingContext?ql(e,t.pendingContext,t.pendingContext!==t.context):t.context&&ql(e,t.context,!1),Oa(e,t.containerInfo)}function Js(e,t,n,i,r){return zn(),Ta(r),t.flags|=256,He(e,t,n,i),t.child}var Xa={dehydrated:null,treeContext:null,retryLane:0};function eo(e){return{baseLanes:e,cachePool:null,transitions:null}}function qs(e,t,n){var i=t.pendingProps,r=he.current,a=!1,o=(t.flags&128)!==0,l;if((l=o)||(l=e!==null&&e.memoizedState===null?!1:(r&2)!==0),l?(a=!0,t.flags&=-129):(e===null||e.memoizedState!==null)&&(r|=1),se(he,r&1),e===null)return Aa(t),e=t.memoizedState,e!==null&&(e=e.dehydrated,e!==null)?((t.mode&1)===0?t.lanes=1:e.data==="$!"?t.lanes=8:t.lanes=1073741824,null):(o=i.children,e=i.fallback,a?(i=t.mode,a=t.child,o={mode:"hidden",children:o},(i&1)===0&&a!==null?(a.childLanes=0,a.pendingProps=o):a=Cr(o,i,0,null),e=sn(e,i,n,null),a.return=t,e.return=t,a.sibling=e,t.child=a,t.child.memoizedState=eo(n),t.memoizedState=Xa,e):to(t,o));if(r=e.memoizedState,r!==null&&(l=r.dehydrated,l!==null))return dm(e,t,o,i,l,r,n);if(a){a=i.fallback,o=t.mode,r=e.child,l=r.sibling;var s={mode:"hidden",children:i.children};return(o&1)===0&&t.child!==r?(i=t.child,i.childLanes=0,i.pendingProps=s,t.deletions=null):(i=Zt(r,s),i.subtreeFlags=r.subtreeFlags&14680064),l!==null?a=Zt(l,a):(a=sn(a,o,n,null),a.flags|=2),a.return=t,i.return=t,i.sibling=a,t.child=i,i=a,a=t.child,o=e.child.memoizedState,o=o===null?eo(n):{baseLanes:o.baseLanes|n,cachePool:null,transitions:o.transitions},a.memoizedState=o,a.childLanes=e.childLanes&~n,t.memoizedState=Xa,i}return a=e.child,e=a.sibling,i=Zt(a,{mode:"visible",children:i.children}),(t.mode&1)===0&&(i.lanes=n),i.return=t,i.sibling=null,e!==null&&(n=t.deletions,n===null?(t.deletions=[e],t.flags|=16):n.push(e)),t.child=i,t.memoizedState=null,i}function to(e,t){return t=Cr({mode:"visible",children:t},e.mode,0,null),t.return=e,e.child=t}function ur(e,t,n,i){return i!==null&&Ta(i),Pn(t,e.child,null,n),e=to(t,t.pendingProps.children),e.flags|=2,t.memoizedState=null,e}function dm(e,t,n,i,r,a,o){if(n)return t.flags&256?(t.flags&=-257,i=Ja(Error(_(422))),ur(e,t,o,i)):t.memoizedState!==null?(t.child=e.child,t.flags|=128,null):(a=i.fallback,r=t.mode,i=Cr({mode:"visible",children:i.children},r,0,null),a=sn(a,r,o,null),a.flags|=2,i.return=t,a.return=t,i.sibling=a,t.child=i,(t.mode&1)!==0&&Pn(t,e.child,null,o),t.child.memoizedState=eo(o),t.memoizedState=Xa,a);if((t.mode&1)===0)return ur(e,t,o,null);if(r.data==="$!"){if(i=r.nextSibling&&r.nextSibling.dataset,i)var l=i.dgst;return i=l,a=Error(_(419)),i=Ja(a,i,void 0),ur(e,t,o,i)}if(l=(o&e.childLanes)!==0,Ke||l){if(i=Ee,i!==null){switch(o&-o){case 4:r=2;break;case 16:r=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:r=32;break;case 536870912:r=268435456;break;default:r=0}r=(r&(i.suspendedLanes|o))!==0?0:r,r!==0&&r!==a.retryLane&&(a.retryLane=r,bt(e,r),_t(i,e,r,-1))}return ko(),i=Ja(Error(_(421))),ur(e,t,o,i)}return r.data==="$?"?(t.flags|=128,t.child=e.child,t=Pm.bind(null,e),r._reactRetry=t,null):(e=a.treeContext,Qe=Dt(r.nextSibling),$e=t,_e=!0,ut=null,e!==null&&(et[tt++]=zt,et[tt++]=Pt,et[tt++]=Qt,zt=e.id,Pt=e.overflow,Qt=t),t=to(t,i.children),t.flags|=4096,t)}function $s(e,t,n){e.lanes|=t;var i=e.alternate;i!==null&&(i.lanes|=t),La(e.return,t,n)}function no(e,t,n,i,r){var a=e.memoizedState;a===null?e.memoizedState={isBackwards:t,rendering:null,renderingStartTime:0,last:i,tail:n,tailMode:r}:(a.isBackwards=t,a.rendering=null,a.renderingStartTime=0,a.last=i,a.tail=n,a.tailMode=r)}function Qs(e,t,n){var i=t.pendingProps,r=i.revealOrder,a=i.tail;if(He(e,t,i.children,n),i=he.current,(i&2)!==0)i=i&1|2,t.flags|=128;else{if(e!==null&&(e.flags&128)!==0)e:for(e=t.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&$s(e,n,t);else if(e.tag===19)$s(e,n,t);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===t)break e;for(;e.sibling===null;){if(e.return===null||e.return===t)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}i&=1}if(se(he,i),(t.mode&1)===0)t.memoizedState=null;else switch(r){case"forwards":for(n=t.child,r=null;n!==null;)e=n.alternate,e!==null&&ir(e)===null&&(r=n),n=n.sibling;n=r,n===null?(r=t.child,t.child=null):(r=n.sibling,n.sibling=null),no(t,!1,r,n,a);break;case"backwards":for(n=null,r=t.child,t.child=null;r!==null;){if(e=r.alternate,e!==null&&ir(e)===null){t.child=r;break}e=r.sibling,r.sibling=n,n=r,r=e}no(t,!0,n,null,a);break;case"together":no(t,!1,null,null,void 0);break;default:t.memoizedState=null}return t.child}function mr(e,t){(t.mode&1)===0&&e!==null&&(e.alternate=null,t.alternate=null,t.flags|=2)}function Tt(e,t,n){if(e!==null&&(t.dependencies=e.dependencies),rn|=t.lanes,(n&t.childLanes)===0)return null;if(e!==null&&t.child!==e.child)throw Error(_(153));if(t.child!==null){for(e=t.child,n=Zt(e,e.pendingProps),t.child=n,n.return=t;e.sibling!==null;)e=e.sibling,n=n.sibling=Zt(e,e.pendingProps),n.return=t;n.sibling=null}return t.child}function pm(e,t,n){switch(t.tag){case 3:Ws(t),zn();break;case 5:ds(t);break;case 1:Ue(t.type)&&Zi(t);break;case 4:Oa(t,t.stateNode.containerInfo);break;case 10:var i=t.type._context,r=t.memoizedProps.value;se(Xi,i._currentValue),i._currentValue=r;break;case 13:if(i=t.memoizedState,i!==null)return i.dehydrated!==null?(se(he,he.current&1),t.flags|=128,null):(n&t.child.childLanes)!==0?qs(e,t,n):(se(he,he.current&1),e=Tt(e,t,n),e!==null?e.sibling:null);se(he,he.current&1);break;case 19:if(i=(n&t.childLanes)!==0,(e.flags&128)!==0){if(i)return Qs(e,t,n);t.flags|=128}if(r=t.memoizedState,r!==null&&(r.rendering=null,r.tail=null,r.lastEffect=null),se(he,he.current),i)break;return null;case 22:case 23:return t.lanes=0,Ys(e,t,n)}return Tt(e,t,n)}var Xs,io,ec,tc;Xs=function(e,t){for(var n=t.child;n!==null;){if(n.tag===5||n.tag===6)e.appendChild(n.stateNode);else if(n.tag!==4&&n.child!==null){n.child.return=n,n=n.child;continue}if(n===t)break;for(;n.sibling===null;){if(n.return===null||n.return===t)return;n=n.return}n.sibling.return=n.return,n=n.sibling}},io=function(){},ec=function(e,t,n,i){var r=e.memoizedProps;if(r!==i){e=t.stateNode,tn(ft.current);var a=null;switch(n){case"input":r=Lr(e,r),i=Lr(e,i),a=[];break;case"select":r=b({},r,{value:void 0}),i=b({},i,{value:void 0}),a=[];break;case"textarea":r=Or(e,r),i=Or(e,i),a=[];break;default:typeof r.onClick!="function"&&typeof i.onClick=="function"&&(e.onclick=Ki)}Vr(n,i);var o;n=null;for(v in r)if(!i.hasOwnProperty(v)&&r.hasOwnProperty(v)&&r[v]!=null)if(v==="style"){var l=r[v];for(o in l)l.hasOwnProperty(o)&&(n||(n={}),n[o]="")}else v!=="dangerouslySetInnerHTML"&&v!=="children"&&v!=="suppressContentEditableWarning"&&v!=="suppressHydrationWarning"&&v!=="autoFocus"&&(A.hasOwnProperty(v)?a||(a=[]):(a=a||[]).push(v,null));for(v in i){var s=i[v];if(l=r!=null?r[v]:void 0,i.hasOwnProperty(v)&&s!==l&&(s!=null||l!=null))if(v==="style")if(l){for(o in l)!l.hasOwnProperty(o)||s&&s.hasOwnProperty(o)||(n||(n={}),n[o]="");for(o in s)s.hasOwnProperty(o)&&l[o]!==s[o]&&(n||(n={}),n[o]=s[o])}else n||(a||(a=[]),a.push(v,n)),n=s;else v==="dangerouslySetInnerHTML"?(s=s?s.__html:void 0,l=l?l.__html:void 0,s!=null&&l!==s&&(a=a||[]).push(v,s)):v==="children"?typeof s!="string"&&typeof s!="number"||(a=a||[]).push(v,""+s):v!=="suppressContentEditableWarning"&&v!=="suppressHydrationWarning"&&(A.hasOwnProperty(v)?(s!=null&&v==="onScroll"&&ce("scroll",e),a||l===s||(a=[])):(a=a||[]).push(v,s))}n&&(a=a||[]).push("style",n);var v=a;(t.updateQueue=v)&&(t.flags|=4)}},tc=function(e,t,n,i){n!==i&&(t.flags|=4)};function pi(e,t){if(!_e)switch(e.tailMode){case"hidden":t=e.tail;for(var n=null;t!==null;)t.alternate!==null&&(n=t),t=t.sibling;n===null?e.tail=null:n.sibling=null;break;case"collapsed":n=e.tail;for(var i=null;n!==null;)n.alternate!==null&&(i=n),n=n.sibling;i===null?t||e.tail===null?e.tail=null:e.tail.sibling=null:i.sibling=null}}function Ve(e){var t=e.alternate!==null&&e.alternate.child===e.child,n=0,i=0;if(t)for(var r=e.child;r!==null;)n|=r.lanes|r.childLanes,i|=r.subtreeFlags&14680064,i|=r.flags&14680064,r.return=e,r=r.sibling;else for(r=e.child;r!==null;)n|=r.lanes|r.childLanes,i|=r.subtreeFlags,i|=r.flags,r.return=e,r=r.sibling;return e.subtreeFlags|=i,e.childLanes=n,t}function _m(e,t,n){var i=t.pendingProps;switch(Pa(t),t.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return Ve(t),null;case 1:return Ue(t.type)&&Gi(),Ve(t),null;case 3:return i=t.stateNode,Tn(),ue(Fe),ue(Oe),wa(),i.pendingContext&&(i.context=i.pendingContext,i.pendingContext=null),(e===null||e.child===null)&&($i(t)?t.flags|=4:e===null||e.memoizedState.isDehydrated&&(t.flags&256)===0||(t.flags|=1024,ut!==null&&(vo(ut),ut=null))),io(e,t),Ve(t),null;case 5:Da(t);var r=tn(si.current);if(n=t.type,e!==null&&t.stateNode!=null)ec(e,t,n,i,r),e.ref!==t.ref&&(t.flags|=512,t.flags|=2097152);else{if(!i){if(t.stateNode===null)throw Error(_(166));return Ve(t),null}if(e=tn(ft.current),$i(t)){i=t.stateNode,n=t.type;var a=t.memoizedProps;switch(i[kt]=t,i[ii]=a,e=(t.mode&1)!==0,n){case"dialog":ce("cancel",i),ce("close",i);break;case"iframe":case"object":case"embed":ce("load",i);break;case"video":case"audio":for(r=0;r<ei.length;r++)ce(ei[r],i);break;case"source":ce("error",i);break;case"img":case"image":case"link":ce("error",i),ce("load",i);break;case"details":ce("toggle",i);break;case"input":Oo(i,a),ce("invalid",i);break;case"select":i._wrapperState={wasMultiple:!!a.multiple},ce("invalid",i);break;case"textarea":wo(i,a),ce("invalid",i)}Vr(n,a),r=null;for(var o in a)if(a.hasOwnProperty(o)){var l=a[o];o==="children"?typeof l=="string"?i.textContent!==l&&(a.suppressHydrationWarning!==!0&&Ui(i.textContent,l,e),r=["children",l]):typeof l=="number"&&i.textContent!==""+l&&(a.suppressHydrationWarning!==!0&&Ui(i.textContent,l,e),r=["children",""+l]):A.hasOwnProperty(o)&&l!=null&&o==="onScroll"&&ce("scroll",i)}switch(n){case"input":gi(i),Vo(i,a,!0);break;case"textarea":gi(i),jo(i);break;case"select":case"option":break;default:typeof a.onClick=="function"&&(i.onclick=Ki)}i=r,t.updateQueue=i,i!==null&&(t.flags|=4)}else{o=r.nodeType===9?r:r.ownerDocument,e==="http://www.w3.org/1999/xhtml"&&(e=Bo(n)),e==="http://www.w3.org/1999/xhtml"?n==="script"?(e=o.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild)):typeof i.is=="string"?e=o.createElement(n,{is:i.is}):(e=o.createElement(n),n==="select"&&(o=e,i.multiple?o.multiple=!0:i.size&&(o.size=i.size))):e=o.createElementNS(e,n),e[kt]=t,e[ii]=i,Xs(e,t,!1,!1),t.stateNode=e;e:{switch(o=wr(n,i),n){case"dialog":ce("cancel",e),ce("close",e),r=i;break;case"iframe":case"object":case"embed":ce("load",e),r=i;break;case"video":case"audio":for(r=0;r<ei.length;r++)ce(ei[r],e);r=i;break;case"source":ce("error",e),r=i;break;case"img":case"image":case"link":ce("error",e),ce("load",e),r=i;break;case"details":ce("toggle",e),r=i;break;case"input":Oo(e,i),r=Lr(e,i),ce("invalid",e);break;case"option":r=i;break;case"select":e._wrapperState={wasMultiple:!!i.multiple},r=b({},i,{value:void 0}),ce("invalid",e);break;case"textarea":wo(e,i),r=Or(e,i),ce("invalid",e);break;default:r=i}Vr(n,r),l=r;for(a in l)if(l.hasOwnProperty(a)){var s=l[a];a==="style"?Ko(e,s):a==="dangerouslySetInnerHTML"?(s=s?s.__html:void 0,s!=null&&Fo(e,s)):a==="children"?typeof s=="string"?(n!=="textarea"||s!=="")&&On(e,s):typeof s=="number"&&On(e,""+s):a!=="suppressContentEditableWarning"&&a!=="suppressHydrationWarning"&&a!=="autoFocus"&&(A.hasOwnProperty(a)?s!=null&&a==="onScroll"&&ce("scroll",e):s!=null&&O(e,a,s,o))}switch(n){case"input":gi(e),Vo(e,i,!1);break;case"textarea":gi(e),jo(e);break;case"option":i.value!=null&&e.setAttribute("value",""+ie(i.value));break;case"select":e.multiple=!!i.multiple,a=i.value,a!=null?cn(e,!!i.multiple,a,!1):i.defaultValue!=null&&cn(e,!!i.multiple,i.defaultValue,!0);break;default:typeof r.onClick=="function"&&(e.onclick=Ki)}switch(n){case"button":case"input":case"select":case"textarea":i=!!i.autoFocus;break e;case"img":i=!0;break e;default:i=!1}}i&&(t.flags|=4)}t.ref!==null&&(t.flags|=512,t.flags|=2097152)}return Ve(t),null;case 6:if(e&&t.stateNode!=null)tc(e,t,e.memoizedProps,i);else{if(typeof i!="string"&&t.stateNode===null)throw Error(_(166));if(n=tn(si.current),tn(ft.current),$i(t)){if(i=t.stateNode,n=t.memoizedProps,i[kt]=t,(a=i.nodeValue!==n)&&(e=$e,e!==null))switch(e.tag){case 3:Ui(i.nodeValue,n,(e.mode&1)!==0);break;case 5:e.memoizedProps.suppressHydrationWarning!==!0&&Ui(i.nodeValue,n,(e.mode&1)!==0)}a&&(t.flags|=4)}else i=(n.nodeType===9?n:n.ownerDocument).createTextNode(i),i[kt]=t,t.stateNode=i}return Ve(t),null;case 13:if(ue(he),i=t.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(_e&&Qe!==null&&(t.mode&1)!==0&&(t.flags&128)===0)rs(),zn(),t.flags|=98560,a=!1;else if(a=$i(t),i!==null&&i.dehydrated!==null){if(e===null){if(!a)throw Error(_(318));if(a=t.memoizedState,a=a!==null?a.dehydrated:null,!a)throw Error(_(317));a[kt]=t}else zn(),(t.flags&128)===0&&(t.memoizedState=null),t.flags|=4;Ve(t),a=!1}else ut!==null&&(vo(ut),ut=null),a=!0;if(!a)return t.flags&65536?t:null}return(t.flags&128)!==0?(t.lanes=n,t):(i=i!==null,i!==(e!==null&&e.memoizedState!==null)&&i&&(t.child.flags|=8192,(t.mode&1)!==0&&(e===null||(he.current&1)!==0?Te===0&&(Te=3):ko())),t.updateQueue!==null&&(t.flags|=4),Ve(t),null);case 4:return Tn(),io(e,t),e===null&&ti(t.stateNode.containerInfo),Ve(t),null;case 10:return Ra(t.type._context),Ve(t),null;case 17:return Ue(t.type)&&Gi(),Ve(t),null;case 19:if(ue(he),a=t.memoizedState,a===null)return Ve(t),null;if(i=(t.flags&128)!==0,o=a.rendering,o===null)if(i)pi(a,!1);else{if(Te!==0||e!==null&&(e.flags&128)!==0)for(e=t.child;e!==null;){if(o=ir(e),o!==null){for(t.flags|=128,pi(a,!1),i=o.updateQueue,i!==null&&(t.updateQueue=i,t.flags|=4),t.subtreeFlags=0,i=n,n=t.child;n!==null;)a=n,e=i,a.flags&=14680066,o=a.alternate,o===null?(a.childLanes=0,a.lanes=e,a.child=null,a.subtreeFlags=0,a.memoizedProps=null,a.memoizedState=null,a.updateQueue=null,a.dependencies=null,a.stateNode=null):(a.childLanes=o.childLanes,a.lanes=o.lanes,a.child=o.child,a.subtreeFlags=0,a.deletions=null,a.memoizedProps=o.memoizedProps,a.memoizedState=o.memoizedState,a.updateQueue=o.updateQueue,a.type=o.type,e=o.dependencies,a.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),n=n.sibling;return se(he,he.current&1|2),t.child}e=e.sibling}a.tail!==null&&Se()>Ln&&(t.flags|=128,i=!0,pi(a,!1),t.lanes=4194304)}else{if(!i)if(e=ir(o),e!==null){if(t.flags|=128,i=!0,n=e.updateQueue,n!==null&&(t.updateQueue=n,t.flags|=4),pi(a,!0),a.tail===null&&a.tailMode==="hidden"&&!o.alternate&&!_e)return Ve(t),null}else 2*Se()-a.renderingStartTime>Ln&&n!==1073741824&&(t.flags|=128,i=!0,pi(a,!1),t.lanes=4194304);a.isBackwards?(o.sibling=t.child,t.child=o):(n=a.last,n!==null?n.sibling=o:t.child=o,a.last=o)}return a.tail!==null?(t=a.tail,a.rendering=t,a.tail=t.sibling,a.renderingStartTime=Se(),t.sibling=null,n=he.current,se(he,i?n&1|2:n&1),t):(Ve(t),null);case 22:case 23:return yo(),i=t.memoizedState!==null,e!==null&&e.memoizedState!==null!==i&&(t.flags|=8192),i&&(t.mode&1)!==0?(Xe&1073741824)!==0&&(Ve(t),t.subtreeFlags&6&&(t.flags|=8192)):Ve(t),null;case 24:return null;case 25:return null}throw Error(_(156,t.tag))}function vm(e,t){switch(Pa(t),t.tag){case 1:return Ue(t.type)&&Gi(),e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 3:return Tn(),ue(Fe),ue(Oe),wa(),e=t.flags,(e&65536)!==0&&(e&128)===0?(t.flags=e&-65537|128,t):null;case 5:return Da(t),null;case 13:if(ue(he),e=t.memoizedState,e!==null&&e.dehydrated!==null){if(t.alternate===null)throw Error(_(340));zn()}return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 19:return ue(he),null;case 4:return Tn(),null;case 10:return Ra(t.type._context),null;case 22:case 23:return yo(),null;case 24:return null;default:return null}}var dr=!1,we=!1,hm=typeof WeakSet=="function"?WeakSet:Set,P=null;function En(e,t){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(i){Ne(e,t,i)}else n.current=null}function ro(e,t,n){try{n()}catch(i){Ne(e,t,i)}}var nc=!1;function ym(e,t){if(ha=Li,e=xl(),sa(e)){if("selectionStart"in e)var n={start:e.selectionStart,end:e.selectionEnd};else e:{n=(n=e.ownerDocument)&&n.defaultView||window;var i=n.getSelection&&n.getSelection();if(i&&i.rangeCount!==0){n=i.anchorNode;var r=i.anchorOffset,a=i.focusNode;i=i.focusOffset;try{n.nodeType,a.nodeType}catch{n=null;break e}var o=0,l=-1,s=-1,v=0,k=0,f=e,h=null;t:for(;;){for(var z;f!==n||r!==0&&f.nodeType!==3||(l=o+r),f!==a||i!==0&&f.nodeType!==3||(s=o+i),f.nodeType===3&&(o+=f.nodeValue.length),(z=f.firstChild)!==null;)h=f,f=z;for(;;){if(f===e)break t;if(h===n&&++v===r&&(l=o),h===a&&++k===i&&(s=o),(z=f.nextSibling)!==null)break;f=h,h=f.parentNode}f=z}n=l===-1||s===-1?null:{start:l,end:s}}else n=null}n=n||{start:0,end:0}}else n=null;for(ya={focusedElem:e,selectionRange:n},Li=!1,P=t;P!==null;)if(t=P,e=t.child,(t.subtreeFlags&1028)!==0&&e!==null)e.return=t,P=e;else for(;P!==null;){t=P;try{var I=t.alternate;if((t.flags&1024)!==0)switch(t.tag){case 0:case 11:case 15:break;case 1:if(I!==null){var R=I.memoizedProps,Ce=I.memoizedState,d=t.stateNode,c=d.getSnapshotBeforeUpdate(t.elementType===t.type?R:mt(t.type,R),Ce);d.__reactInternalSnapshotBeforeUpdate=c}break;case 3:var p=t.stateNode.containerInfo;p.nodeType===1?p.textContent="":p.nodeType===9&&p.documentElement&&p.removeChild(p.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(_(163))}}catch(N){Ne(t,t.return,N)}if(e=t.sibling,e!==null){e.return=t.return,P=e;break}P=t.return}return I=nc,nc=!1,I}function _i(e,t,n){var i=t.updateQueue;if(i=i!==null?i.lastEffect:null,i!==null){var r=i=i.next;do{if((r.tag&e)===e){var a=r.destroy;r.destroy=void 0,a!==void 0&&ro(t,n,a)}r=r.next}while(r!==i)}}function pr(e,t){if(t=t.updateQueue,t=t!==null?t.lastEffect:null,t!==null){var n=t=t.next;do{if((n.tag&e)===e){var i=n.create;n.destroy=i()}n=n.next}while(n!==t)}}function ao(e){var t=e.ref;if(t!==null){var n=e.stateNode;switch(e.tag){case 5:e=n;break;default:e=n}typeof t=="function"?t(e):t.current=e}}function ic(e){var t=e.alternate;t!==null&&(e.alternate=null,ic(t)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(t=e.stateNode,t!==null&&(delete t[kt],delete t[ii],delete t[Na],delete t[Xu],delete t[em])),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}function rc(e){return e.tag===5||e.tag===3||e.tag===4}function ac(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||rc(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function oo(e,t,n){var i=e.tag;if(i===5||i===6)e=e.stateNode,t?n.nodeType===8?n.parentNode.insertBefore(e,t):n.insertBefore(e,t):(n.nodeType===8?(t=n.parentNode,t.insertBefore(e,n)):(t=n,t.appendChild(e)),n=n._reactRootContainer,n!=null||t.onclick!==null||(t.onclick=Ki));else if(i!==4&&(e=e.child,e!==null))for(oo(e,t,n),e=e.sibling;e!==null;)oo(e,t,n),e=e.sibling}function lo(e,t,n){var i=e.tag;if(i===5||i===6)e=e.stateNode,t?n.insertBefore(e,t):n.appendChild(e);else if(i!==4&&(e=e.child,e!==null))for(lo(e,t,n),e=e.sibling;e!==null;)lo(e,t,n),e=e.sibling}var Le=null,dt=!1;function Ft(e,t,n){for(n=n.child;n!==null;)oc(e,t,n),n=n.sibling}function oc(e,t,n){if(yt&&typeof yt.onCommitFiberUnmount=="function")try{yt.onCommitFiberUnmount(bi,n)}catch{}switch(n.tag){case 5:we||En(n,t);case 6:var i=Le,r=dt;Le=null,Ft(e,t,n),Le=i,dt=r,Le!==null&&(dt?(e=Le,n=n.stateNode,e.nodeType===8?e.parentNode.removeChild(n):e.removeChild(n)):Le.removeChild(n.stateNode));break;case 18:Le!==null&&(dt?(e=Le,n=n.stateNode,e.nodeType===8?ga(e.parentNode,n):e.nodeType===1&&ga(e,n),Gn(e)):ga(Le,n.stateNode));break;case 4:i=Le,r=dt,Le=n.stateNode.containerInfo,dt=!0,Ft(e,t,n),Le=i,dt=r;break;case 0:case 11:case 14:case 15:if(!we&&(i=n.updateQueue,i!==null&&(i=i.lastEffect,i!==null))){r=i=i.next;do{var a=r,o=a.destroy;a=a.tag,o!==void 0&&((a&2)!==0||(a&4)!==0)&&ro(n,t,o),r=r.next}while(r!==i)}Ft(e,t,n);break;case 1:if(!we&&(En(n,t),i=n.stateNode,typeof i.componentWillUnmount=="function"))try{i.props=n.memoizedProps,i.state=n.memoizedState,i.componentWillUnmount()}catch(l){Ne(n,t,l)}Ft(e,t,n);break;case 21:Ft(e,t,n);break;case 22:n.mode&1?(we=(i=we)||n.memoizedState!==null,Ft(e,t,n),we=i):Ft(e,t,n);break;default:Ft(e,t,n)}}function lc(e){var t=e.updateQueue;if(t!==null){e.updateQueue=null;var n=e.stateNode;n===null&&(n=e.stateNode=new hm),t.forEach(function(i){var r=bm.bind(null,e,i);n.has(i)||(n.add(i),i.then(r,r))})}}function pt(e,t){var n=t.deletions;if(n!==null)for(var i=0;i<n.length;i++){var r=n[i];try{var a=e,o=t,l=o;e:for(;l!==null;){switch(l.tag){case 5:Le=l.stateNode,dt=!1;break e;case 3:Le=l.stateNode.containerInfo,dt=!0;break e;case 4:Le=l.stateNode.containerInfo,dt=!0;break e}l=l.return}if(Le===null)throw Error(_(160));oc(a,o,r),Le=null,dt=!1;var s=r.alternate;s!==null&&(s.return=null),r.return=null}catch(v){Ne(r,t,v)}}if(t.subtreeFlags&12854)for(t=t.child;t!==null;)sc(t,e),t=t.sibling}function sc(e,t){var n=e.alternate,i=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:if(pt(t,e),Nt(e),i&4){try{_i(3,e,e.return),pr(3,e)}catch(R){Ne(e,e.return,R)}try{_i(5,e,e.return)}catch(R){Ne(e,e.return,R)}}break;case 1:pt(t,e),Nt(e),i&512&&n!==null&&En(n,n.return);break;case 5:if(pt(t,e),Nt(e),i&512&&n!==null&&En(n,n.return),e.flags&32){var r=e.stateNode;try{On(r,"")}catch(R){Ne(e,e.return,R)}}if(i&4&&(r=e.stateNode,r!=null)){var a=e.memoizedProps,o=n!==null?n.memoizedProps:a,l=e.type,s=e.updateQueue;if(e.updateQueue=null,s!==null)try{l==="input"&&a.type==="radio"&&a.name!=null&&Do(r,a),wr(l,o);var v=wr(l,a);for(o=0;o<s.length;o+=2){var k=s[o],f=s[o+1];k==="style"?Ko(r,f):k==="dangerouslySetInnerHTML"?Fo(r,f):k==="children"?On(r,f):O(r,k,f,v)}switch(l){case"input":Mr(r,a);break;case"textarea":Ho(r,a);break;case"select":var h=r._wrapperState.wasMultiple;r._wrapperState.wasMultiple=!!a.multiple;var z=a.value;z!=null?cn(r,!!a.multiple,z,!1):h!==!!a.multiple&&(a.defaultValue!=null?cn(r,!!a.multiple,a.defaultValue,!0):cn(r,!!a.multiple,a.multiple?[]:"",!1))}r[ii]=a}catch(R){Ne(e,e.return,R)}}break;case 6:if(pt(t,e),Nt(e),i&4){if(e.stateNode===null)throw Error(_(162));r=e.stateNode,a=e.memoizedProps;try{r.nodeValue=a}catch(R){Ne(e,e.return,R)}}break;case 3:if(pt(t,e),Nt(e),i&4&&n!==null&&n.memoizedState.isDehydrated)try{Gn(t.containerInfo)}catch(R){Ne(e,e.return,R)}break;case 4:pt(t,e),Nt(e);break;case 13:pt(t,e),Nt(e),r=e.child,r.flags&8192&&(a=r.memoizedState!==null,r.stateNode.isHidden=a,!a||r.alternate!==null&&r.alternate.memoizedState!==null||(uo=Se())),i&4&&lc(e);break;case 22:if(k=n!==null&&n.memoizedState!==null,e.mode&1?(we=(v=we)||k,pt(t,e),we=v):pt(t,e),Nt(e),i&8192){if(v=e.memoizedState!==null,(e.stateNode.isHidden=v)&&!k&&(e.mode&1)!==0)for(P=e,k=e.child;k!==null;){for(f=P=k;P!==null;){switch(h=P,z=h.child,h.tag){case 0:case 11:case 14:case 15:_i(4,h,h.return);break;case 1:En(h,h.return);var I=h.stateNode;if(typeof I.componentWillUnmount=="function"){i=h,n=h.return;try{t=i,I.props=t.memoizedProps,I.state=t.memoizedState,I.componentWillUnmount()}catch(R){Ne(i,n,R)}}break;case 5:En(h,h.return);break;case 22:if(h.memoizedState!==null){mc(f);continue}}z!==null?(z.return=h,P=z):mc(f)}k=k.sibling}e:for(k=null,f=e;;){if(f.tag===5){if(k===null){k=f;try{r=f.stateNode,v?(a=r.style,typeof a.setProperty=="function"?a.setProperty("display","none","important"):a.display="none"):(l=f.stateNode,s=f.memoizedProps.style,o=s!=null&&s.hasOwnProperty("display")?s.display:null,l.style.display=Uo("display",o))}catch(R){Ne(e,e.return,R)}}}else if(f.tag===6){if(k===null)try{f.stateNode.nodeValue=v?"":f.memoizedProps}catch(R){Ne(e,e.return,R)}}else if((f.tag!==22&&f.tag!==23||f.memoizedState===null||f===e)&&f.child!==null){f.child.return=f,f=f.child;continue}if(f===e)break e;for(;f.sibling===null;){if(f.return===null||f.return===e)break e;k===f&&(k=null),f=f.return}k===f&&(k=null),f.sibling.return=f.return,f=f.sibling}}break;case 19:pt(t,e),Nt(e),i&4&&lc(e);break;case 21:break;default:pt(t,e),Nt(e)}}function Nt(e){var t=e.flags;if(t&2){try{e:{for(var n=e.return;n!==null;){if(rc(n)){var i=n;break e}n=n.return}throw Error(_(160))}switch(i.tag){case 5:var r=i.stateNode;i.flags&32&&(On(r,""),i.flags&=-33);var a=ac(e);lo(e,a,r);break;case 3:case 4:var o=i.stateNode.containerInfo,l=ac(e);oo(e,l,o);break;default:throw Error(_(161))}}catch(s){Ne(e,e.return,s)}e.flags&=-3}t&4096&&(e.flags&=-4097)}function km(e,t,n){P=e,cc(e)}function cc(e,t,n){for(var i=(e.mode&1)!==0;P!==null;){var r=P,a=r.child;if(r.tag===22&&i){var o=r.memoizedState!==null||dr;if(!o){var l=r.alternate,s=l!==null&&l.memoizedState!==null||we;l=dr;var v=we;if(dr=o,(we=s)&&!v)for(P=r;P!==null;)o=P,s=o.child,o.tag===22&&o.memoizedState!==null?dc(r):s!==null?(s.return=o,P=s):dc(r);for(;a!==null;)P=a,cc(a),a=a.sibling;P=r,dr=l,we=v}uc(e)}else(r.subtreeFlags&8772)!==0&&a!==null?(a.return=r,P=a):uc(e)}}function uc(e){for(;P!==null;){var t=P;if((t.flags&8772)!==0){var n=t.alternate;try{if((t.flags&8772)!==0)switch(t.tag){case 0:case 11:case 15:we||pr(5,t);break;case 1:var i=t.stateNode;if(t.flags&4&&!we)if(n===null)i.componentDidMount();else{var r=t.elementType===t.type?n.memoizedProps:mt(t.type,n.memoizedProps);i.componentDidUpdate(r,n.memoizedState,i.__reactInternalSnapshotBeforeUpdate)}var a=t.updateQueue;a!==null&&ms(t,a,i);break;case 3:var o=t.updateQueue;if(o!==null){if(n=null,t.child!==null)switch(t.child.tag){case 5:n=t.child.stateNode;break;case 1:n=t.child.stateNode}ms(t,o,n)}break;case 5:var l=t.stateNode;if(n===null&&t.flags&4){n=l;var s=t.memoizedProps;switch(t.type){case"button":case"input":case"select":case"textarea":s.autoFocus&&n.focus();break;case"img":s.src&&(n.src=s.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(t.memoizedState===null){var v=t.alternate;if(v!==null){var k=v.memoizedState;if(k!==null){var f=k.dehydrated;f!==null&&Gn(f)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(_(163))}we||t.flags&512&&ao(t)}catch(h){Ne(t,t.return,h)}}if(t===e){P=null;break}if(n=t.sibling,n!==null){n.return=t.return,P=n;break}P=t.return}}function mc(e){for(;P!==null;){var t=P;if(t===e){P=null;break}var n=t.sibling;if(n!==null){n.return=t.return,P=n;break}P=t.return}}function dc(e){for(;P!==null;){var t=P;try{switch(t.tag){case 0:case 11:case 15:var n=t.return;try{pr(4,t)}catch(s){Ne(t,n,s)}break;case 1:var i=t.stateNode;if(typeof i.componentDidMount=="function"){var r=t.return;try{i.componentDidMount()}catch(s){Ne(t,r,s)}}var a=t.return;try{ao(t)}catch(s){Ne(t,a,s)}break;case 5:var o=t.return;try{ao(t)}catch(s){Ne(t,o,s)}}}catch(s){Ne(t,t.return,s)}if(t===e){P=null;break}var l=t.sibling;if(l!==null){l.return=t.return,P=l;break}P=t.return}}var fm=Math.ceil,_r=q.ReactCurrentDispatcher,so=q.ReactCurrentOwner,rt=q.ReactCurrentBatchConfig,Q=0,Ee=null,ze=null,Me=0,Xe=0,Rn=Vt(0),Te=0,vi=null,rn=0,vr=0,co=0,hi=null,Ye=null,uo=0,Ln=1/0,It=null,hr=!1,mo=null,Ut=null,yr=!1,Kt=null,kr=0,yi=0,po=null,fr=-1,gr=0;function je(){return(Q&6)!==0?Se():fr!==-1?fr:fr=Se()}function Yt(e){return(e.mode&1)===0?1:(Q&2)!==0&&Me!==0?Me&-Me:nm.transition!==null?(gr===0&&(gr=al()),gr):(e=re,e!==0||(e=window.event,e=e===void 0?16:_l(e.type)),e)}function _t(e,t,n,i){if(50<yi)throw yi=0,po=null,Error(_(185));Bn(e,n,i),((Q&2)===0||e!==Ee)&&(e===Ee&&((Q&2)===0&&(vr|=n),Te===4&&Gt(e,Me)),Ge(e,i),n===1&&Q===0&&(t.mode&1)===0&&(Ln=Se()+500,Wi&&Ht()))}function Ge(e,t){var n=e.callbackNode;nu(e,t);var i=Ii(e,e===Ee?Me:0);if(i===0)n!==null&&nl(n),e.callbackNode=null,e.callbackPriority=0;else if(t=i&-i,e.callbackPriority!==t){if(n!=null&&nl(n),t===1)e.tag===0?tm(_c.bind(null,e)):Xl(_c.bind(null,e)),$u(function(){(Q&6)===0&&Ht()}),n=null;else{switch(ol(i)){case 1:n=Yr;break;case 4:n=il;break;case 16:n=Pi;break;case 536870912:n=rl;break;default:n=Pi}n=Sc(n,pc.bind(null,e))}e.callbackPriority=t,e.callbackNode=n}}function pc(e,t){if(fr=-1,gr=0,(Q&6)!==0)throw Error(_(327));var n=e.callbackNode;if(Mn()&&e.callbackNode!==n)return null;var i=Ii(e,e===Ee?Me:0);if(i===0)return null;if((i&30)!==0||(i&e.expiredLanes)!==0||t)t=Nr(e,i);else{t=i;var r=Q;Q|=2;var a=hc();(Ee!==e||Me!==t)&&(It=null,Ln=Se()+500,on(e,t));do try{Sm();break}catch(l){vc(e,l)}while(!0);Ea(),_r.current=a,Q=r,ze!==null?t=0:(Ee=null,Me=0,t=Te)}if(t!==0){if(t===2&&(r=Gr(e),r!==0&&(i=r,t=_o(e,r))),t===1)throw n=vi,on(e,0),Gt(e,i),Ge(e,Se()),n;if(t===6)Gt(e,i);else{if(r=e.current.alternate,(i&30)===0&&!gm(r)&&(t=Nr(e,i),t===2&&(a=Gr(e),a!==0&&(i=a,t=_o(e,a))),t===1))throw n=vi,on(e,0),Gt(e,i),Ge(e,Se()),n;switch(e.finishedWork=r,e.finishedLanes=i,t){case 0:case 1:throw Error(_(345));case 2:ln(e,Ye,It);break;case 3:if(Gt(e,i),(i&130023424)===i&&(t=uo+500-Se(),10<t)){if(Ii(e,0)!==0)break;if(r=e.suspendedLanes,(r&i)!==i){je(),e.pingedLanes|=e.suspendedLanes&r;break}e.timeoutHandle=fa(ln.bind(null,e,Ye,It),t);break}ln(e,Ye,It);break;case 4:if(Gt(e,i),(i&4194240)===i)break;for(t=e.eventTimes,r=-1;0<i;){var o=31-st(i);a=1<<o,o=t[o],o>r&&(r=o),i&=~a}if(i=r,i=Se()-i,i=(120>i?120:480>i?480:1080>i?1080:1920>i?1920:3e3>i?3e3:4320>i?4320:1960*fm(i/1960))-i,10<i){e.timeoutHandle=fa(ln.bind(null,e,Ye,It),i);break}ln(e,Ye,It);break;case 5:ln(e,Ye,It);break;default:throw Error(_(329))}}}return Ge(e,Se()),e.callbackNode===n?pc.bind(null,e):null}function _o(e,t){var n=hi;return e.current.memoizedState.isDehydrated&&(on(e,t).flags|=256),e=Nr(e,t),e!==2&&(t=Ye,Ye=n,t!==null&&vo(t)),e}function vo(e){Ye===null?Ye=e:Ye.push.apply(Ye,e)}function gm(e){for(var t=e;;){if(t.flags&16384){var n=t.updateQueue;if(n!==null&&(n=n.stores,n!==null))for(var i=0;i<n.length;i++){var r=n[i],a=r.getSnapshot;r=r.value;try{if(!ct(a(),r))return!1}catch{return!1}}}if(n=t.child,t.subtreeFlags&16384&&n!==null)n.return=t,t=n;else{if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return!0;t=t.return}t.sibling.return=t.return,t=t.sibling}}return!0}function Gt(e,t){for(t&=~co,t&=~vr,e.suspendedLanes|=t,e.pingedLanes&=~t,e=e.expirationTimes;0<t;){var n=31-st(t),i=1<<n;e[n]=-1,t&=~i}}function _c(e){if((Q&6)!==0)throw Error(_(327));Mn();var t=Ii(e,0);if((t&1)===0)return Ge(e,Se()),null;var n=Nr(e,t);if(e.tag!==0&&n===2){var i=Gr(e);i!==0&&(t=i,n=_o(e,i))}if(n===1)throw n=vi,on(e,0),Gt(e,t),Ge(e,Se()),n;if(n===6)throw Error(_(345));return e.finishedWork=e.current.alternate,e.finishedLanes=t,ln(e,Ye,It),Ge(e,Se()),null}function ho(e,t){var n=Q;Q|=1;try{return e(t)}finally{Q=n,Q===0&&(Ln=Se()+500,Wi&&Ht())}}function an(e){Kt!==null&&Kt.tag===0&&(Q&6)===0&&Mn();var t=Q;Q|=1;var n=rt.transition,i=re;try{if(rt.transition=null,re=1,e)return e()}finally{re=i,rt.transition=n,Q=t,(Q&6)===0&&Ht()}}function yo(){Xe=Rn.current,ue(Rn)}function on(e,t){e.finishedWork=null,e.finishedLanes=0;var n=e.timeoutHandle;if(n!==-1&&(e.timeoutHandle=-1,qu(n)),ze!==null)for(n=ze.return;n!==null;){var i=n;switch(Pa(i),i.tag){case 1:i=i.type.childContextTypes,i!=null&&Gi();break;case 3:Tn(),ue(Fe),ue(Oe),wa();break;case 5:Da(i);break;case 4:Tn();break;case 13:ue(he);break;case 19:ue(he);break;case 10:Ra(i.type._context);break;case 22:case 23:yo()}n=n.return}if(Ee=e,ze=e=Zt(e.current,null),Me=Xe=t,Te=0,vi=null,co=vr=rn=0,Ye=hi=null,en!==null){for(t=0;t<en.length;t++)if(n=en[t],i=n.interleaved,i!==null){n.interleaved=null;var r=i.next,a=n.pending;if(a!==null){var o=a.next;a.next=r,i.next=o}n.pending=i}en=null}return e}function vc(e,t){do{var n=ze;try{if(Ea(),rr.current=sr,ar){for(var i=ye.memoizedState;i!==null;){var r=i.queue;r!==null&&(r.pending=null),i=i.next}ar=!1}if(nn=0,Ie=Ae=ye=null,ci=!1,ui=0,so.current=null,n===null||n.return===null){Te=1,vi=t,ze=null;break}e:{var a=e,o=n.return,l=n,s=t;if(t=Me,l.flags|=32768,s!==null&&typeof s=="object"&&typeof s.then=="function"){var v=s,k=l,f=k.tag;if((k.mode&1)===0&&(f===0||f===11||f===15)){var h=k.alternate;h?(k.updateQueue=h.updateQueue,k.memoizedState=h.memoizedState,k.lanes=h.lanes):(k.updateQueue=null,k.memoizedState=null)}var z=js(o);if(z!==null){z.flags&=-257,Bs(z,o,l,a,t),z.mode&1&&Hs(a,v,t),t=z,s=v;var I=t.updateQueue;if(I===null){var R=new Set;R.add(s),t.updateQueue=R}else I.add(s);break e}else{if((t&1)===0){Hs(a,v,t),ko();break e}s=Error(_(426))}}else if(_e&&l.mode&1){var Ce=js(o);if(Ce!==null){(Ce.flags&65536)===0&&(Ce.flags|=256),Bs(Ce,o,l,a,t),Ta(In(s,l));break e}}a=s=In(s,l),Te!==4&&(Te=2),hi===null?hi=[a]:hi.push(a),a=o;do{switch(a.tag){case 3:a.flags|=65536,t&=-t,a.lanes|=t;var d=Vs(a,s,t);us(a,d);break e;case 1:l=s;var c=a.type,p=a.stateNode;if((a.flags&128)===0&&(typeof c.getDerivedStateFromError=="function"||p!==null&&typeof p.componentDidCatch=="function"&&(Ut===null||!Ut.has(p)))){a.flags|=65536,t&=-t,a.lanes|=t;var N=ws(a,l,t);us(a,N);break e}}a=a.return}while(a!==null)}kc(n)}catch(L){t=L,ze===n&&n!==null&&(ze=n=n.return);continue}break}while(!0)}function hc(){var e=_r.current;return _r.current=sr,e===null?sr:e}function ko(){(Te===0||Te===3||Te===2)&&(Te=4),Ee===null||(rn&268435455)===0&&(vr&268435455)===0||Gt(Ee,Me)}function Nr(e,t){var n=Q;Q|=2;var i=hc();(Ee!==e||Me!==t)&&(It=null,on(e,t));do try{Nm();break}catch(r){vc(e,r)}while(!0);if(Ea(),Q=n,_r.current=i,ze!==null)throw Error(_(261));return Ee=null,Me=0,Te}function Nm(){for(;ze!==null;)yc(ze)}function Sm(){for(;ze!==null&&!Zc();)yc(ze)}function yc(e){var t=Nc(e.alternate,e,Xe);e.memoizedProps=e.pendingProps,t===null?kc(e):ze=t,so.current=null}function kc(e){var t=e;do{var n=t.alternate;if(e=t.return,(t.flags&32768)===0){if(n=_m(n,t,Xe),n!==null){ze=n;return}}else{if(n=vm(n,t),n!==null){n.flags&=32767,ze=n;return}if(e!==null)e.flags|=32768,e.subtreeFlags=0,e.deletions=null;else{Te=6,ze=null;return}}if(t=t.sibling,t!==null){ze=t;return}ze=t=e}while(t!==null);Te===0&&(Te=5)}function ln(e,t,n){var i=re,r=rt.transition;try{rt.transition=null,re=1,Cm(e,t,n,i)}finally{rt.transition=r,re=i}return null}function Cm(e,t,n,i){do Mn();while(Kt!==null);if((Q&6)!==0)throw Error(_(327));n=e.finishedWork;var r=e.finishedLanes;if(n===null)return null;if(e.finishedWork=null,e.finishedLanes=0,n===e.current)throw Error(_(177));e.callbackNode=null,e.callbackPriority=0;var a=n.lanes|n.childLanes;if(iu(e,a),e===Ee&&(ze=Ee=null,Me=0),(n.subtreeFlags&2064)===0&&(n.flags&2064)===0||yr||(yr=!0,Sc(Pi,function(){return Mn(),null})),a=(n.flags&15990)!==0,(n.subtreeFlags&15990)!==0||a){a=rt.transition,rt.transition=null;var o=re;re=1;var l=Q;Q|=4,so.current=null,ym(e,n),sc(n,e),Uu(ya),Li=!!ha,ya=ha=null,e.current=n,km(n),Wc(),Q=l,re=o,rt.transition=a}else e.current=n;if(yr&&(yr=!1,Kt=e,kr=r),a=e.pendingLanes,a===0&&(Ut=null),$c(n.stateNode),Ge(e,Se()),t!==null)for(i=e.onRecoverableError,n=0;n<t.length;n++)r=t[n],i(r.value,{componentStack:r.stack,digest:r.digest});if(hr)throw hr=!1,e=mo,mo=null,e;return(kr&1)!==0&&e.tag!==0&&Mn(),a=e.pendingLanes,(a&1)!==0?e===po?yi++:(yi=0,po=e):yi=0,Ht(),null}function Mn(){if(Kt!==null){var e=ol(kr),t=rt.transition,n=re;try{if(rt.transition=null,re=16>e?16:e,Kt===null)var i=!1;else{if(e=Kt,Kt=null,kr=0,(Q&6)!==0)throw Error(_(331));var r=Q;for(Q|=4,P=e.current;P!==null;){var a=P,o=a.child;if((P.flags&16)!==0){var l=a.deletions;if(l!==null){for(var s=0;s<l.length;s++){var v=l[s];for(P=v;P!==null;){var k=P;switch(k.tag){case 0:case 11:case 15:_i(8,k,a)}var f=k.child;if(f!==null)f.return=k,P=f;else for(;P!==null;){k=P;var h=k.sibling,z=k.return;if(ic(k),k===v){P=null;break}if(h!==null){h.return=z,P=h;break}P=z}}}var I=a.alternate;if(I!==null){var R=I.child;if(R!==null){I.child=null;do{var Ce=R.sibling;R.sibling=null,R=Ce}while(R!==null)}}P=a}}if((a.subtreeFlags&2064)!==0&&o!==null)o.return=a,P=o;else e:for(;P!==null;){if(a=P,(a.flags&2048)!==0)switch(a.tag){case 0:case 11:case 15:_i(9,a,a.return)}var d=a.sibling;if(d!==null){d.return=a.return,P=d;break e}P=a.return}}var c=e.current;for(P=c;P!==null;){o=P;var p=o.child;if((o.subtreeFlags&2064)!==0&&p!==null)p.return=o,P=p;else e:for(o=c;P!==null;){if(l=P,(l.flags&2048)!==0)try{switch(l.tag){case 0:case 11:case 15:pr(9,l)}}catch(L){Ne(l,l.return,L)}if(l===o){P=null;break e}var N=l.sibling;if(N!==null){N.return=l.return,P=N;break e}P=l.return}}if(Q=r,Ht(),yt&&typeof yt.onPostCommitFiberRoot=="function")try{yt.onPostCommitFiberRoot(bi,e)}catch{}i=!0}return i}finally{re=n,rt.transition=t}}return!1}function fc(e,t,n){t=In(n,t),t=Vs(e,t,1),e=Bt(e,t,1),t=je(),e!==null&&(Bn(e,1,t),Ge(e,t))}function Ne(e,t,n){if(e.tag===3)fc(e,e,n);else for(;t!==null;){if(t.tag===3){fc(t,e,n);break}else if(t.tag===1){var i=t.stateNode;if(typeof t.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(Ut===null||!Ut.has(i))){e=In(n,e),e=ws(t,e,1),t=Bt(t,e,1),e=je(),t!==null&&(Bn(t,1,e),Ge(t,e));break}}t=t.return}}function zm(e,t,n){var i=e.pingCache;i!==null&&i.delete(t),t=je(),e.pingedLanes|=e.suspendedLanes&n,Ee===e&&(Me&n)===n&&(Te===4||Te===3&&(Me&130023424)===Me&&500>Se()-uo?on(e,0):co|=n),Ge(e,t)}function gc(e,t){t===0&&((e.mode&1)===0?t=1:(t=Ti,Ti<<=1,(Ti&130023424)===0&&(Ti=4194304)));var n=je();e=bt(e,t),e!==null&&(Bn(e,t,n),Ge(e,n))}function Pm(e){var t=e.memoizedState,n=0;t!==null&&(n=t.retryLane),gc(e,n)}function bm(e,t){var n=0;switch(e.tag){case 13:var i=e.stateNode,r=e.memoizedState;r!==null&&(n=r.retryLane);break;case 19:i=e.stateNode;break;default:throw Error(_(314))}i!==null&&i.delete(t),gc(e,n)}var Nc;Nc=function(e,t,n){if(e!==null)if(e.memoizedProps!==t.pendingProps||Fe.current)Ke=!0;else{if((e.lanes&n)===0&&(t.flags&128)===0)return Ke=!1,pm(e,t,n);Ke=(e.flags&131072)!==0}else Ke=!1,_e&&(t.flags&1048576)!==0&&es(t,qi,t.index);switch(t.lanes=0,t.tag){case 2:var i=t.type;mr(e,t),e=t.pendingProps;var r=Nn(t,Oe.current);An(t,n),r=Ba(null,t,i,e,r,n);var a=Fa();return t.flags|=1,typeof r=="object"&&r!==null&&typeof r.render=="function"&&r.$$typeof===void 0?(t.tag=1,t.memoizedState=null,t.updateQueue=null,Ue(i)?(a=!0,Zi(t)):a=!1,t.memoizedState=r.state!==null&&r.state!==void 0?r.state:null,xa(t),r.updater=cr,t.stateNode=r,r._reactInternals=t,Wa(t,i,e,n),t=Qa(null,t,i,!0,a,n)):(t.tag=0,_e&&a&&za(t),He(null,t,r,n),t=t.child),t;case 16:i=t.elementType;e:{switch(mr(e,t),e=t.pendingProps,r=i._init,i=r(i._payload),t.type=i,r=t.tag=Tm(i),e=mt(i,e),r){case 0:t=$a(null,t,i,e,n);break e;case 1:t=Zs(null,t,i,e,n);break e;case 11:t=Fs(null,t,i,e,n);break e;case 14:t=Us(null,t,i,mt(i.type,e),n);break e}throw Error(_(306,i,""))}return t;case 0:return i=t.type,r=t.pendingProps,r=t.elementType===i?r:mt(i,r),$a(e,t,i,r,n);case 1:return i=t.type,r=t.pendingProps,r=t.elementType===i?r:mt(i,r),Zs(e,t,i,r,n);case 3:e:{if(Ws(t),e===null)throw Error(_(387));i=t.pendingProps,a=t.memoizedState,r=a.element,cs(e,t),nr(t,i,null,n);var o=t.memoizedState;if(i=o.element,a.isDehydrated)if(a={element:i,isDehydrated:!1,cache:o.cache,pendingSuspenseBoundaries:o.pendingSuspenseBoundaries,transitions:o.transitions},t.updateQueue.baseState=a,t.memoizedState=a,t.flags&256){r=In(Error(_(423)),t),t=Js(e,t,i,n,r);break e}else if(i!==r){r=In(Error(_(424)),t),t=Js(e,t,i,n,r);break e}else for(Qe=Dt(t.stateNode.containerInfo.firstChild),$e=t,_e=!0,ut=null,n=ls(t,null,i,n),t.child=n;n;)n.flags=n.flags&-3|4096,n=n.sibling;else{if(zn(),i===r){t=Tt(e,t,n);break e}He(e,t,i,n)}t=t.child}return t;case 5:return ds(t),e===null&&Aa(t),i=t.type,r=t.pendingProps,a=e!==null?e.memoizedProps:null,o=r.children,ka(i,r)?o=null:a!==null&&ka(i,a)&&(t.flags|=32),Gs(e,t),He(e,t,o,n),t.child;case 6:return e===null&&Aa(t),null;case 13:return qs(e,t,n);case 4:return Oa(t,t.stateNode.containerInfo),i=t.pendingProps,e===null?t.child=Pn(t,null,i,n):He(e,t,i,n),t.child;case 11:return i=t.type,r=t.pendingProps,r=t.elementType===i?r:mt(i,r),Fs(e,t,i,r,n);case 7:return He(e,t,t.pendingProps,n),t.child;case 8:return He(e,t,t.pendingProps.children,n),t.child;case 12:return He(e,t,t.pendingProps.children,n),t.child;case 10:e:{if(i=t.type._context,r=t.pendingProps,a=t.memoizedProps,o=r.value,se(Xi,i._currentValue),i._currentValue=o,a!==null)if(ct(a.value,o)){if(a.children===r.children&&!Fe.current){t=Tt(e,t,n);break e}}else for(a=t.child,a!==null&&(a.return=t);a!==null;){var l=a.dependencies;if(l!==null){o=a.child;for(var s=l.firstContext;s!==null;){if(s.context===i){if(a.tag===1){s=At(-1,n&-n),s.tag=2;var v=a.updateQueue;if(v!==null){v=v.shared;var k=v.pending;k===null?s.next=s:(s.next=k.next,k.next=s),v.pending=s}}a.lanes|=n,s=a.alternate,s!==null&&(s.lanes|=n),La(a.return,n,t),l.lanes|=n;break}s=s.next}}else if(a.tag===10)o=a.type===t.type?null:a.child;else if(a.tag===18){if(o=a.return,o===null)throw Error(_(341));o.lanes|=n,l=o.alternate,l!==null&&(l.lanes|=n),La(o,n,t),o=a.sibling}else o=a.child;if(o!==null)o.return=a;else for(o=a;o!==null;){if(o===t){o=null;break}if(a=o.sibling,a!==null){a.return=o.return,o=a;break}o=o.return}a=o}He(e,t,r.children,n),t=t.child}return t;case 9:return r=t.type,i=t.pendingProps.children,An(t,n),r=nt(r),i=i(r),t.flags|=1,He(e,t,i,n),t.child;case 14:return i=t.type,r=mt(i,t.pendingProps),r=mt(i.type,r),Us(e,t,i,r,n);case 15:return Ks(e,t,t.type,t.pendingProps,n);case 17:return i=t.type,r=t.pendingProps,r=t.elementType===i?r:mt(i,r),mr(e,t),t.tag=1,Ue(i)?(e=!0,Zi(t)):e=!1,An(t,n),Os(t,i,r),Wa(t,i,r,n),Qa(null,t,i,!0,e,n);case 19:return Qs(e,t,n);case 22:return Ys(e,t,n)}throw Error(_(156,t.tag))};function Sc(e,t){return tl(e,t)}function Am(e,t,n,i){this.tag=e,this.key=n,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=t,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function at(e,t,n,i){return new Am(e,t,n,i)}function fo(e){return e=e.prototype,!(!e||!e.isReactComponent)}function Tm(e){if(typeof e=="function")return fo(e)?1:0;if(e!=null){if(e=e.$$typeof,e===vt)return 11;if(e===ht)return 14}return 2}function Zt(e,t){var n=e.alternate;return n===null?(n=at(e.tag,t,e.key,e.mode),n.elementType=e.elementType,n.type=e.type,n.stateNode=e.stateNode,n.alternate=e,e.alternate=n):(n.pendingProps=t,n.type=e.type,n.flags=0,n.subtreeFlags=0,n.deletions=null),n.flags=e.flags&14680064,n.childLanes=e.childLanes,n.lanes=e.lanes,n.child=e.child,n.memoizedProps=e.memoizedProps,n.memoizedState=e.memoizedState,n.updateQueue=e.updateQueue,t=e.dependencies,n.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext},n.sibling=e.sibling,n.index=e.index,n.ref=e.ref,n}function Sr(e,t,n,i,r,a){var o=2;if(i=e,typeof e=="function")fo(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case w:return sn(n.children,r,a,t);case $:o=8,r|=8;break;case ke:return e=at(12,n,t,r|2),e.elementType=ke,e.lanes=a,e;case We:return e=at(13,n,t,r),e.elementType=We,e.lanes=a,e;case lt:return e=at(19,n,t,r),e.elementType=lt,e.lanes=a,e;case ge:return Cr(n,r,a,t);default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case fe:o=10;break e;case ot:o=9;break e;case vt:o=11;break e;case ht:o=14;break e;case Be:o=16,i=null;break e}throw Error(_(130,e==null?e:typeof e,""))}return t=at(o,n,t,r),t.elementType=e,t.type=i,t.lanes=a,t}function sn(e,t,n,i){return e=at(7,e,i,t),e.lanes=n,e}function Cr(e,t,n,i){return e=at(22,e,i,t),e.elementType=ge,e.lanes=n,e.stateNode={isHidden:!1},e}function go(e,t,n){return e=at(6,e,null,t),e.lanes=n,e}function No(e,t,n){return t=at(4,e.children!==null?e.children:[],e.key,t),t.lanes=n,t.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},t}function Im(e,t,n,i,r){this.tag=t,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=Zr(0),this.expirationTimes=Zr(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Zr(0),this.identifierPrefix=i,this.onRecoverableError=r,this.mutableSourceEagerHydrationData=null}function So(e,t,n,i,r,a,o,l,s){return e=new Im(e,t,n,l,s),t===1?(t=1,a===!0&&(t|=8)):t=0,a=at(3,null,null,t),e.current=a,a.stateNode=e,a.memoizedState={element:i,isDehydrated:n,cache:null,transitions:null,pendingSuspenseBoundaries:null},xa(a),e}function Em(e,t,n){var i=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:g,key:i==null?null:""+i,children:e,containerInfo:t,implementation:n}}function Cc(e){if(!e)return wt;e=e._reactInternals;e:{if(Jt(e)!==e||e.tag!==1)throw Error(_(170));var t=e;do{switch(t.tag){case 3:t=t.stateNode.context;break e;case 1:if(Ue(t.type)){t=t.stateNode.__reactInternalMemoizedMergedChildContext;break e}}t=t.return}while(t!==null);throw Error(_(171))}if(e.tag===1){var n=e.type;if(Ue(n))return $l(e,n,t)}return t}function zc(e,t,n,i,r,a,o,l,s){return e=So(n,i,!0,e,r,a,o,l,s),e.context=Cc(null),n=e.current,i=je(),r=Yt(n),a=At(i,r),a.callback=t??null,Bt(n,a,r),e.current.lanes=r,Bn(e,r,i),Ge(e,i),e}function zr(e,t,n,i){var r=t.current,a=je(),o=Yt(r);return n=Cc(n),t.context===null?t.context=n:t.pendingContext=n,t=At(a,o),t.payload={element:e},i=i===void 0?null:i,i!==null&&(t.callback=i),e=Bt(r,t,o),e!==null&&(_t(e,r,o,a),tr(e,r,o)),o}function Pr(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Pc(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var n=e.retryLane;e.retryLane=n!==0&&n<t?n:t}}function Co(e,t){Pc(e,t),(e=e.alternate)&&Pc(e,t)}function Rm(){return null}var bc=typeof reportError=="function"?reportError:function(e){console.error(e)};function zo(e){this._internalRoot=e}br.prototype.render=zo.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(_(409));zr(e,t,null,null)},br.prototype.unmount=zo.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;an(function(){zr(null,e,null,null)}),t[St]=null}};function br(e){this._internalRoot=e}br.prototype.unstable_scheduleHydration=function(e){if(e){var t=cl();e={blockedOn:null,target:e,priority:t};for(var n=0;n<Mt.length&&t!==0&&t<Mt[n].priority;n++);Mt.splice(n,0,e),n===0&&dl(e)}};function Po(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function Ar(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function Ac(){}function Lm(e,t,n,i,r){if(r){if(typeof i=="function"){var a=i;i=function(){var v=Pr(o);a.call(v)}}var o=zc(t,i,e,0,null,!1,!1,"",Ac);return e._reactRootContainer=o,e[St]=o.current,ti(e.nodeType===8?e.parentNode:e),an(),o}for(;r=e.lastChild;)e.removeChild(r);if(typeof i=="function"){var l=i;i=function(){var v=Pr(s);l.call(v)}}var s=So(e,0,!1,null,null,!1,!1,"",Ac);return e._reactRootContainer=s,e[St]=s.current,ti(e.nodeType===8?e.parentNode:e),an(function(){zr(t,s,n,i)}),s}function Tr(e,t,n,i,r){var a=n._reactRootContainer;if(a){var o=a;if(typeof r=="function"){var l=r;r=function(){var s=Pr(o);l.call(s)}}zr(t,o,e,r)}else o=Lm(n,t,e,r,i);return Pr(o)}ll=function(e){switch(e.tag){case 3:var t=e.stateNode;if(t.current.memoizedState.isDehydrated){var n=jn(t.pendingLanes);n!==0&&(Wr(t,n|1),Ge(t,Se()),(Q&6)===0&&(Ln=Se()+500,Ht()))}break;case 13:an(function(){var i=bt(e,1);if(i!==null){var r=je();_t(i,e,1,r)}}),Co(e,1)}},Jr=function(e){if(e.tag===13){var t=bt(e,134217728);if(t!==null){var n=je();_t(t,e,134217728,n)}Co(e,134217728)}},sl=function(e){if(e.tag===13){var t=Yt(e),n=bt(e,t);if(n!==null){var i=je();_t(n,e,t,i)}Co(e,t)}},cl=function(){return re},ul=function(e,t){var n=re;try{return re=e,t()}finally{re=n}},Br=function(e,t,n){switch(t){case"input":if(Mr(e,n),t=n.name,n.type==="radio"&&t!=null){for(n=e;n.parentNode;)n=n.parentNode;for(n=n.querySelectorAll("input[name="+JSON.stringify(""+t)+'][type="radio"]'),t=0;t<n.length;t++){var i=n[t];if(i!==e&&i.form===e.form){var r=Yi(i);if(!r)throw Error(_(90));xo(i),Mr(i,r)}}}break;case"textarea":Ho(e,n);break;case"select":t=n.value,t!=null&&cn(e,!!n.multiple,t,!1)}},Wo=ho,Jo=an;var Mm={usingClientEntryPoint:!1,Events:[ri,fn,Yi,Go,Zo,ho]},ki={findFiberByHostInstance:qt,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},xm={bundleType:ki.bundleType,version:ki.version,rendererPackageName:ki.rendererPackageName,rendererConfig:ki.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:q.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Xo(e),e===null?null:e.stateNode},findFiberByHostInstance:ki.findFiberByHostInstance||Rm,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var Ir=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!Ir.isDisabled&&Ir.supportsFiber)try{bi=Ir.inject(xm),yt=Ir}catch{}}return Ze.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Mm,Ze.createPortal=function(e,t){var n=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!Po(t))throw Error(_(200));return Em(e,t,null,n)},Ze.createRoot=function(e,t){if(!Po(e))throw Error(_(299));var n=!1,i="",r=bc;return t!=null&&(t.unstable_strictMode===!0&&(n=!0),t.identifierPrefix!==void 0&&(i=t.identifierPrefix),t.onRecoverableError!==void 0&&(r=t.onRecoverableError)),t=So(e,1,!1,null,null,n,!1,i,r),e[St]=t.current,ti(e.nodeType===8?e.parentNode:e),new zo(t)},Ze.findDOMNode=function(e){if(e==null)return null;if(e.nodeType===1)return e;var t=e._reactInternals;if(t===void 0)throw typeof e.render=="function"?Error(_(188)):(e=Object.keys(e).join(","),Error(_(268,e)));return e=Xo(t),e=e===null?null:e.stateNode,e},Ze.flushSync=function(e){return an(e)},Ze.hydrate=function(e,t,n){if(!Ar(t))throw Error(_(200));return Tr(null,e,t,!0,n)},Ze.hydrateRoot=function(e,t,n){if(!Po(e))throw Error(_(405));var i=n!=null&&n.hydratedSources||null,r=!1,a="",o=bc;if(n!=null&&(n.unstable_strictMode===!0&&(r=!0),n.identifierPrefix!==void 0&&(a=n.identifierPrefix),n.onRecoverableError!==void 0&&(o=n.onRecoverableError)),t=zc(t,null,e,1,n??null,r,!1,a,o),e[St]=t.current,ti(e),i)for(e=0;e<i.length;e++)n=i[e],r=n._getVersion,r=r(n._source),t.mutableSourceEagerHydrationData==null?t.mutableSourceEagerHydrationData=[n,r]:t.mutableSourceEagerHydrationData.push(n,r);return new br(t)},Ze.render=function(e,t,n){if(!Ar(t))throw Error(_(200));return Tr(null,e,t,!1,n)},Ze.unmountComponentAtNode=function(e){if(!Ar(e))throw Error(_(40));return e._reactRootContainer?(an(function(){Tr(null,null,e,!1,function(){e._reactRootContainer=null,e[St]=null})}),!0):!1},Ze.unstable_batchedUpdates=ho,Ze.unstable_renderSubtreeIntoContainer=function(e,t,n,i){if(!Ar(n))throw Error(_(200));if(e==null||e._reactInternals===void 0)throw Error(_(38));return Tr(e,t,n,!1,i)},Ze.version="18.3.1-next-f1338f8080-20240426",Ze}var Oc;function Fm(){if(Oc)return To.exports;Oc=1;function S(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(S)}catch(E){console.error(E)}}return S(),To.exports=Bm(),To.exports}var Dc;function Um(){if(Dc)return Er;Dc=1;var S=Fm();return Er.createRoot=S.createRoot,Er.hydrateRoot=S.hydrateRoot,Er}var Km=Um();const Ym={en:{appTitle:"CT REPORTING",appSubtitle:"Search Pattern + Template · Evidence-based",evidenceLabel:"Evidence:",dontMiss:"Don't miss:",searchTab:"Search",templateTab:"Template",mismatchTitle:"Template vs. Search Mismatch",searchEvidenceLabel:"Search evidence:",protocolTitle:"Ordered Search Protocol — Execute Before Writing",legendCritical:"Critical",legendHigh:"High",legendStandard:"Standard",formatNote:"Delete-down format · pre-populated normals",copyButton:"Copy",copiedButton:"✓ Copied",usageNote:"Normal findings pre-filled — delete what is abnormal and annotate it. Fill only ___ fields.",criticalNote:"⚠ findings require immediate clinical communication.",guidanceRow1:"ASPECTS · ICH · Fisher · Rotterdam · AAST · Hinchey",guidanceRow2:"Fleischner · Lung-RADS · UIP · ITMIG · RECIST · ESC"},cs:{appTitle:"CT REPORTING",appSubtitle:"Systematika hodnocení + Šablona · Na důkazech založeno",evidenceLabel:"Reference:",dontMiss:"Nepřehlédni:",searchTab:"Systematika",templateTab:"Šablona",mismatchTitle:"Nesoulad šablony a systematiky hodnocení",searchEvidenceLabel:"Reference k systematice:",protocolTitle:"Doporučený postup hodnocení — provést před diktováním",legendCritical:"Kritický",legendHigh:"Prioritní",legendStandard:"Standardní",formatNote:"Formát mazání · předvyplněný normální nález",copyButton:"Kopírovat",copiedButton:"✓ Zkopírováno",usageNote:"Normální nález je předvyplněn — smažte vše, co neplatí, a doplňte patologický nález. Vyplňujte pouze pole označená ___.",criticalNote:"⚠ nálezy vyžadují okamžité sdělení klinikovi.",guidanceRow1:"ASPECTS · ICH skóre · Fisher · Rotterdam · AAST · Hinchey",guidanceRow2:"Fleischner · Lung-RADS · UIP · ITMIG · RECIST · ESC"}},Gm={en:{abdomen:"ABDOMEN",head:"HEAD",chest:"CHEST",spine:"SPINE",oncology:"ONCOLOGY",routine:"ROUTINE"},cs:{abdomen:"BŘICHO",head:"HLAVA",chest:"HRUDNÍK",spine:"PÁTEŘ",oncology:"ONKOLOGIE",routine:"RUTINA"}},Zm={en:{surgical:"Surgical",trauma:"Trauma",oncology:"Oncology",urological:"Urological",vascular:"Vascular",neuro:"Neuro",chest:"Chest",spine:"Spine"},cs:{surgical:"Chirurgie",trauma:"Trauma",oncology:"Onkologie",urological:"Urologie",vascular:"Vaskulární",neuro:"Neuro",chest:"Hrudník",spine:"Páteř"}},Rr=[{key:"abdomen",color:"amber",categories:{surgical:{text:"text-amber-400",badge:"bg-amber-500/15 text-amber-300 border-amber-500/25",border:"border-amber-500/25",bg:"bg-amber-500/8"},trauma:{text:"text-red-400",badge:"bg-red-500/15 text-red-300 border-red-500/25",border:"border-red-500/25",bg:"bg-red-500/8"},oncology:{text:"text-sky-400",badge:"bg-sky-500/15 text-sky-300 border-sky-500/25",border:"border-sky-500/25",bg:"bg-sky-500/8"},urological:{text:"text-teal-400",badge:"bg-teal-500/15 text-teal-300 border-teal-500/25",border:"border-teal-500/25",bg:"bg-teal-500/8"},vascular:{text:"text-orange-400",badge:"bg-orange-500/15 text-orange-300 border-orange-500/25",border:"border-orange-500/25",bg:"bg-orange-500/8"}},tabStyle:{active:"bg-amber-500/15 text-amber-300 border-amber-500/30",inactive:"text-zinc-600 hover:text-zinc-300 border-transparent"}},{key:"head",color:"violet",categories:{neuro:{text:"text-violet-400",badge:"bg-violet-500/15 text-violet-300 border-violet-500/25",border:"border-violet-500/25",bg:"bg-violet-500/8"}},tabStyle:{active:"bg-violet-500/15 text-violet-300 border-violet-500/30",inactive:"text-zinc-600 hover:text-zinc-300 border-transparent"}},{key:"chest",color:"sky",categories:{chest:{text:"text-sky-400",badge:"bg-sky-500/15 text-sky-300 border-sky-500/25",border:"border-sky-500/25",bg:"bg-sky-500/8"}},tabStyle:{active:"bg-sky-500/15 text-sky-300 border-sky-500/30",inactive:"text-zinc-600 hover:text-zinc-300 border-transparent"}},{key:"spine",color:"emerald",categories:{spine:{text:"text-emerald-400",badge:"bg-emerald-500/15 text-emerald-300 border-emerald-500/25",border:"border-emerald-500/25",bg:"bg-emerald-500/8"}},tabStyle:{active:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",inactive:"text-zinc-600 hover:text-zinc-300 border-transparent"}},{key:"oncology",color:"rose",categories:{},tabStyle:{active:"bg-rose-500/15 text-rose-300 border-rose-500/30",inactive:"text-zinc-600 hover:text-zinc-300 border-transparent"},isOncology:!0},{key:"routine",color:"zinc",categories:{},tabStyle:{active:"bg-zinc-700/40 text-zinc-200 border-zinc-500/30",inactive:"text-zinc-600 hover:text-zinc-300 border-transparent"},isRoutine:!0}],Wm={critical:{dot:"bg-red-500",label:"text-red-400",bg:"bg-red-500/6"},high:{dot:"bg-amber-500",label:"text-amber-400",bg:"bg-amber-500/6"},normal:{dot:"bg-zinc-500",label:"text-zinc-400",bg:"bg-zinc-800/20"}},Jm=[{id:"appendicitis",category:"surgical",en:{label:"Appendicitis",evidence:"ACR + ESGAR consensus; Hlibczuk 2010 meta-analysis CT diagnostic criteria; Rao et al. 1997",criticalFindings:["Perforation signs","Pericaecal abscess","Portal venous gas"],searchEvidence:"Rao 1997 CT graded compression; Doria 2006 meta-analysis; Lameris 2009 — RIF-tracing technique vs systematic survey",searchMismatch:"Templates are anatomy-ordered. Correct search is RIF-centric and appendix-first, not organ-by-organ.",searchPattern:[{step:1,priority:"critical",title:"W/L Setup & Scout",detail:"Soft tissue W400/L40. Scroll coronal first for global orientation — dilated bowel, free fluid, RIF density change visible in 5 seconds.",time:"5s"},{step:2,priority:"critical",title:"Locate Caecum → Trace Appendix",detail:"Find caecum (gas + ileocaecal valve) on axials. Trace appendix from base — it always originates here. Follow it to tip. Do NOT start by looking for a 'round structure in RIF'.",time:"45s"},{step:3,priority:"critical",title:"Appendix Not Found? Systematic RIF",detail:"Retrocaecal (most common), retroileal, pelvic, subhepatic positions. Absence of visualisation ≠ normal. Look for fat stranding without appendix — perforation/abscess until proven otherwise.",time:"30s"},{step:4,priority:"high",title:"Characterise Appendix",detail:"Diameter, wall thickening, surrounding fat stranding, appendicolith. Diameter >6mm + stranding = appendicitis. Extraluminal appendicolith = perforation.",time:"20s"},{step:5,priority:"high",title:"Complications Sweep",detail:"Switch to lung windows — free air? Abscess in RIF? Portal venous gas (rare but critical). Peritoneal fluid distribution.",time:"20s"},{step:6,priority:"normal",title:"Alternative Diagnosis [if appendix normal]",detail:"Right ovary and adnexa. Terminal ileum (Crohn, Meckel). Caecum wall. Right ureter/calculus. Mesenteric nodes. Only after appendix is confirmed normal.",time:"30s"},{step:7,priority:"normal",title:"Standard Organ Survey",detail:"Liver, spleen, kidneys, remaining bowel. Incidentals. This comes LAST.",time:"30s"}],template:`CT ABDOMEN & PELVIS — ACUTE APPENDICITIS
...
Poznámka: GCIG kritéria: CA-125 ≥2× minimum = PD bez ohledu na RECIST`}}}}],Ro=[...ed,...td],wc={en:{selectTumour:"Select tumour type",clinicalQuestion:"Clinical question",staging:"Staging",response:"Response assessment",scanExtent:"Scan extent",extents:{ap:"Abdomen & Pelvis",cap:"Chest + Abdomen + Pelvis",ncap:"Neck + Chest + Abdomen + Pelvis"},classificationLabel:"Classification:",criteriaLabel:"Response criteria:",stagingNote:"Staging search differs from response — primary tumour assessment first, then nodal and distant disease.",responseNote:"Response search: prior report before images, target lesions before new lesion survey.",templateSections:{tumorSpecific:"TUMOUR-SPECIFIC ASSESSMENT",abdomen:"ABDOMEN & PELVIS",chest:"CHEST",neck:"NECK",impression:"IMPRESSION"}},cs:{selectTumour:"Vyberte typ nádoru",clinicalQuestion:"Klinická otázka",staging:"Staging",response:"Hodnocení odpovědi",scanExtent:"Rozsah vyšetření",extents:{ap:"Břicho a pánev",cap:"Hrudník + břicho + pánev",ncap:"Krk + hrudník + břicho + pánev"},classificationLabel:"Klasifikace:",criteriaLabel:"Kritéria odpovědi:",stagingNote:"Systematika stagingu se liší od hodnocení odpovědi — nejdříve primární tumor, pak uzlinové a vzdálené postižení.",responseNote:"Systematika odpovědi: nejdříve starý protokol, pak cílové léze, pak přehled nových lézí.",templateSections:{tumorSpecific:"SPECIFICKÉ HODNOCENÍ NÁDORU",abdomen:"BŘICHO A PÁNEV",chest:"HRUDNÍK",neck:"KRK",impression:"ZÁVĚR"}}},nd={en:{colorectal:"Colorectal",pancreatic:"Pancreatic",rcc:"Renal Cell Ca.",lymphoma:"Lymphoma",hcc:"HCC",melanoma:"Melanoma",gastric:"Gastric",ovarian:"Ovarian"},cs:{colorectal:"Kolorektální",pancreatic:"Pankreatický",rcc:"Karcinom ledviny",lymphoma:"Lymfom",hcc:"HCC",melanoma:"Melanom",gastric:"Žaludeční",ovarian:"Ovariální"}},Pe="#fb7185",id={critical:{dot:"#f87171",label:"#f87171",border:"#f87171",pill:"rgba(248,113,113,0.12)",pillText:"#f87171"},high:{dot:"#fbbf24",label:"#fbbf24",border:"#fbbf24",pill:"rgba(251,191,36,0.12)",pillText:"#fbbf24"},normal:{dot:"#6b7280",label:"#9ca3af",border:"#374151",pill:"rgba(107,114,128,0.10)",pillText:"#9ca3af"}},Hc={ap:["tumorSpecific","abdomen","impression"],cap:["tumorSpecific","chest","abdomen","impression"],ncap:["tumorSpecific","neck","chest","abdomen","impression"]};function rd(S,E,_){const U=Hc[E]||Hc.ap,A=S.template;return U.filter(H=>A[H]).map(H=>{const K=_[H];return!K||H==="tumorSpecific"?A[H]:`
${"─".repeat(60)}
${K}
${"─".repeat(60)}
${A[H]}`}).join(`
`)}function ad({lang:S,ui:E}){var q;const[_,U]=ve.useState(null),[A,H]=ve.useState("staging"),[K,ne]=ve.useState("cap"),[j,me]=ve.useState("search"),[ae,x]=ve.useState(!1),Y=wc[S],de=nd[S],oe=Ro.find(T=>T.id===_),M=(q=oe==null?void 0:oe[S])==null?void 0:q[A],G=(oe==null?void 0:oe.validExtents)||["ap","cap"],xe=ve.useMemo(()=>M?rd(M,K,Y.templateSections):"",[M,K,Y]),be=()=>{navigator.clipboard.writeText(xe),x(!0),setTimeout(()=>x(!1),2e3)},O=T=>{const g=Ro.find(w=>w.id===T);U(T),g&&!g.validExtents.includes(K)&&ne(g.validExtents[0]),me("search"),x(!1)};return _?u.jsxs("div",{style:{maxWidth:"820px"},children:[u.jsx("div",{style:{background:"var(--card)",border:`1px solid ${Pe}25`,borderTop:`3px solid ${Pe}`,borderRadius:"10px",padding:"20px 22px",marginBottom:"20px"},children:u.jsxs("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:"16px",flexWrap:"wrap"},children:[u.jsxs("div",{style:{flex:1,minWidth:0},children:[u.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px",marginBottom:"10px",flexWrap:"wrap"},children:[u.jsx("button",{onClick:()=>U(null),style:{fontSize:"12px",padding:"4px 10px",borderRadius:"6px",border:"1px solid var(--border-md)",background:"transparent",color:"var(--text-2)",cursor:"pointer"},children:"← back"}),u.jsx("h1",{style:{margin:0,fontSize:"18px",fontWeight:700,color:"#f0f2f7"},children:oe[S].label})]}),M&&u.jsxs("p",{style:{margin:0,fontSize:"13px",color:"var(--text-2)",lineHeight:1.6},children:[u.jsxs("span",{style:{color:"#9ca3af",fontWeight:600},children:[E.evidenceLabel," "]}),M.evidence]}),u.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"20px",marginTop:"14px"},children:[u.jsxs("div",{children:[u.jsx("div",{style:{fontSize:"10px",fontWeight:700,letterSpacing:"0.1em",color:"var(--text-3)",textTransform:"uppercase",marginBottom:"6px"},children:Y.clinicalQuestion}),u.jsx("div",{style:{display:"flex",gap:"4px"},children:["staging","response"].map(T=>u.jsx("button",{onClick:()=>{H(T),me("search")},style:{fontSize:"12px",fontWeight:A===T?700:500,padding:"5px 14px",borderRadius:"6px",cursor:"pointer",border:A===T?`1px solid ${Pe}40`:"1px solid var(--border-md)",background:A===T?`${Pe}15`:"transparent",color:A===T?Pe:"var(--text-2)",transition:"all 0.15s"},children:T==="staging"?Y.staging:Y.response},T))})]}),u.jsxs("div",{children:[u.jsx("div",{style:{fontSize:"10px",fontWeight:700,letterSpacing:"0.1em",color:"var(--text-3)",textTransform:"uppercase",marginBottom:"6px"},children:Y.scanExtent}),u.jsx("div",{style:{display:"flex",gap:"4px",flexWrap:"wrap"},children:G.map(T=>u.jsx("button",{onClick:()=>ne(T),style:{fontSize:"12px",fontWeight:K===T?700:500,padding:"5px 14px",borderRadius:"6px",cursor:"pointer",border:K===T?`1px solid ${Pe}40`:"1px solid var(--border-md)",background:K===T?`${Pe}15`:"transparent",color:K===T?Pe:"var(--text-2)",transition:"all 0.15s"},children:Y.extents[T]},T))})]})]}),M&&u.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px",marginTop:"14px",alignItems:"center"},children:[u.jsx("span",{style:{fontSize:"11px",color:"var(--text-2)",marginRight:"2px"},children:E.dontMiss}),M.criticalFindings.map(T=>u.jsxs("span",{style:{fontSize:"11px",fontWeight:600,padding:"2px 9px",borderRadius:"4px",background:"rgba(248,113,113,0.1)",border:"1px solid rgba(248,113,113,0.25)",color:"#f87171"},children:["⚠ ",T]},T))]})]}),u.jsx("div",{style:{display:"flex",background:"var(--surface)",border:"1px solid var(--border)",borderRadius:"8px",padding:"3px",flexShrink:0,alignSelf:"flex-start"},children:[["search",E.searchTab],["template",E.templateTab]].map(([T,g])=>u.jsx("button",{onClick:()=>me(T),style:{fontSize:"12px",fontWeight:j===T?700:500,padding:"6px 16px",borderRadius:"6px",cursor:"pointer",border:j===T?`1px solid ${Pe}35`:"1px solid transparent",background:j===T?`${Pe}18`:"transparent",color:j===T?Pe:"var(--text-2)",transition:"all 0.15s"},children:g},T))})]})}),j==="search"&&M&&u.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[u.jsxs("div",{style:{background:"var(--card)",border:"1px solid var(--border)",borderLeft:"3px solid #fbbf24",borderRadius:"10px",padding:"16px 18px"},children:[u.jsx("div",{style:{fontSize:"10px",fontWeight:700,letterSpacing:"0.1em",color:"#fbbf24",textTransform:"uppercase",marginBottom:"8px"},children:E.mismatchTitle}),u.jsx("p",{style:{margin:0,fontSize:"14px",color:"var(--text)",lineHeight:1.65},children:M.searchMismatch}),u.jsx("div",{style:{marginTop:"10px"},children:u.jsxs("span",{style:{fontSize:"12px",fontWeight:600,padding:"3px 10px",borderRadius:"20px",background:`${Pe}15`,border:`1px solid ${Pe}30`,color:Pe},children:[A==="staging"?Y.classificationLabel:Y.criteriaLabel," ",A==="staging"?M.classification:M.criteria]})}),u.jsxs("p",{style:{fontSize:"12px",color:"var(--text-2)",margin:"10px 0 0",lineHeight:1.6},children:[u.jsxs("span",{style:{color:"#9ca3af",fontWeight:600},children:[E.searchEvidenceLabel," "]}),M.searchEvidence]})]}),u.jsxs("div",{style:{background:"var(--card)",border:"1px solid var(--border)",borderRadius:"10px",overflow:"hidden"},children:[u.jsx("div",{style:{padding:"12px 18px",borderBottom:"1px solid var(--border)",background:"var(--elevated)",fontSize:"10px",fontWeight:700,letterSpacing:"0.1em",color:"var(--text-2)",textTransform:"uppercase"},children:E.protocolTitle}),M.searchPattern.map((T,g)=>{const w=id[T.priority],$=g===M.searchPattern.length-1;return u.jsxs("div",{style:{display:"flex",gap:"14px",padding:"16px 18px",borderBottom:$?"none":"1px solid var(--border)",borderLeft:`3px solid ${w.border}`,background:g%2===0?"transparent":"rgba(255,255,255,0.015)"},children:[u.jsx("div",{style:{flexShrink:0,width:"24px",height:"24px",borderRadius:"6px",background:w.pill,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"11px",fontWeight:700,color:w.pillText,fontFamily:"monospace"},children:T.step}),u.jsxs("div",{style:{flex:1,minWidth:0},children:[u.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:"10px",marginBottom:"5px",flexWrap:"wrap"},children:[u.jsx("span",{style:{fontSize:"14px",fontWeight:600,color:w.label},children:T.title}),u.jsx("span",{style:{fontSize:"11px",color:"var(--text-3)",background:"var(--elevated)",borderRadius:"4px",padding:"1px 6px",fontFamily:"monospace"},children:T.time})]}),u.jsx("p",{style:{fontSize:"13px",color:"var(--text-2)",margin:0,lineHeight:1.65},children:T.detail})]})]},T.step)})]}),u.jsx("div",{style:{display:"flex",gap:"20px",padding:"0 4px"},children:[["#f87171",E.legendCritical],["#fbbf24",E.legendHigh],["#6b7280",E.legendStandard]].map(([T,g])=>u.jsxs("span",{style:{display:"flex",alignItems:"center",gap:"6px",fontSize:"12px",color:"var(--text-2)"},children:[u.jsx("span",{style:{width:7,height:7,borderRadius:"50%",background:T,flexShrink:0}}),g]},g))})]}),j==="template"&&M&&u.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[u.jsxs("div",{style:{background:"var(--card)",border:"1px solid var(--border)",borderRadius:"10px",overflow:"hidden"},children:[u.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 16px",borderBottom:"1px solid var(--border)",background:"var(--elevated)"},children:[u.jsxs("span",{style:{fontSize:"12px",color:"var(--text-2)"},children:[E.formatNote," · ",Y.extents[K]]}),u.jsx("button",{onClick:be,style:{fontSize:"12px",fontWeight:600,padding:"5px 14px",borderRadius:"6px",cursor:"pointer",border:`1px solid ${ae?Pe:"rgba(255,255,255,0.12)"}`,background:ae?`${Pe}20`:"transparent",color:ae?Pe:"var(--text-2)",transition:"all 0.15s"},children:ae?E.copiedButton:E.copyButton})]}),u.jsx("pre",{style:{margin:0,padding:"20px",fontFamily:"'JetBrains Mono','Cascadia Code','Fira Code',monospace",fontSize:"12.5px",lineHeight:1.9,color:"#c9d1e0",overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word"},children:xe})]}),u.jsxs("p",{style:{fontSize:"12px",color:"var(--text-2)",padding:"0 4px",lineHeight:1.6,margin:0},children:[E.usageNote," ",u.jsx("span",{style:{color:"#f87171"},children:E.criticalNote})]})]})]}):u.jsxs("div",{style:{maxWidth:"820px"},children:[u.jsxs("div",{style:{background:"var(--card)",border:`1px solid ${Pe}25`,borderTop:`3px solid ${Pe}`,borderRadius:"10px",padding:"20px 22px",marginBottom:"24px"},children:[u.jsx("h1",{style:{margin:"0 0 6px",fontSize:"18px",fontWeight:700,color:"#f0f2f7"},children:Y.selectTumour}),u.jsx("p",{style:{margin:0,fontSize:"13px",color:"var(--text-2)"},children:"Select a tumour type below, then choose clinical question and scan extent."})]}),u.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(170px, 1fr))",gap:"10px"},children:Ro.map(T=>u.jsxs("button",{onClick:()=>O(T.id),style:{textAlign:"left",padding:"16px",background:"var(--card)",border:"1px solid var(--border)",borderRadius:"10px",cursor:"pointer",transition:"all 0.15s"},onMouseEnter:g=>{g.currentTarget.style.borderColor=`${Pe}40`,g.currentTarget.style.background="var(--elevated)"},onMouseLeave:g=>{g.currentTarget.style.borderColor="var(--border)",g.currentTarget.style.background="var(--card)"},children:[u.jsx("div",{style:{fontSize:"14px",fontWeight:600,color:"var(--text)",marginBottom:"5px"},children:de[T.id]}),u.jsx("div",{style:{fontSize:"11px",color:"var(--text-2)"},children:T.validExtents.map(g=>wc[S].extents[g]).join(" · ")})]},T.id))})]})}const Lo=[{id:"ct_bricha",title:"CT BŘICHA A PÁNVE",techniqueLabel:"Technika",defaultTechnique:"Portální fáze, i.v. KL ___ ml Iomeron 400, bez reakce.",normalConclusion:"Přiměřený nález na CT břicha a pánve.",groups:[{label:"Hrudník (zachycen)",fields:[{id:"plice_baze",label:"Plicní baze",reportLabel:"Zachycená část plic",options:[{label:"Normální",value:"V normě.",isNormal:!0,correlates:[]},{label:"Atelektáza",value:"Parciální atelektáza bazálně ___ vlevo/vpravo.",isNormal:!1,summaryLabel:"Atelektáza plicní baze",correlates:["pleura"]},{label:"Infiltrace",value:"Infiltrát/konsolidace v ___.",isNormal:!1,summaryLabel:"Plicní infiltrát",correlates:[]},{label:"Uzlík",value:"Ojedinělý pulmonální uzlík ___ mm — ke srovnání / Fleischner doporučení.",isNormal:!1,summaryLabel:"Pulmonální uzlík",correlates:[]},{label:"Fluidothorax",value:"Fluidothorax vpravo/vlevo — množství ___.",isNormal:!1,summaryLabel:"Fluidothorax",correlates:["pleura"]},{label:"Emfyzém",value:"Plicní emfyzém.",isNormal:!1,summaryLabel:"Plicní emfyzém",correlates:[]}]}]},{label:"Parenchymatózní orgány",fields:[{id:"jatra",label:"Játra",reportLabel:"Játra",options:[{label:"Normální",value:"V normě, homogenní parenchym. Bez ložiskových změn.",isNormal:!0,correlates:[]},{label:"Steatóza",value:"Jaterní steatóza.",isNormal:!1,summaryLabel:"Jaterní steatóza",correlates:["bili"]},{label:"Cysty / hemangiomy",value:"Drobná ložiska v.s. cysty/hemangiomy (do ___ mm).",isNormal:!1,summaryLabel:"Benigní ložiska jater",correlates:[]},{label:"Ložisko — sumptní",value:"Fokální hypodenzní ložisko ___ mm v S___ — k dovyšetření.",isNormal:!1,summaryLabel:"Ložisko jater k dovyšetření",correlates:["uzliny_retro","peritonealni"]},{label:"Hepatomegalie",value:"Hepatomegalie.",isNormal:!1,summaryLabel:"Hepatomegalie",correlates:["porta","slezina"]},{label:"Nehomogenní sycení",value:"Nehomogenní sycení parenchymu.",isNormal:!1,summaryLabel:"Nehomogenní jaterní parenchym",correlates:["porta"]},{label:"Abscesy",value:"Vícečetná hypodenzní ložiska susp. absces/y — k dovyšetření.",isNormal:!1,summaryLabel:"Suspektní jaterní abscesy",correlates:[]}]},{id:"bili",label:"Žlučové cesty",reportLabel:"Žlučové cesty",options:[{label:"Normální",value:"D. choledochus štíhlý do ___ mm. IJCH nerozšířeny.",isNormal:!0,correlates:[]},{label:"Postcholecystektomická dil.",value:"D. choledochus šíře do ___ mm — postcholecystektomická dilatace v mezích normy.",isNormal:!0,correlates:["zlucdnik"]},{label:"Dilatace d. choledochus",value:"Dilatace d. choledochus na ___ mm s dilatací IJCH.",isNormal:!1,summaryLabel:"Dilatace žlučových cest",correlates:["pankreas","zlucdnik"]},{label:"Choledocholitiáza",value:"Choledocholitiáza — konkrement v distální části d. choledochus.",isNormal:!1,summaryLabel:"Choledocholitiáza",correlates:["pankreas","zlucdnik"]},{label:"Pneumobilie",value:"Pneumobilie.",isNormal:!1,summaryLabel:"Pneumobilie",correlates:["zlucdnik"]}]},{id:"zlucdnik",label:"Žlučník",reportLabel:"Žlučník",options:[{label:"Normální",value:"Přiměřený.",isNormal:!0,correlates:[]},{label:"St.p. CHCE",value:"Stav po CHCE.",isNormal:!0,correlates:["bili"]},{label:"Cholecystolitiáza",value:"Cholecystolitiáza — konkrementy do ___ mm.",isNormal:!1,summaryLabel:"Cholecystolitiáza",correlates:[]},{label:"Cholecystitida",value:"Ztluštění stěny žlučníku na ___ mm. Pericholecy stická tekutina — v.s. akutní cholecystitida.",isNormal:!1,summaryLabel:"Suspektní cholecystitida",correlates:["bili","peritonealni"]},{label:"Hydrops",value:"Hydrops žlučníku.",isNormal:!1,summaryLabel:"Hydrops žlučníku",correlates:["bili"]},{label:"Stěnová kalcifikace",value:"Kalcifikace stěny žlučníku.",isNormal:!1,summaryLabel:"Kalcifikace žlučníku",correlates:[]}]},{id:"porta",label:"Porta",reportLabel:"Porta",options:[{label:"Normální",value:"Normální.",isNormal:!0,correlates:[]},{label:"Portální hypertenze",value:"Portální hypertenze — rozšíření v. portae na ___ mm.",isNormal:!1,summaryLabel:"Portální hypertenze",correlates:["slezina","jatra"]},{label:"Trombóza VP",value:"Trombóza v. portae.",isNormal:!1,summaryLabel:"Trombóza v. portae",correlates:["jatra","slezina"]},{label:"Trombóza VMH",value:"Trombóza v. mesenterica superior.",isNormal:!1,summaryLabel:"Trombóza VMH",correlates:["travici","jatra"]},{label:"Kavernózní transformace",value:"Kavernózní transformace v. portae.",isNormal:!1,summaryLabel:"Kavernózní transformace v. portae",correlates:["slezina"]}]},{id:"pankreas",label:"Pankreas",reportLabel:"Pankreas",options:[{label:"Normální",value:"Normální velikosti, kontury a sycení. Bez dilatace vývodu.",isNormal:!0,correlates:[]},{label:"Dilatace vývodu",value:"Dilatace Wirsungova vývodu na ___ mm.",isNormal:!1,summaryLabel:"Dilatace pankreatického vývodu",correlates:["bili"]},{label:"Atrofie",value:"Atrofie pankreatického parenchymu.",isNormal:!1,summaryLabel:"Atrofie pankreatu",correlates:["bili"]},{label:"Akutní pankreatitida",value:"Zvětšení pankreatu s infiltrací peripankreatického tuku — v.s. akutní pankreatitida.",isNormal:!1,summaryLabel:"Akutní pankreatitida",correlates:["peritonealni","slezina"]},{label:"Ložisko / nádor",value:"Hypovaskulární ložisko ___ mm v ___ pankreatu — k dovyšetření.",isNormal:!1,summaryLabel:"Ložisko pankreatu k dovyšetření",correlates:["bili","uzliny_retro"]},{label:"Pseudocysta",value:"Pseudocysta pankreatu ___ mm v ___.",isNormal:!1,summaryLabel:"Pseudocysta pankreatu",correlates:[]}]},{id:"slezina",label:"Slezina",reportLabel:"Slezina",options:[{label:"Normální",value:"Normální.",isNormal:!0,correlates:[]},{label:"Splenomegalie",value:"Splenomegalie — ___ cm v KK rozměru.",isNormal:!1,summaryLabel:"Splenomegalie",correlates:["porta"]},{label:"Ložiska",value:"Vícečetná fokální hypodenzní ložiska sleziny.",isNormal:!1,summaryLabel:"Ložiska sleziny",correlates:["uzliny_retro"]},{label:"Stac. hematom",value:"Kalcifikovaný hematom sleziny — stacionárně.",isNormal:!0,correlates:[]},{label:"Akcesorní slezina",value:"Akcesorní slezina.",isNormal:!0,correlates:[]}]},{id:"nadledviny",label:"Nadledviny",reportLabel:"Nadledviny",options:[{label:"Normální bilat.",value:"Normální bilaterálně.",isNormal:!0,correlates:[]},{label:"Adenom vpravo",value:"Drobný adenom pravé nadledviny — ___ mm, denzita < 10 HU.",isNormal:!1,summaryLabel:"Adenom pravé nadledviny",correlates:[]},{label:"Adenom vlevo",value:"Drobný adenom levé nadledviny — ___ mm, denzita < 10 HU.",isNormal:!1,summaryLabel:"Adenom levé nadledviny",correlates:[]},{label:"Uzel — suspektní",value:"Nodulární zvětšení nadledviny vpravo/vlevo — ___ mm, k dovyšetření (MRI / washout CT).",isNormal:!1,summaryLabel:"Suspektní uzel nadledviny",correlates:["uzliny_retro"]},{label:"Bilat. zvětšení",value:"Bilaterální zvětšení nadledvin — k dovyšetření (endokrinologie).",isNormal:!1,summaryLabel:"Bilaterální zvětšení nadledvin",correlates:[]}]}]},{label:"Ledviny a vývodné cesty",fields:[{id:"ledvina_p",label:"Ledvina vpravo",reportLabel:"Pravá ledvina",options:[{label:"Normální",value:"Normální tvaru, velikosti a sycení.",isNormal:!0,correlates:[]},{label:"Nefrolitiáza",value:"Nefrolitiáza — konkrement ___ mm.",isNormal:!1,summaryLabel:"Nefrolitiáza vpravo",correlates:["ureter_p"]},{label:"Hydronefróza I°",value:"Hydronefróza I. stupně vpravo.",isNormal:!1,summaryLabel:"Hydronefróza I° vpravo",correlates:["ureter_p"]},{label:"Hydronefróza II°",value:"Hydronefróza II. stupně vpravo.",isNormal:!1,summaryLabel:"Hydronefróza II° vpravo",correlates:["ureter_p"]},{label:"Cysta Bosniak I",value:"Kortikální cysta Bosniak I — ___ mm.",isNormal:!1,summaryLabel:"Renální cysta vpravo (Bosniak I)",correlates:[]},{label:"Ložisko — sumptní",value:"Kortikální ložisko ___ mm vpravo — k dovyšetření (MRI ledvin).",isNormal:!1,summaryLabel:"Ložisko pravé ledviny k dovyšetření",correlates:["uzliny_retro"]}]},{id:"ledvina_l",label:"Ledvina vlevo",reportLabel:"Levá ledvina",options:[{label:"Normální",value:"Normální tvaru, velikosti a sycení.",isNormal:!0,correlates:[]},{label:"Nefrolitiáza",value:"Nefrolitiáza — konkrement ___ mm.",isNormal:!1,summaryLabel:"Nefrolitiáza vlevo",correlates:["ureter_l"]},{label:"Hydronefróza I°",value:"Hydronefróza I. stupně vlevo.",isNormal:!1,summaryLabel:"Hydronefróza I° vlevo",correlates:["ureter_l"]},{label:"Hydronefróza II°",value:"Hydronefróza II. stupně vlevo.",isNormal:!1,summaryLabel:"Hydronefróza II° vlevo",correlates:["ureter_l"]},{label:"Cysta Bosniak I",value:"Kortikální cysta Bosniak I — ___ mm.",isNormal:!1,summaryLabel:"Renální cysta vlevo (Bosniak I)",correlates:[]},{label:"Ložisko — suspektní",value:"Kortikální ložisko ___ mm vlevo — k dovyšetření (MRI ledvin).",isNormal:!1,summaryLabel:"Ložisko levé ledviny k dovyšetření",correlates:["uzliny_retro"]}]},{id:"ureter_p",label:"Ureter vpravo",reportLabel:"Pravý ureter",options:[{label:"Nerozšířen",value:"Nerozšířen.",isNormal:!0,correlates:[]},{label:"Dilatace",value:"Dilatace pravého ureteru na ___ mm.",isNormal:!1,summaryLabel:"Dilatace pravého ureteru",correlates:["ledvina_p"]},{label:"Ureterolitiáza",value:"Ureterolitiáza vpravo — konkrement ___ mm v ___.",isNormal:!1,summaryLabel:"Ureterolitiáza vpravo",correlates:["ledvina_p"]},{label:"Stent in situ",value:"Stent in situ.",isNormal:!0,correlates:[]},{label:"Pig-tail katétr",value:"Pig-tail katétr in situ.",isNormal:!0,correlates:[]}]},{id:"ureter_l",label:"Ureter vlevo",reportLabel:"Levý ureter",options:[{label:"Nerozšířen",value:"Nerozšířen.",isNormal:!0,correlates:[]},{label:"Dilatace",value:"Dilatace levého ureteru na ___ mm.",isNormal:!1,summaryLabel:"Dilatace levého ureteru",correlates:["ledvina_l"]},{label:"Ureterolitiáza",value:"Ureterolitiáza vlevo — konkrement ___ mm v ___.",isNormal:!1,summaryLabel:"Ureterolitiáza vlevo",correlates:["ledvina_l"]},{label:"Stent in situ",value:"Stent in situ.",isNormal:!0,correlates:[]},{label:"Pig-tail katétr",value:"Pig-tail katétr in situ.",isNormal:!0,correlates:[]}]},{id:"mechyr",label:"Moč. měchýř",reportLabel:"Močový měchýř",options:[{label:"Normální",value:"Normální, hladkých stěn, homogenního obsahu.",isNormal:!0,correlates:[]},{label:"Min. náplně",value:"Minimální náplně — omezené hodnocení.",isNormal:!0,correlates:[]},{label:"Ztluštění stěny",value:"Ztluštění stěny měchýře — cystoskopie doporučena.",isNormal:!1,summaryLabel:"Ztluštění stěny měchýře",correlates:[]},{label:"Konkrement",value:"Intravezikální konkrement.",isNormal:!1,summaryLabel:"Konkrement v měchýři",correlates:[]},{label:"Katétr",value:"Katétr in situ.",isNormal:!0,correlates:[]}]}]},{label:"Trávicí trubice a peritoneum",fields:[{id:"travici",label:"Trávicí trubice",reportLabel:"Trávicí trubice",options:[{label:"Normální",value:"Normální.",isNormal:!0,correlates:[]},{label:"Divertikly",value:"Vícečetné klidné divertikly tračníku.",isNormal:!1,summaryLabel:"Divertikulóza tračníku",correlates:[]},{label:"Divertikulitida",value:"Divertikulitida sigmatu — ztluštění stěny s infiltrací perisigmoidálního tuku.",isNormal:!1,summaryLabel:"Divertikulitida",correlates:["peritonealni","mezenterium"]},{label:"Ztluštění stěny",value:"Cirkulární ztluštění stěny tračníku v oblasti ___ — k endoskopickému dovyšetření.",isNormal:!1,summaryLabel:"Ztluštění stěny tračníku k dovyšetření",correlates:["uzliny_mez","peritonealni"]},{label:"Ileus TT",value:"Ileus tenkého střeva — přechodová zóna v oblasti ___.",isNormal:!1,summaryLabel:"Ileus tenkého střeva",correlates:["peritonealni"]},{label:"Hiátová hernie",value:"Hiátová hernie.",isNormal:!1,summaryLabel:"Hiátová hernie",correlates:[]}]},{id:"mezenterium",label:"Mezenterium",reportLabel:"Mezenterium",options:[{label:"Normální",value:"Normální.",isNormal:!0,correlates:[]},{label:"Infiltrace tuku",value:"Infiltrace perimezenteriálního tuku.",isNormal:!1,summaryLabel:"Infiltrace mezenteria",correlates:["travici"]},{label:"Zvětšené uzliny",value:"Zvětšené mezenteriální uzliny do ___ mm.",isNormal:!1,summaryLabel:"Mezenteriální lymfadenopatie",correlates:["travici"]},{label:"Retrakce",value:"Retrakce mezenteria.",isNormal:!1,summaryLabel:"Retrakce mezenteria",correlates:["travici"]},{label:"Tukový tumor",value:"Lipom/liposarkom mezenteria — ___ mm, k dovyšetření.",isNormal:!1,summaryLabel:"Mezenteriální tumor",correlates:[]}]},{id:"peritonealni",label:"Periton. dutina",reportLabel:"Peritoneální dutina",options:[{label:"Normální",value:"Bez volné tekutiny ani vzduchu.",isNormal:!0,correlates:[]},{label:"Stopová tekutina",value:"Stopová volná tekutina v pánvi.",isNormal:!1,summaryLabel:"Stopová volná peritoneální tekutina",correlates:[]},{label:"Ascites",value:"Ascites — množství ___.",isNormal:!1,summaryLabel:"Ascites",correlates:["porta","slezina","jatra"]},{label:"Volný vzduch!",value:"Volný vzduch v peritoneální dutině — perforace!",isNormal:!1,summaryLabel:"⚠ VOLNÝ VZDUCH — PERFORACE",correlates:["travici"]},{label:"Peritoneální depozita",value:"Peritoneální depozita — v.s. peritoneální karcinomatóza.",isNormal:!1,summaryLabel:"Peritoneální karcinomatóza",correlates:["uzliny_retro","jatra"]},{label:"Volná tekutina",value:"Volná tekutina v dutině břišní — množství ___.",isNormal:!1,summaryLabel:"Volná peritoneální tekutina",correlates:[]}]}]},{label:"Cévní a uzliny",fields:[{id:"cevni",label:"Cévní struktury",reportLabel:"Cévní struktury",options:[{label:"Normální",value:"V normě.",isNormal:!0,correlates:[]},{label:"ATS aorty",value:"Ateroskleróza abdominální aorty a pánevních tepen.",isNormal:!1,summaryLabel:"Ateroskleróza",correlates:[]},{label:"AAA",value:"Aneuryzma abdominální aorty — průměr ___ mm.",isNormal:!1,summaryLabel:"AAA — průměr ___ mm",correlates:[]},{label:"Kalcifikace mez. tepen",value:"Kalcifikace mezenteriálních tepen.",isNormal:!1,summaryLabel:"Kalcifikace mezenteriálních tepen",correlates:[]},{label:"Trombóza VP/VMH",value:"Trombóza v. portae / v. mesenterica superior.",isNormal:!1,summaryLabel:"Portomezenteriální trombóza",correlates:["jatra","slezina"]}]},{id:"uzliny_mez",label:"LU mezenteriální",reportLabel:"LU mezenteriální",options:[{label:"Nezvětšeny",value:"Nezvětšeny.",isNormal:!0,correlates:[]},{label:"Do 10 mm",value:"Mezenteriální uzliny do 10 mm — hraniční.",isNormal:!1,summaryLabel:"Hraniční mezenteriální uzliny",correlates:["travici"]},{label:"Zvětšeny > 10 mm",value:"Zvětšené mezenteriální uzliny > 10 mm — suspektní.",isNormal:!1,summaryLabel:"Mezenteriální lymfadenopatie",correlates:["travici"]},{label:"Conglomerát",value:"Konglomerát mezenteriálních uzlin.",isNormal:!1,summaryLabel:"Konglomerát mez. uzlin",correlates:["travici","uzliny_retro"]}]},{id:"uzliny_retro",label:"LU retroperitoneální",reportLabel:"LU retroperitoneální",options:[{label:"Nezvětšeny",value:"Nezvětšeny.",isNormal:!0,correlates:[]},{label:"Do 10 mm",value:"Retroperitoneální uzliny do 10 mm — nespecifické.",isNormal:!1,summaryLabel:"Drobné retroperitoneální uzliny",correlates:[]},{label:"Suspektní",value:"Retroperitoneální uzliny > 10 mm — suspektní.",isNormal:!1,summaryLabel:"Retroperitoneální lymfadenopatie",correlates:[]},{label:"Masivní LAP",value:"Masivní retroperitoneální lymfadenopatie.",isNormal:!1,summaryLabel:"Masivní retroperitoneální LAP",correlates:["uzliny_mez"]}]},{id:"uzliny_trisla",label:"LU tříselné",reportLabel:"LU tříselné",options:[{label:"Nezvětšeny",value:"Nezvětšeny.",isNormal:!0,correlates:[]},{label:"Lipomatózní",value:"V krátké ose do ___ mm — lipomatózní.",isNormal:!0,correlates:[]},{label:"Suspektní",value:"Tříselné uzliny > 10 mm — suspektní.",isNormal:!1,summaryLabel:"Tříselná lymfadenopatie",correlates:[]}]}]},{label:"Pánev a skelet",fields:[{id:"pan_organy",label:"Pánevní orgány",reportLabel:"Pánevní orgány",options:[{label:"Normální",value:"Normální.",isNormal:!0,correlates:[]},{label:"Prostata zvětšena",value:"Prostata zvětšena — ___ × ___ × ___ mm.",isNormal:!1,summaryLabel:"Benigní hyperplazie prostaty",correlates:[]},{label:"Prostata s kalcif.",value:"Prostata s kalcifikacemi.",isNormal:!1,summaryLabel:"Kalcifikace prostaty",correlates:[]},{label:"Uterus normální",value:"Děloha normální velikosti.",isNormal:!0,correlates:[]},{label:"Ovariální cysta",value:"Cystická ovariální struktura vpravo/vlevo — ___ mm.",isNormal:!1,summaryLabel:"Ovariální cysta",correlates:[]},{label:"TEP kyčle",value:"Stav po TEP kyčelního kloubu vpravo/vlevo — in situ.",isNormal:!0,correlates:[]}]},{id:"skelet",label:"Skelet",reportLabel:"Skelet",options:[{label:"Normální",value:"Bez patologických ložisek.",isNormal:!0,correlates:[]},{label:"Deg. změny páteře",value:"Degenerativní změny páteře.",isNormal:!1,summaryLabel:"Degenerativní změny páteře",correlates:[]},{label:"Stará fraktura",value:"Stará kompresivní fraktura ___ — zhojená.",isNormal:!1,summaryLabel:"Zhojená fraktura",correlates:[]},{label:"Lytická ložiska",value:"Osteolytická ložiska — k dovyšetření (onkologie?).",isNormal:!1,summaryLabel:"Osteolytická ložiska",correlates:["uzliny_retro"]},{label:"Hemangiom",value:"Hemangiom obratl. těla ___ — benigní.",isNormal:!1,summaryLabel:"Vertebrální hemangiom",correlates:[]},{label:"Artróza SIK",value:"Artróza sakroiliakálních kloubů bilat.",isNormal:!1,summaryLabel:"Artróza SIK",correlates:[]}]}]}]},{id:"ct_ag_plicnice",title:"CT AG PLICNICE",techniqueLabel:"Technika",defaultTechnique:"___ ml Iomeron 400 i.v., aplikace injektorem, bolus tracking. Bez nežádoucí reakce.",normalConclusion:"Plicní embolie neprokázána. Nepřímé známky přetížení pravé komory nediferencuji.",groups:[{label:"Plicní tepny",fields:[{id:"pe_main",label:"Hlavní plicnice",reportLabel:"Plicní arterie",options:[{label:"Bez embolizace",value:"Plní homogenně v celém rozsahu, bez známek embolizace.",isNormal:!0,correlates:[]},{label:"Sedlová embolie!",value:"Sedlová embolie — výplňový defekt v kmeni plicnice přesahující na obě strany.",isNormal:!1,summaryLabel:"⚠ SEDLOVÁ EMBOLIE",correlates:["rvlv","ivs","thrombus"]},{label:"Defekt v kmeni",value:"Výplňový defekt v kmeni plicnice.",isNormal:!1,summaryLabel:"PE v kmeni plicnice",correlates:["rvlv","ivs"]},{label:"Bilat. lalokové větve",value:"Výplňové defekty oboustranně v lalokových a segmentárních větvích.",isNormal:!1,summaryLabel:"Masivní bilaterální PE",correlates:["rvlv","hampton"]},{label:"Vpravo — lalokové",value:"Defekty v pravé plicní tepně a lalokových větvích vpravo.",isNormal:!1,summaryLabel:"PE vpravo — lalokové větve",correlates:["rvlv"]},{label:"Vlevo — lalokové",value:"Defekty v levé plicní tepně a lalokových větvích vlevo.",isNormal:!1,summaryLabel:"PE vlevo — lalokové větve",correlates:["rvlv"]},{label:"Pouze segmentární",value:"Defekty pouze v segmentárních/subsegmentárních větvích.",isNormal:!1,summaryLabel:"PE segmentární/subsegmentární",correlates:[]}]},{id:"kmen_plicnice",label:"Kmen plicnice",reportLabel:"Kmen plicnice šíře",options:[{label:"< 29 mm",value:"___ mm — normální.",isNormal:!0,correlates:[]},{label:"29–32 mm",value:"___ mm — hraniční.",isNormal:!1,summaryLabel:"Hraniční šíře kmene plicnice",correlates:[]},{label:"> 32 mm",value:"___ mm — dilatace, v.s. plicní hypertenze.",isNormal:!1,summaryLabel:"Dilatace kmene plicnice — plicní hypertenze",correlates:["rvlv"]}]}]},{label:"Přetížení pravé komory",fields:[{id:"rvlv",label:"PK/LK ratio",reportLabel:"PK/LK poměr",options:[{label:"< 1.0 (normální)",value:"PK ___ mm / LK ___ mm — poměr PK/LK < 1,0 — normální.",isNormal:!0,correlates:[]},{label:"1.0–1.5 (dilatace PK)",value:"PK ___ mm / LK ___ mm — poměr PK/LK = ___ — dilatace PK.",isNormal:!1,summaryLabel:"Dilatace PK (RV/LV > 1,0)",correlates:["ivs"]},{label:"> 1.5 (závažné)",value:"PK ___ mm / LK ___ mm — poměr PK/LK = ___ — závažná dilatace PK.",isNormal:!1,summaryLabel:"⚠ Závažné přetížení PK (RV/LV > 1,5)",correlates:["ivs","thrombus"]}]},{id:"ivs",label:"Mezikomorové septum",reportLabel:"Mezikomorové septum",options:[{label:"Normální",value:"Normální poloha.",isNormal:!0,correlates:[]},{label:"Vybočení vlevo",value:"Vybočení mezikomorového septa vlevo — přetlak PK.",isNormal:!1,summaryLabel:"Vybočení septa — přetlak PK",correlates:["rvlv"]}]},{id:"thrombus",label:"Trombus v srdci",reportLabel:"Pravé srdeční oddíly",options:[{label:"Bez trombu",value:"Bez intrakavitárního trombu.",isNormal:!0,correlates:[]},{label:"Trombus!",value:"Trombus v pravé síni/komoře — kritický nález.",isNormal:!1,summaryLabel:"⚠ Intrakavitární trombus",correlates:["rvlv"]},{label:"Reflexní KL do DDŽ",value:"Reflexní náplň kontrastu do DDŽ a jaterních žil.",isNormal:!1,summaryLabel:"Reflux KL do DDŽ — přetížení PK",correlates:["rvlv"]}]}]},{label:"Plicní infarkt",fields:[{id:"hampton",label:"Plicní infarkt",reportLabel:"Plicní infarkt",options:[{label:"Nepřítomen",value:"Nepřítomen.",isNormal:!0,correlates:[]},{label:"Hamptonův hrb",value:"Klínovité subpleurální zhutění — Hamptonův hrb (plicní infarkt) ___.",isNormal:!1,summaryLabel:"Plicní infarkt — Hamptonův hrb",correlates:["pleura"]},{label:"GGO / konsolidace",value:"GGO / konsolidace periferně v ___ — v.s. plicní infarkt.",isNormal:!1,summaryLabel:"Suspektní plicní infarkt",correlates:["pleura"]}]},{id:"pleura",label:"Pleura",reportLabel:"Pleurální dutiny",options:[{label:"Bez tekutiny",value:"Bez tekutiny.",isNormal:!0,correlates:[]},{label:"Malý výpotek",value:"Malý pleurální výpotek vpravo/vlevo.",isNormal:!1,summaryLabel:"Pleurální výpotek",correlates:[]},{label:"Střední výpotek",value:"Střední pleurální výpotek vpravo/vlevo.",isNormal:!1,summaryLabel:"Pleurální výpotek",correlates:[]},{label:"Oboustranný výpotek",value:"Oboustranný pleurální výpotek.",isNormal:!1,summaryLabel:"Oboustranný pleurální výpotek",correlates:["rvlv"]}]}]},{label:"Ostatní",fields:[{id:"aorta_pa",label:"Aorta",reportLabel:"Aorta",options:[{label:"Normální",value:"Bez dilatace, má homogenní náplň.",isNormal:!0,correlates:[]},{label:"ATS",value:"S kalcifikacemi — ATS.",isNormal:!1,summaryLabel:"Ateroskleróza aorty",correlates:[]},{label:"Disekce?",value:"Suspektní intimalní chlopeň — k dovyšetření.",isNormal:!1,summaryLabel:"⚠ Suspektní disekce aorty",correlates:[]}]},{id:"plice_pa",label:"Plíce",reportLabel:"Plíce",options:[{label:"Normální",value:"Rozepjaty, bez ložisek či infiltrace.",isNormal:!0,correlates:[]},{label:"GGO bilat.",value:"Oboustranně GGO — dif. dg. edém/pneumonie/COVID.",isNormal:!1,summaryLabel:"Oboustranné GGO",correlates:[]},{label:"Uzlík",value:"Ojedinělý plicní uzlík ___ mm — ke srovnání / Fleischner.",isNormal:!1,summaryLabel:"Plicní uzlík",correlates:[]},{label:"Emfyzém",value:"Plicní emfyzém.",isNormal:!1,summaryLabel:"Plicní emfyzém",correlates:[]},{label:"Konsolidace",value:"Ložisková konsolidace — v.s. pneumonie.",isNormal:!1,summaryLabel:"Konsolidace — pneumonie?",correlates:[]}]},{id:"srdce_pa",label:"Srdce",reportLabel:"Srdce",options:[{label:"Normální",value:"Normální.",isNormal:!0,correlates:[]},{label:"Dilatace",value:"Celková dilatace srdce.",isNormal:!1,summaryLabel:"Dilatace srdce",correlates:["rvlv"]},{label:"Dilatace P oddílů",value:"Dilatace pravostranných srdečních oddílů.",isNormal:!1,summaryLabel:"Dilatace P srdečních oddílů",correlates:["rvlv"]},{label:"Perikard. výpotek",value:"Perikardiální výpotek.",isNormal:!1,summaryLabel:"Perikardiální výpotek",correlates:[]}]},{id:"epigastrium_pa",label:"Epigastrium",reportLabel:"Zachycené epigastrium",options:[{label:"V normě",value:"V normě.",isNormal:!0,correlates:[]},{label:"Steatóza jater",value:"Steatóza jaterní.",isNormal:!1,summaryLabel:"Jaterní steatóza",correlates:[]},{label:"Cholelitýza",value:"Cholecystolitiáza.",isNormal:!1,summaryLabel:"Cholecystolitiáza (incidentální)",correlates:[]}]}]}]},{id:"ct_mozku",title:"CT MOZKU",techniqueLabel:"Technika",defaultTechnique:"Nativně.",normalConclusion:"Přiměřený nativní CT nález mozku.",groups:[{label:"Krvácení",fields:[{id:"krvareni",label:"Intrakraniální krvácení",reportLabel:"Intrakraniální krvácení",options:[{label:"Nediferencuji",value:"Nediferencuji.",isNormal:!0,correlates:[]},{label:"ICH",value:"Intrakraniální hemoragie — ___ × ___ mm v oblasti ___.",isNormal:!1,summaryLabel:"Intrakraniální krvácení",correlates:["komory","stredni_cara","cisterny"]},{label:"SDH",value:"Subdurální hematom ___ mm v oblasti ___.",isNormal:!1,summaryLabel:"Subdurální hematom",correlates:["stredni_cara"]},{label:"EDH",value:"Epidurální hematom ___ mm v oblasti ___.",isNormal:!1,summaryLabel:"Epidurální hematom",correlates:["stredni_cara"]},{label:"SAK",value:"Subarachnoidální krvácení — v oblasti ___.",isNormal:!1,summaryLabel:"Subarachnoidální krvácení",correlates:["cisterny","komory"]},{label:"IVH",value:"Intraventrikulární hemoragie.",isNormal:!1,summaryLabel:"Intraventrikulární krvácení",correlates:["komory"]}]}]},{label:"Parenchym",fields:[{id:"parenchym",label:"Mozkový parenchym",reportLabel:"Mozkový parenchym",options:[{label:"Normální",value:"Bez ložiskových změn. Zachovalá diferenciace bílé a šedé hmoty.",isNormal:!0,correlates:[]},{label:"Akutní ischémie",value:"Hypodenzní okrsek v oblasti ___ — v.s. čerstvá ischémie. ASPECTS ___.",isNormal:!1,summaryLabel:"Akutní ischemická CMP",correlates:["stredni_cara","cisterny"]},{label:"Chronická ischémie / gliosa",value:"Oboustranně supratentoriálně glióza s typickou distribucí — chronické vaskulární změny.",isNormal:!1,summaryLabel:"Chronické vaskulární změny",correlates:[]},{label:"Ložisko / tumor",value:"Expanzivní ložisko ___ mm v oblasti ___ — k dovyšetření (MRI mozku s KL).",isNormal:!1,summaryLabel:"Expanzivní ložisko mozku",correlates:["stredni_cara","komory"]},{label:"Kontuze",value:"Kontuzní ložisko ___ mm frontobazálně/temporálně.",isNormal:!1,summaryLabel:"Kontuzní ložisko",correlates:["stredni_cara"]},{label:"Kalcifikace BG",value:"Kalcifikace bazálních ganglií bilat. — benigní.",isNormal:!1,summaryLabel:"Kalcifikace BG (benigní)",correlates:[]}]},{id:"bila_hmota",label:"Bílá hmota",reportLabel:"Bílá hmota",options:[{label:"Normální",value:"Bez patologických hypodenzit.",isNormal:!0,correlates:[]},{label:"Periventrikulární změny",value:"Periventrikulární hypodenzity — chronické vaskulární změny.",isNormal:!1,summaryLabel:"Periventrikulární vaskulární změny",correlates:[]},{label:"Rozsáhlá leukoaraióza",value:"Rozsáhlé změny bílé hmoty — leukoaraióza.",isNormal:!1,summaryLabel:"Leukoaraióza",correlates:[]},{label:"Postkontuzní změny",value:"Postkontuzní změny frontobazálně bilat.",isNormal:!1,summaryLabel:"Postkontuzní změny",correlates:[]}]}]},{label:"Komorový systém a expanze",fields:[{id:"komory",label:"Komorový systém",reportLabel:"Komorový systém",options:[{label:"Symetrický, štíhlý",value:"Symetrický, přiměřené šíře, ve střední čáře.",isNormal:!0,correlates:[]},{label:"Hydrocefalus",value:"Hydrocefalus — dilatace komorového systému.",isNormal:!1,summaryLabel:"Hydrocefalus",correlates:["cisterny"]},{label:"Hydrocefalus — EVD",value:"Hydrocefalus. Komorová drenáž in situ.",isNormal:!1,summaryLabel:"Hydrocefalus — komorová drenáž",correlates:["cisterny"]},{label:"Asymetrie",value:"Asymetrie postranních komor — stac. / nová.",isNormal:!1,summaryLabel:"Asymetrie komor",correlates:["stredni_cara"]},{label:"Hemocefalus",value:"Hemocefalus — krev v komorovém systému.",isNormal:!1,summaryLabel:"Hemocefalus",correlates:["krvareni"]}]},{id:"stredni_cara",label:"Střední čára",reportLabel:"Přesun středočarových struktur",options:[{label:"Ve střední čáře",value:"Ne.",isNormal:!0,correlates:[]},{label:"Deviace < 5 mm",value:"Ano — ___ mm.",isNormal:!1,summaryLabel:"Deviace střední čáry < 5 mm",correlates:[]},{label:"Deviace > 5 mm!",value:"Ano — ___ mm — závažný přesun.",isNormal:!1,summaryLabel:"⚠ Deviace střední čáry > 5 mm",correlates:["cisterny"]}]},{id:"cisterny",label:"Bazální cisterny",reportLabel:"Bazální cisterny",options:[{label:"Volné",value:"Volné.",isNormal:!0,correlates:[]},{label:"Stlačené",value:"Stlačené — přetlak z expanzivního procesu.",isNormal:!1,summaryLabel:"Stlačené bazální cisterny",correlates:["stredni_cara"]},{label:"SAK v cisternách",value:"SAK v bazálních cisternách — aneuryzma?",isNormal:!1,summaryLabel:"SAK v bazálních cisternách",correlates:["komory"]}]}]},{label:"SA prostory a ostatní",fields:[{id:"sa_prostory",label:"SA prostory",reportLabel:"SA prostory",options:[{label:"Zachované",value:"Zachované, věku přiměřené.",isNormal:!0,correlates:[]},{label:"Atrofie",value:"Celkově širší při pokročilé korové atrofii.",isNormal:!1,summaryLabel:"Korová atrofie",correlates:[]},{label:"SAK kortikálně",value:"SAK v kortikálních sulcích v oblasti ___.",isNormal:!1,summaryLabel:"Kortikální SAK",correlates:["krvareni"]}]},{id:"sella",label:"Sella / zadní jáma",reportLabel:"Sella / zadní jáma",options:[{label:"Normální",value:"Sella nezvětšena. Zadní jáma — mozeček a mozkový kmen bez patolog. nálezu.",isNormal:!0,correlates:[]},{label:"Expanze selly",value:"Zvětšení selly — v.s. adenohypofyzární adenom. MRI hypofýzy doporučeno.",isNormal:!1,summaryLabel:"Expanze selly — MRI hypofýzy",correlates:[]},{label:"Ischémie v ZJ",value:"Hypodenzní okrsek v mozečku/mozkovém kmeni.",isNormal:!1,summaryLabel:"Ischémie v zadní jámě",correlates:["komory"]}]},{id:"skelet_mozek",label:"Skelet / VDN",reportLabel:"Skelet / VDN",options:[{label:"Normální",value:"Skelet neurokrania bez zlomenin. VDN vzdušné.",isNormal:!0,correlates:[]},{label:"Zlomenina kalvy",value:"Zlomenina kalvy v oblasti ___.",isNormal:!1,summaryLabel:"Zlomenina kalvy",correlates:["krvareni"]},{label:"Fraktura spodiny",value:"Fraktura spodiny lební v oblasti ___.",isNormal:!1,summaryLabel:"Fraktura spodiny lební",correlates:[]},{label:"Patol. obsah VDN",value:"Patologický obsah v paranazálních dutinách — ___ sinus.",isNormal:!1,summaryLabel:"Patol. obsah vedlejších dutin nosních",correlates:[]},{label:"Pneumocefalus",value:"Pneumocefalus.",isNormal:!1,summaryLabel:"Pneumocefalus",correlates:["krvareni"]}]}]}]}];function od({option:S,isSelected:E,onClick:_}){const U="text-xs px-2.5 py-1 rounded border font-medium transition-all duration-150 cursor-pointer select-none";let A;return E?A=S.isNormal?"bg-emerald-500/20 border-emerald-500/50 text-emerald-300 ring-1 ring-emerald-500/30":"bg-amber-500/20 border-amber-500/50 text-amber-300 ring-1 ring-amber-500/30":A="bg-zinc-800/50 border-zinc-700 text-zinc-400 hover:text-zinc-200 hover:border-zinc-500 hover:bg-zinc-700/50",u.jsx("button",{onClick:_,className:`${U} ${A}`,children:S.label})}function ld({field:S,selected:E,onToggle:_,isHighlighted:U,correlatedBy:A}){const H=U?"bg-amber-500/6 border-l-2 border-amber-400/60 pl-2":"border-l-2 border-transparent pl-2";return u.jsxs("div",{className:`flex items-start gap-2 py-2 pr-2 rounded-r transition-all duration-200 ${H}`,children:[u.jsxs("div",{className:"flex items-start gap-1.5 pt-1 flex-shrink-0 w-36",children:[U&&u.jsx("span",{className:"text-amber-400 text-xs leading-none",children:"⚡"}),u.jsx("span",{className:"text-xs text-zinc-500 leading-tight",children:S.label})]}),u.jsx("div",{className:"flex flex-wrap gap-1.5 flex-1",children:S.options.map(K=>u.jsx(od,{option:K,isSelected:(E==null?void 0:E.label)===K.label,onClick:()=>_(S.id,K)},K.label))})]})}function sd({lang:S="cs"}){const[E,_]=ve.useState("ct_bricha"),[U,A]=ve.useState({}),[H,K]=ve.useState(""),[ne,j]=ve.useState(""),[me,ae]=ve.useState(!1),x=Lo.find(g=>g.id===E),Y=ve.useCallback(g=>{const w=Lo.find($=>$.id===g);_(g),A({}),K(""),j((w==null?void 0:w.defaultTechnique)||"")},[]);ve.useState(()=>{j((x==null?void 0:x.defaultTechnique)||"")});const de=ve.useMemo(()=>{const g=new Set;return Object.values(U).forEach(w=>{var $;($=w==null?void 0:w.correlates)==null||$.forEach(ke=>g.add(ke))}),g},[U]),oe=ve.useCallback((g,w)=>{A($=>{var ke;if(((ke=$[g])==null?void 0:ke.label)===w.label){const fe={...$};return delete fe[g],fe}return{...$,[g]:w}})},[]),M=ve.useMemo(()=>{if(!x)return"";const g=[];g.push(x.title),g.push(`Klinické informace: ${H||"___"}`),g.push("Předchozí vyšetření: ___"),g.push(`${x.techniqueLabel}: ${ne||"___"}`),g.push(""),g.push("NÁLEZ"),x.groups.forEach($=>{$.fields.forEach(ke=>{const fe=U[ke.id];g.push(`${ke.reportLabel}: ${fe?fe.value:"___"}`)})}),g.push(""),g.push("ZÁVĚR");const w=[];return x.groups.forEach($=>{$.fields.forEach(ke=>{const fe=U[ke.id];fe&&!fe.isNormal&&w.push(fe.summaryLabel||fe.label)})}),w.length===0?g.push(x.normalConclusion):g.push(w.join(". ")+"."),g.join(`
`)},[x,U,H,ne]),G=ve.useCallback(()=>{navigator.clipboard.writeText(M),ae(!0),setTimeout(()=>ae(!1),2e3)},[M]),xe=ve.useCallback(()=>A({}),[]),be=Object.keys(U).length,O=Object.values(U).filter(g=>g&&!g.isNormal).length,T=((x==null?void 0:x.groups.reduce((g,w)=>g+w.fields.length,0))||0)-be;return x?u.jsxs("div",{className:"flex flex-col h-full",children:[u.jsx("div",{className:"flex gap-1 mb-4 flex-wrap",children:Lo.map(g=>u.jsx("button",{onClick:()=>Y(g.id),className:`text-xs px-3 py-1.5 rounded border font-bold transition-all ${E===g.id?"bg-zinc-700/60 border-zinc-500 text-zinc-100":"border-zinc-800 text-zinc-600 hover:text-zinc-300 hover:border-zinc-700"}`,children:g.title.replace("CT ","")},g.id))}),u.jsxs("div",{className:"grid grid-cols-2 gap-2 mb-4",children:[u.jsxs("div",{children:[u.jsx("label",{className:"text-xs text-zinc-600 uppercase tracking-widest block mb-1",children:"Klinické informace"}),u.jsx("input",{value:H,onChange:g=>K(g.target.value),placeholder:"k vyloučení PE, bolest břicha...",className:"w-full bg-zinc-900 border border-zinc-800 rounded px-3 py-1.5 text-xs text-zinc-300 placeholder-zinc-700 focus:outline-none focus:border-zinc-600"})]}),u.jsxs("div",{children:[u.jsx("label",{className:"text-xs text-zinc-600 uppercase tracking-widest block mb-1",children:"Technika"}),u.jsx("input",{value:ne,onChange:g=>j(g.target.value),className:"w-full bg-zinc-900 border border-zinc-800 rounded px-3 py-1.5 text-xs text-zinc-300 placeholder-zinc-700 focus:outline-none focus:border-zinc-600"})]})]}),u.jsxs("div",{className:"flex items-center gap-4 mb-3 px-1",children:[u.jsxs("span",{className:"text-xs text-zinc-700 flex items-center gap-1.5",children:[u.jsx("span",{className:"w-2 h-2 rounded-full bg-emerald-500 inline-block"}),be-O," normální"]}),u.jsxs("span",{className:"text-xs text-amber-600 flex items-center gap-1.5",children:[u.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-500 inline-block"}),O," patologické"]}),T>0&&u.jsxs("span",{className:"text-xs text-zinc-700",children:[T," nevyplněno"]}),de.size>0&&u.jsxs("span",{className:"text-xs text-amber-500 flex items-center gap-1",children:["⚡ ",de.size," ",(de.size===1,"pole ke kontrole")]}),be>0&&u.jsx("button",{onClick:xe,className:"text-xs text-zinc-700 hover:text-zinc-400 ml-auto transition-colors",children:"Vymazat vše"})]}),u.jsxs("div",{className:"flex flex-col lg:flex-row gap-4 flex-1 min-h-0",children:[u.jsx("div",{className:"flex-1 min-w-0 overflow-y-auto space-y-4 pr-1",children:x.groups.map(g=>u.jsxs("div",{children:[u.jsx("div",{className:"text-xs font-bold text-zinc-600 uppercase tracking-widest mb-1 pb-1 border-b border-zinc-800",children:g.label}),u.jsx("div",{className:"space-y-0.5",children:g.fields.map(w=>u.jsx(ld,{field:w,selected:U[w.id],onToggle:oe,isHighlighted:de.has(w.id)},w.id))})]},g.label))}),u.jsxs("div",{className:"lg:w-80 xl:w-96 flex-shrink-0 flex flex-col",children:[u.jsxs("div",{className:"flex items-center justify-between mb-2",children:[u.jsx("span",{className:"text-xs text-zinc-600 uppercase tracking-widest font-bold",children:"Protokol"}),u.jsx("button",{onClick:G,className:`text-xs px-3 py-1 rounded border font-bold transition-all ${me?"bg-emerald-500/15 border-emerald-500/40 text-emerald-300":"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:me?"✓ Zkopírováno":"Kopírovat"})]}),u.jsx("div",{className:"flex-1 bg-zinc-900/60 border border-zinc-800 rounded-lg overflow-y-auto",children:u.jsx("pre",{className:"p-4 text-zinc-300 whitespace-pre-wrap break-words",style:{fontFamily:"inherit",fontSize:"0.68rem",lineHeight:"1.9"},children:M.split(`
`).map((g,w)=>{const $=g==="NÁLEZ"||g==="ZÁVĚR"||g===x.title,ke=g.includes("___"),fe=Object.values(U).some(ot=>ot&&!ot.isNormal&&g.includes(ot.value.substring(0,15)));return u.jsx("span",{className:`block ${$?"text-zinc-100 font-bold":ke?"text-zinc-600":fe?"text-amber-300":"text-zinc-300"}`,children:g||" "},w)})})})]})]})]}):null}function cd(S,E){const _=Rr.find(U=>U.key===S);return(_==null?void 0:_.categories[E])||(_==null?void 0:_.categories[Object.keys(_.categories)[0]])}function ud({template:S,lang:E,ui:_}){const U=S[E];return u.jsxs("div",{className:"space-y-3",children:[u.jsxs("div",{className:"rounded-lg border border-zinc-700/60 bg-zinc-900/60 p-4",children:[u.jsx("div",{className:"text-xs font-bold text-zinc-500 uppercase tracking-widest mb-2",children:_.mismatchTitle}),u.jsx("p",{className:"text-sm text-zinc-300 leading-relaxed",children:U.searchMismatch}),u.jsxs("p",{className:"text-xs text-zinc-600 mt-2 leading-relaxed",children:[u.jsxs("span",{className:"text-zinc-500 font-semibold",children:[_.searchEvidenceLabel," "]}),U.searchEvidence]})]}),u.jsxs("div",{className:"rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden",children:[u.jsx("div",{className:"px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70",children:u.jsx("span",{className:"text-xs font-bold text-zinc-400 uppercase tracking-widest",children:_.protocolTitle})}),u.jsx("div",{className:"divide-y divide-zinc-800/50",children:U.searchPattern.map(A=>{const H=Wm[A.priority];return u.jsxs("div",{className:`flex gap-3 p-4 ${H.bg}`,children:[u.jsxs("div",{className:"flex-shrink-0 flex items-start gap-2 pt-1",children:[u.jsx("div",{className:`w-2 h-2 rounded-full flex-shrink-0 ${H.dot}`}),u.jsx("span",{className:"text-xs text-zinc-700 font-bold w-3 leading-none",children:A.step})]}),u.jsxs("div",{className:"flex-1 min-w-0",children:[u.jsxs("div",{className:"flex items-baseline gap-2 mb-1 flex-wrap",children:[u.jsx("span",{className:`text-sm font-bold ${H.label}`,children:A.title}),u.jsxs("span",{className:"text-xs text-zinc-700 flex-shrink-0",children:["~",A.time]})]}),u.jsx("p",{className:"text-xs text-zinc-400 leading-relaxed",children:A.detail})]})]},A.step)})})]}),u.jsxs("div",{className:"flex gap-5 text-xs text-zinc-600 px-1",children:[u.jsxs("span",{className:"flex items-center gap-1.5",children:[u.jsx("span",{className:"w-2 h-2 rounded-full bg-red-500 flex-shrink-0"})," ",_.legendCritical]}),u.jsxs("span",{className:"flex items-center gap-1.5",children:[u.jsx("span",{className:"w-2 h-2 rounded-full bg-amber-500 flex-shrink-0"})," ",_.legendHigh]}),u.jsxs("span",{className:"flex items-center gap-1.5",children:[u.jsx("span",{className:"w-2 h-2 rounded-full bg-zinc-500 flex-shrink-0"})," ",_.legendStandard]})]})]})}function md({template:S,lang:E,ui:_,catStyle:U}){const[A,H]=ve.useState(!1),K=S[E],ne=()=>{navigator.clipboard.writeText(K.template),H(!0),setTimeout(()=>H(!1),2e3)};return u.jsxs("div",{className:"space-y-3",children:[u.jsxs("div",{className:"rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden",children:[u.jsxs("div",{className:"flex items-center justify-between px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70",children:[u.jsx("span",{className:"text-xs text-zinc-600",children:_.formatNote}),u.jsx("button",{onClick:ne,className:`text-xs px-3 py-1 rounded border font-bold transition-all ${A?`${U.bg} ${U.border} ${U.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:A?_.copiedButton:_.copyButton})]}),u.jsx("pre",{className:"p-4 text-zinc-300 overflow-x-auto whitespace-pre-wrap break-words",style:{fontFamily:"inherit",fontSize:"0.72rem",lineHeight:"1.8"},children:K.template})]}),u.jsxs("p",{className:"text-xs text-zinc-600 px-1 leading-relaxed",children:[_.usageNote," ",u.jsx("span",{className:"text-red-500/60",children:_.criticalNote})]})]})}function dd(){const[S,E]=ve.useState("en"),[_,U]=ve.useState("abdomen"),[A,H]=ve.useState("appendicitis"),[K,ne]=ve.useState("search"),j=Ym[S],me=Gm[S],ae=Zm[S],x=Rr.find(O=>O.key===_),Y=x==null?void 0:x.isOncology,de=x==null?void 0:x.isRoutine,oe=Vc[_]||[],M=oe.find(O=>O.id===A)||oe[0],G=Y||de?null:cd(_,M==null?void 0:M.category),xe=O=>{var T;U(O);const q=Rr.find(g=>g.key===O);!(q!=null&&q.isOncology)&&!(q!=null&&q.isRoutine)&&H(((T=(Vc[O]||[])[0])==null?void 0:T.id)||""),ne("search")},be=Y||de?{}:oe.reduce((O,q)=>(O[q.category]||(O[q.category]=[]),O[q.category].push(q),O),{});return u.jsxs("div",{className:"min-h-screen bg-zinc-950 text-zinc-100",style:{fontFamily:"'JetBrains Mono','Cascadia Code','Fira Code',monospace"},children:[u.jsx("div",{className:"border-b border-zinc-800 bg-zinc-900/80 sticky top-0 z-10",children:u.jsxs("div",{className:"max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-3 flex-wrap",children:[u.jsxs("div",{className:"flex-shrink-0",children:[u.jsx("div",{className:"text-sm font-bold tracking-widest text-zinc-100",children:j.appTitle}),u.jsx("div",{className:"text-xs text-zinc-600 mt-0.5 tracking-wide",children:j.appSubtitle})]}),u.jsx("div",{className:"flex gap-1 bg-zinc-900 border border-zinc-800 rounded-lg p-1 flex-wrap",children:Rr.map(O=>u.jsx("button",{onClick:()=>xe(O.key),className:`text-xs px-3 py-1.5 rounded-md font-bold tracking-wider border transition-all ${_===O.key?O.tabStyle.active:O.tabStyle.inactive}`,children:me[O.key]},O.key))}),u.jsxs("div",{className:"flex items-center gap-4",children:[u.jsxs("div",{className:"text-xs text-zinc-700 text-right hidden lg:block leading-relaxed",children:[u.jsx("div",{children:j.guidanceRow1}),u.jsx("div",{children:j.guidanceRow2})]}),u.jsx("div",{className:"flex gap-1 bg-zinc-900 border border-zinc-800 rounded p-0.5 flex-shrink-0",children:["en","cs"].map(O=>u.jsx("button",{onClick:()=>E(O),className:`text-xs px-3 py-1.5 rounded font-bold tracking-wider uppercase transition-all ${S===O?"bg-zinc-700 text-zinc-100":"text-zinc-600 hover:text-zinc-300"}`,children:O},O))})]})]})}),u.jsxs("div",{className:"max-w-7xl mx-auto flex flex-col lg:flex-row",style:{minHeight:"calc(100vh - 57px)"},children:[!Y&&!de&&u.jsx("div",{className:"lg:w-52 flex-shrink-0 border-b lg:border-b-0 lg:border-r border-zinc-800/70",children:u.jsx("div",{className:"p-3 space-y-1",children:Object.entries(be).map(([O,q])=>{const T=x.categories[O],g=Object.keys(be).length>1;return u.jsxs("div",{className:"mb-2",children:[g&&u.jsx("div",{className:"text-xs font-bold text-zinc-700 uppercase tracking-widest px-2 pt-2 pb-1",children:ae[O]}),q.map(w=>{const $=x.categories[w.category]||T,ke=w.id===A;return u.jsx("button",{onClick:()=>{H(w.id),ne("search")},className:`w-full text-left px-3 py-2 rounded text-xs transition-all mb-0.5 ${ke?`${$.bg} border ${$.border} ${$.text} font-bold`:"text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800/50"}`,children:w[S].label},w.id)})]},O)})})}),u.jsx("div",{className:"flex-1 min-w-0 p-4 lg:p-6",children:Y?u.jsx(ad,{lang:S,ui:j}):de?u.jsx(sd,{lang:S}):M?u.jsxs("div",{className:"space-y-4",children:[u.jsxs("div",{className:`rounded-lg border p-4 ${G.bg} ${G.border}`,children:[u.jsxs("div",{className:"flex flex-wrap items-start gap-3 justify-between",children:[u.jsxs("div",{className:"flex-1 min-w-0",children:[u.jsxs("div",{className:"flex flex-wrap items-center gap-2 mb-2",children:[u.jsx("h2",{className:`text-lg font-bold ${G.text}`,children:M[S].label}),u.jsx("span",{className:`text-xs px-2 py-0.5 rounded border font-semibold ${G.badge}`,children:ae[M.category]})]}),u.jsxs("p",{className:"text-xs text-zinc-500 leading-relaxed",children:[u.jsxs("span",{className:"text-zinc-400 font-semibold",children:[j.evidenceLabel," "]}),M[S].evidence]})]}),u.jsx("div",{className:"flex gap-2 flex-shrink-0",children:["search","template"].map(O=>u.jsx("button",{onClick:()=>ne(O),className:`text-xs px-3 py-1.5 rounded border font-bold tracking-wide transition-all ${K===O?`${G.bg} ${G.border} ${G.text}`:"border-zinc-700 text-zinc-500 hover:text-zinc-200"}`,children:O==="search"?j.searchTab:j.templateTab},O))})]}),u.jsxs("div",{className:"mt-3 flex flex-wrap gap-1.5 items-center",children:[u.jsx("span",{className:"text-xs text-zinc-600 mr-1",children:j.dontMiss}),M[S].criticalFindings.map(O=>u.jsxs("span",{className:"text-xs px-2 py-0.5 bg-red-500/10 border border-red-500/20 text-red-400 rounded font-medium",children:["⚠ ",O]},O))]})]}),K==="search"?u.jsx(ud,{template:M,lang:S,ui:j}):u.jsx(md,{template:M,lang:S,ui:j,catStyle:G})]}):null})]})]})}Km.createRoot(document.getElementById("root")).render(u.jsx(ve.StrictMode,{children:u.jsx(dd,{})}));
